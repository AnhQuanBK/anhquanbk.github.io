...
(() => {
  ...
  var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" :
  key, value);
  ...
  var init_define_GAME_CONFIG = __esm({
    "<define:__GAME_CONFIG__>"() {
      define_GAME_CONFIG_default = { AppId: "block-puzzle-social", AppDescription: "A relaxing block\
 puzzle game where you place pieces on the grid, clear lines, collect gems, and challenge your frien\
ds!", ApiHost: "https://fbig-singleplay-apps.citigo.site", OtherHost: "https://fbig-leaderboards.cit\
igo.site", Ads: { Enabled: true, PreloadAds: false, NotifyPlayerBeforeShow: false, ShowAdOnLoad: { Enabled: false,
      DelaySeconds: 0, PlacementId: "ad_demo_01" }, DegradationTracking: { ResetTimeMinutes: 5, MaxFailedAttempts: 8 },
      AdServiceConfigs: { AdSense: { Enabled: false, UsePreload: true, DataAdClient: "ca-pub-2993382\
360222769", DataAdChannel: "2634907396", DataAdBreakTest: false, DataAdFrequencyHint: 30 }, Savana: {
      Enabled: false, UsePreload: false, DataAdClient: "ca-pub-1234567890", DataAdChannel: "12345678\
90", DataAdBreakTest: false, DataAdFrequencyHint: 45, BannerAdSlotId: "1234567890" }, AppLovin: { Enabled: false,
      UsePreload: false } }, InterstitialAdOptions: [{ DeviceOS: "default", AdService: "platform", PlacementId: "\
interstitial_01", SecondsFirstTime: 30, SecondsBetweenAds: 45 }, { DeviceOS: "default", AdService: "\
adsense", PlacementId: "interstitial_02", SecondsFirstTime: 30, SecondsBetweenAds: 45 }], RewardedVideoAdOptions: [
      { DeviceOS: "default", AdService: "platform", PlacementId: "rewarded_video_01", SecondsFirstTime: 0,
      SecondsBetweenAds: 0 }, { AdService: "adsense", PlacementId: "rewarded_video_02", SecondsFirstTime: 0,
      SecondsBetweenAds: 0, DeviceOS: "default" }], RewardedInterstitialAdOptions: [], BannerDisplayAdOptions: [] },
      Languages: { Enabled: false, DetectPlayerLocale: true }, GameSDKOptions: { AllowWithoutSDK: true,
      UseNameGenerator: true, MSGames: { LoginOnStart: false, MaxLoginAttemptsPerDay: 1, DevPlaygroundAppId: "\
9pjt8ctkxwb-stag", ScheduleNotification: { D1: "Your grid is waiting! Place your blocks wisely and c\
lear those lines. \u{1F9E9}\u2728", D2: "Ready for a quick break? A fresh set of blocks is ready for\
 you. \u{1F3AF}\u{1F9F1}", D3: "Can you beat your high score? The board is calling you back! \u{1F3C6}\u{1F4A5}",
      D4: "Your daily puzzle is here! Come back and test your skills in Block Puzzle Social. \u{1F579}\uFE0F\u2705",
      D5: "Those lines won't clear themselves! Drop in and place your next perfect piece. \u{1F9E9}\u{1F525}",
      D6: "Time for a quick brain boost! Clear a few lines and collect some gems. \u{1F48E}\u{1F9E0}",
      D7: "Don't lose your streak! Log in now and keep the blocks falling in Block Puzzle Social. \u{1F4C8}\
\u{1F9F1}" } }, TikTok: { ClientKey: "" }, Yandex: { LoginOnStart: false, MaxLoginAttemptsPerDay: 1 },
      Playable: { AppleAppStoreUrl: "", GooglePlayStoreUrl: "" }, TranssionH5: { GaId: "G-XXXXXXXXXX" },
      YoutubePlayables: { AutoLogGameReady: true } }, Core: { InitAsync: true, AverageLoadTime: 6, StartSDKAfterLoadGame: true,
      FastCheckTournamentContext: true }, GameEngine: { ForceDesktopDPR: 2, AutoResizeCanvas: true, PreferredFPS: {
      Mobile: 60, Desktop: 60 }, DynamicAtlas: { IOS: { Enabled: true, MaxAtlasSize: 8192, MaxFrameSize: 2048,
      MaxAtlasCount: 1 }, Android: { Enabled: true, MaxAtlasSize: 4096, MaxFrameSize: 2048, MaxAtlasCount: 1 },
      Desktop: { Enabled: true, MaxAtlasSize: 8192, MaxFrameSize: 2048, MaxAtlasCount: 1 }, OptimizeAtlas: {
      Enabled: true, AtlasDebug: false, AutoAtlasSize: true, UsePowerOfTwo: false, TextureBleeding: true,
      AllowNonePackable: false, OnlyOptimizeWhenRenderTooLong: true } }, DynamicAssets: { Enabled: true,
      Resolution: { Source: 2, Available: [1, 2] }, Compression: { Debug: false, Enabled: false, PNG: {
      colors: 256, quality: 80, dither: 0.6, palette: true, compressionLevel: 6 }, JPEG: { quality: 80,
      mozjpeg: true }, WEBP: { quality: 80, lossless: false, alphaQuality: 60, smartSubsample: true,
      preset: "drawing" } }, IgnoreFiles: [] }, HybridFileCache: { Enabled: true, BuildMode: { Enabled: true,
      InvalidateMode: "both", SupportedExtensions: [".json"] }, PreviewMode: { Enabled: false, CacheScene: false,
      CachePrefab: false, CacheUuidExtension: false, InvalidateMode: "commitId", SupportedExtensions: [
      ".json"] } } }, Gameplay: { StartAdAtLevel: 5, MaxRescueCount: 1, Tutorial: { Enabled: true, ForceUseTutorial: false } },
      Firebase: { Enabled: false, Options: { AppId: "", ApiKey: "", ProjectId: "", AuthDomain: "", StorageBucket: "",
      MeasurementId: "", MessagingSenderId: "" }, Services: { Analytics: { Enabled: false }, Performance: {
      Enabled: false }, RemoteConfig: { Enabled: false } } }, Analytics: { Enabled: true, GoogleAnalytics: {
      Enabled: true, ConsoleLog: false }, ClarityAnalytics: { Enabled: false, ConsoleLog: false, ScreenshotCanvas: {
      Interval: 1500, ByEvent: ["APP_READY", "PAGE_VIEW", "BUTTON_CLICK", "AD_SHOWING", "LEVEL_START",
      "LEVEL_END"] } }, FirebaseAnalytics: { Enabled: false, ConsoleLog: false }, FacebookAnalytics: {
      Prefix: "fba", Enabled: false, ConsoleLog: false } }, PerformanceMonitor: { CoreFlows: false, EngineFlows: false,
      GameSDKFlows: false, LoadResources: false, FpsTracking: { Enabled: false, TrackingDuration: 60,
      TrackingInterval: 10 } }, RemoteConfig: { Enabled: false, Options: { ForceReloadGame: false, FetchIntervalInSeconds: 300 },
      ...
      Notification: { Enabled: false, ApiUrl: "https://notifications.sunstudio.io" }, DailyRewards: {
      Enabled: false, MaxDays: 7, MockTime: 0, CheckInterrupt: false }, Mockup: { Ads: { Enabled: false,
      ErrorRate: 5, GiphyApiKey: "VmjHIRsfrwCAssDS4mDo9DoImxJm1lLM", SafeAreaBottom: 0 }, Match: { Enabled: false,
      ErrorRate: 5, PlayerInfo: { Id: "player-mock", Name: "Player Mock", Photo: "", Signature: "" },
      OpponentInfo: { Id: "opponent-mock", Name: "Opponent Mock", Photo: "", Signature: "" } }, GameSDK: {
      SlowAPI: { Enabled: false, ErrorRate: 5, StartDelay: 1e3, InitialDelay: 1e3, PlayerDataDelay: 1e3 },
      Context: { Enabled: false }, Player: { SubscribeBot: { Enabled: false, CanSubscribeBot: true },
      ConnectedPlayers: { Enabled: false, ErrorRate: 5, RandomDelayMs: 1e3, NumOfPlayers: 3 } }, AddShortcut: {
      Enabled: false, CanCreateShortcut: true }, OverlayViews: { Enabled: false }, Tournament: { Enabled: false,
      ErrorRates: 5, RandomDelayMs: 1e3, NumOfTournament: { Normal: 10, HostPage: 2 } }, Payments: {
      Enabled: false, ErrorRates: 5, RandomDelayMs: 1e3, Products: [] } }, Profile: { Enabled: false,
...
a1f7164dc9d2468b953aef67b0a19355" }, Leaderboards: { Enabled: false, MinScore: 10, MaxScore: 100, ErrorRate: 5,
      ...
      Ignored: ["USER_INPUT", "NETWORK_FAILURE"] }, Messages: { Accepted: [], Ignored: ["Load image \
failed"] } }, Feedback: false }, ListPlayerDevIds: ["0000"], InputRecorder: { Enabled: false, Logging: true,
      ...
      OnlyUpdateWhenSwitchScene: false }, TrackingSceneNames: ["GameScene"] }, FrameCapture: { Enabled: false,
      Options: { Quality: 0.85, RenderType: "jpeg", UseBlobIfPossible: true, FallbackWithWideframe: "\
Default" } }, Auth: { Enabled: true }, Audio: { Enabled: true }, Match: { Enabled: true }, Player: {
      Enabled: true }, Profile: { Enabled: true }, Context: { Enabled: true }, Missions: { Enabled: false },
  ...
  var init_define_GAME_SDK_CONFIG = __esm({
    "<define:__GAME_SDK_CONFIG__>"() {
      ...
      MaxLoginAttemptsPerDay: 1, DevPlaygroundAppId: "9pjt8ctkxwb-stag", ScheduleNotification: { D1: "\
Your grid is waiting! Place your blocks wisely and clear those lines. \u{1F9E9}\u2728", D2: "Ready f\
or a quick break? A fresh set of blocks is ready for you. \u{1F3AF}\u{1F9F1}", D3: "Can you beat you\
r high score? The board is calling you back! \u{1F3C6}\u{1F4A5}", D4: "Your daily puzzle is here! Co\
me back and test your skills in Block Puzzle Social. \u{1F579}\uFE0F\u2705", D5: "Those lines won't \
clear themselves! Drop in and place your next perfect piece. \u{1F9E9}\u{1F525}", D6: "Time for a qu\
ick brain boost! Clear a few lines and collect some gems. \u{1F48E}\u{1F9E0}", D7: "Don't lose your \
streak! Log in now and keep the blocks falling in Block Puzzle Social. \u{1F4C8}\u{1F9F1}" } } };
    }
  });
  ...
  var init_console = __esm({
    "extensions/ludex/libs/common/console.ts"() {
      ...
      if (false) {
        wc.info = wc.log = wc.dir = wc.warn = wc.error = wc.debug = wc.table = wc.trace = wc.group =
        wc.groupEnd = wc.groupCollapsed = () => {
        };
      }
    }
  });
  ...
  var init_init_core = __esm({
    "extensions/ludex/libs/init-core.ts"() {
      ...
      finalizeAnalyticsInitialization = /* @__PURE__ */ __name(() => {
        const {
          Events: Events11,
          Plugins: { Analytics: { Events: AnalyticsEvents2 } = {} }
        } = Ludex;
      ...
      initGameSDK = /* @__PURE__ */ __name(async (retryCount = 0) => {
        try {
          ...
          if (retryCount >= MAX_RETRY) {
            console.error(`initGameSDK: ${error}`);
            logError(error);
            return;
          }
    ...
    "extensions/ludex/src/game-sdk/sdk/Context.ts"() {
      ...
      _Context = class _Context {
        ...
        initContextInfo(contextId2, contextType2) {
          const { Array: A10, String: S10 } = Ludex.Utils;
          this.contextIdsByCreate$ = {};
          this.playerIdsInContexts$ = {};
          this.contextIdsByChoose$ = A10.fillWith(10, () => S10.generateObjectId());
        ...
        async createAsync(playerId2) {
          ...
          if (!this.contextIdsByCreate$[playerId2]) {
            ...
            this.contextIdsByCreate$[playerId2] = S10.generateObjectId();
          }
        ...
        createPlayerIdsInContext$(contextId2, maxPlayers) {
          if (!this.playerIdsInContexts$[contextId2]) {
            ...
            const playerIds = A10.fillWith(rand, () => S10.generateObjectId());
    ...
    "extensions/ludex/src/game-sdk/sdk/Extra.ts"() {
      ...
      _Extra = class _Extra {
        ...
        getErrorMessage(error) {
          const { Valid: V35, Object: O30 } = Ludex.Utils;
          if (!O30.hasOwn(error, "message") || !V35.isString(error.message)) return null;
        ...
        exceptionMethodNotImplemented() {
          this.throwNewCommonError$("METHOD_NOT_IMPLEMENTED" /* METHOD_NOT_IMPLEMENTED */, "Method n\
ot implemented");
        }
        ...
        exceptionSameContext() {
          this.throwNewCommonError$("SAME_CONTEXT" /* SAME_CONTEXT */, "Must specify a context other\
 than the current one.");
  ...
  // extensions/ludex/src/game-sdk/sdk/OverlayViews.ts
  var _OverlayViews, OverlayViews, OverlayViews_default;
  var init_OverlayViews = __esm({
    "extensions/ludex/src/game-sdk/sdk/OverlayViews.ts"() {
      "use strict";
      init_define_GAME_CONFIG();
      init_define_GAME_SDK_CONFIG();
      ...
      init_performance();
      init_google_analytics();
      _OverlayViews = class _OverlayViews {
        adapter$;
        extra$;
        ...
        createOverlayView(_fullyQualifiedOverlayViewFilename, _pathToCSS, _initialData, _onInitializedSuccessCallback, _onInitializedErrorCallback) {
          this.extra$.exceptionClientUnsupportedOperation("createOverlayView callback-based is not s\
upported in mock mode");
        }
        createOverlayViewWithXMLString(_xmlString, _pathToCSS, _initialData, _onInitializedSuccessCallback, _onInitializedErrorCallback) {
          this.extra$.exceptionClientUnsupportedOperation("createOverlayViewWithXMLString callback-b\
ased is not supported in mock mode");
        }
        setCustomEventHandler(_callback) {
        }
        async createOverlayViewAsync(fullyQualifiedOverlayViewFilename, domElement, iFrameStyle, pathToCSS, initialData) {
          await this.loadMockOverlayView$();
          if (!this.MockOverlayView$) {
            this.extra$.exceptionUnsupported();
          }
          const mockOverlay = new this.MockOverlayView$(
          ...
          await mockOverlay.initialize$();
          return mockOverlay;
        }
        async createOverlayViewWithXMLStringAsync(_overlayViewContentOverride, _domElement, _iFrameStyle, _pathToCSS, _initialData, _pathToOverlayFiles) {
          this.extra$.exceptionClientUnsupportedOperation("createOverlayViewWithXMLStringAsync is no\
t supported in mock mode");
        }
        async createProfilePictureOverlayViewAsync(_domElement, _imageStyle, _iFrameStyle) {
          this.extra$.exceptionClientUnsupportedOperation("createProfilePictureOverlayViewAsync is n\
ot supported in mock mode");
        }
        async createProfileNameOverlayViewAsync(_domElement, _textStyle, _iFrameStyle, _pathToCss) {
          this.extra$.exceptionClientUnsupportedOperation("createProfileNameOverlayViewAsync is not \
supported in mock mode");
        }
        async loadMockOverlayView$() {
          if (this.MockOverlayView$) return;
          const MockOverlayView = (await Promise.resolve().then(() => (init_empty_script(), empty_script_exports))).
          default;
          if (typeof MockOverlayView !== "function") return;
          this.MockOverlayView$ = MockOverlayView;
        }
      };
      __name(_OverlayViews, "OverlayViews");
      OverlayViews = _OverlayViews;
      OverlayViews_default = OverlayViews;
    }
  });
  ...
  var init_Payments = __esm({
    "extensions/ludex/src/game-sdk/sdk/Payments.ts"() {
      ...
      init_performance();
      init_google_analytics();
      CommonErrorList = ["Unsupported", "NetworkFailure", "PendingRequest", "ClientUnsupportedOperat\
ion"];
      ...
      _Payments = class _Payments {
        ...
        async initPaymentInfoAsync() {
          const { Mockup: Mockup3 } = Ludex.Configs;
          const { Enabled } = Mockup3.GameSDK.Payments;
          if (!Enabled) return;
        ...
        createMockPurchaseAsync$(config) {
          ...
          const purchase = {
            ...
            paymentID: S10.generateObjectId(),
            purchaseToken: S10.generateObjectId(),
            purchaseTime: (/* @__PURE__ */ new Date()).toISOString(),
            developerPayload: config.developerPayload,
            signedRequest: S10.generateObjectId()
          };
          const playerId2 = this.adapter$.player.getID();
          if (playerId2) {
            const purchasesData = this.getPurchasesData$();
        ...
        getProductsData$() {
          const {
            Utils: { Browser: B3, Valid: V35 }
          } = Ludex;
          const data = B3.getLocalStorage(PRODUCTS_DATA_MOCK_KEY);
        ...
        writeProductsData$(products) {
          ...
          if (!V35.isObject(products)) return;
          B3.writeLocalStorage(PRODUCTS_DATA_MOCK_KEY, products);
        }
        getPurchasesData$() {
          const {
            Utils: { Browser: B3, Valid: V35 }
          } = Ludex;
          const data = B3.getLocalStorage(PURCHASES_DATA_MOCK_KEY);
          if (!V35.isObject(data)) return {};
          return data;
        }
        writePurchasesData$(playerId2, purchases) {
          ...
          B3.writeLocalStorage(PURCHASES_DATA_MOCK_KEY, data);
        }
        handleOnYes$ = /* @__PURE__ */ __name((resolve) => () => {
          this.extra$.isPopupShown = false;
          resolve(true);
  ...
  var init_Player = __esm({
    "extensions/ludex/src/game-sdk/sdk/Player.ts"() {
      ...
      init_performance();
      init_google_analytics();
      GameName = "Block Puzzle Social".replace(/ /g, "-");
      ...
      _Player = class _Player {
        ...
        initPlayerInfo(playerId2) {
          ...
          B3.writeLocalStorage(this.infoKey$, this.currentPlayerInfo$);
        }
        ...
        async getDataAsync(keys) {
          ...
          const {
            Utils: { Browser: B3, Valid: V35, Object: O30 }
          } = Ludex;
          const data = B3.getLocalStorage(this.dataKey$);
          if (!V35.isObject(data)) return {};
          const dataObject = {};
          for (const key of keys) {
            if (O30.hasOwn(data, key)) {
        ...
        async setDataAsync(data) {
          ...
          B3.writeLocalStorage(this.dataKey$, data);
        }
        ...
        updateCurrentPlayerInfo$(playerId2) {
          const {
            Utils: { Browser: B3, Valid: V35, Object: O30, String: S10 }
          } = Ludex;
          let currentId = playerId2 ?? "";
          let currentName = "Nameless";
          if (this.extra$.isGuest) {
            const data = B3.getLocalStorage(this.infoKey$);
            if (V35.isObject(data) && O30.hasOwn(data, "playerId") && V35.isString(data.playerId)) {
              currentId = data.playerId;
            }
            if (V35.isObject(data) && O30.hasOwn(data, "playerName") && V35.isString(data.playerName)) {
              currentName = data.playerName;
            }
          }
          if (V35.isEmpty(currentId)) {
            currentId = S10.generateObjectId();
          }
          if (currentName === "Nameless" && this.isUseNameGenerator$()) {
            currentName = S10.generateNameUsingString(currentId);
          }
  ...
  var init_Tournament = __esm({
    "extensions/ludex/src/game-sdk/sdk/Tournament.ts"() {
      ...
      CommonErrorList2 = ["Unsupported", "NetworkFailure", "PendingRequest", "ClientUnsupportedOpera\
tion"];
      ...
      _Tournament = class _Tournament {
        ...
        async createMockTournamentsData$() {
          ...
          const allTournaments = O30.vals(tournamentsData);
        ...
        createDefaultTournaments$(length) {
          const {
            Utils: { String: S10, Array: A10, Number: N },
            Configs: {
              Mockup: {
                GameSDK: {
          ...
          return A10.length(length).map(async () => {
            const title = `${playerName}'s Tournament ${S10.generateObjectId()}`;
        ...
        async getTournamentsAsync() {
          ...
          const tournaments = O30.vals(tournamentsData);
        ...
        getTournamentInstance$(id) {
          ...
          return {
            ...
            getTournamentType: /* @__PURE__ */ __name(() => tournamentData.tournamentType, "getTourn\
amentType")
          };
        }
        ...
        getTournamentsData$() {
          ...
          const data = B3.getLocalStorage(TOURNAMENTS_DATA_MOCK_KEY);
          if (!V35.isObject(data)) return {};
          return data;
        }
        writeTournamentsData$(tournaments) {
          ...
          if (!V35.isObject(tournaments)) return;
          B3.writeLocalStorage(TOURNAMENTS_DATA_MOCK_KEY, tournaments);
        }
        ...
        getTournamentLeadersData$(tournamentId) {
          const {
            Utils: { Browser: B3, Object: O30 }
          } = Ludex;
          const data = B3.getLocalStorage(TOURNAMENT_LEADERS_MOCK_KEY);
          if (!O30.hasOwn(data, tournamentId)) return [];
        ...
        writeTournamentLeadersData$(tournamentId, tournamentLeaders) {
          ...
          if (!Array.isArray(tournamentLeaders)) return;
          const data = B3.getLocalStorage(TOURNAMENT_LEADERS_MOCK_KEY) ?? {};
          O30.assign(data, { [tournamentId]: tournamentLeaders });
          B3.writeLocalStorage(TOURNAMENT_LEADERS_MOCK_KEY, data);
        }
      };
    ...
    "extensions/ludex/src/game-sdk/sdk/GameSDK.ts"() {
      ...
      _GameSDK = class _GameSDK {
        ...
        initialize$() {
          ...
          this.overlayViews = new OverlayViews_default(this);
        }
        isNeedSDK$() {
          const gameConfig = define_GAME_SDK_CONFIG_default;
        ...
        getEntryPointData() {
          const {
            Utils: { Browser: B3, Json: J6 }
          } = Ludex;
          const { payload = "{}" } = B3.getQueryParams();
        ...
        async getTournamentAsync() {
          ...
          const { Array: A10, Valid: V35 } = Ludex.Utils;
          if (!V35.isString(currentContextID)) {
  ...
  var defaultInstance, SHOW_AD_REQUEST_TIMEOUT_MS, ErrorCodes, _MSAdInstance, MSAdInstance, MSAdInstance_default;
  var init_MSAdInstance = __esm({
    "extensions/ludex/src/game-sdk/adapters/msgames/MSAdInstance.ts"() {
      ...
      SHOW_AD_REQUEST_TIMEOUT_MS = 30 * 1e3;
      ErrorCodes = {
        ...
        async loadAsync() {
          try {
            if (this.isAdShowInProgress$) {
              throw this.makeErrorWithCode$(ErrorCodes.INVALID_OPERATION, "Can't load ads while show\
ing ads");
            }
        ...
        async showAsync() {
          if (!this.instance$.instanceId) {
            throw this.makeErrorWithCode$(ErrorCodes.AD_NOT_LOADED, "Ad is not loaded. InstanceId is\
 empty");
          }
          if (this.isAdShowInProgress$) {
            throw this.makeErrorWithCode$(ErrorCodes.INVALID_OPERATION, "Can't show ads while showin\
g ads");
          }
          try {
            this.isAdShowInProgress$ = true;
            await this.processShowAd$(this.instance$.instanceId);
        ...
        async processShowAd$(instanceId) {
          ...
          try {
            const instance = await F6.timeOut(this.sdk$.showAdsAsync(instanceId), SHOW_AD_REQUEST_TIMEOUT_MS);
            ...
            if (error instanceof Error && error.message === "Timeout") {
              throw this.makeErrorWithCode$(ErrorCodes.SHOW_ADS_TIMEOUT, "Ad display request timed o\
ut");
            }
        ...
        isErrorWithCode$(error) {
          ...
          return O30.hasOwn(error, "code") && typeof error.code === "string";
        }
        getErrorReason$(error) {
          const {
            Utils: { Object: O30 }
          } = Ludex;
          if (O30.hasOwn(error, "message") && typeof error.message === "string") {
            return { reason: error.message };
          }
          if (O30.hasOwn(error, "description") && typeof error.description === "string") {
  ...
  var init_MSExtra = __esm({
    "extensions/ludex/src/game-sdk/adapters/msgames/MSExtra.ts"() {
      ...
      _MSExtra = class _MSExtra extends Extra_default {
        ...
        listenEvent$() {
          const { event } = codex;
          const { PLAYER_SETTINGS_CHANGED: PLAYER_SETTINGS_CHANGED2, PLAYER_INFO_LOADED } = Ludex.Events;
          event.on(PLAYER_SETTINGS_CHANGED2, this.handleMusicSettingsChanged$);
          event.once(PLAYER_INFO_LOADED, this.handlePlayerInfoLoaded$);
        }
        ...
        async shareAsync() {
          try {
            if (!this.shareImageBase64$) {
              const base64 = await this.loadImageAsync$("./share-400x400.jpg");
              if (base64) {
        ...
        async loadImageAsync$(path) {
          ...
          try {
            const blob = await Promise.race([
              fetchImage(path),
              T3.sleepAsync(5e3).then(() => {
                throw new Error(`Image fetch timeout: ${path}`);
              })
            ]);
        ...
        getDevPlaygroundAppId() {
          const { Valid: V35 } = Ludex.Utils;
          if (this.devPlaygroundAppId$ && V35.isDebugger()) {
            return this.devPlaygroundAppId$;
          }
          return null;
        }
        getGameId() {
          const { Configs: { AppId: AppId6 } } = Ludex;
          const gameId = this.getDevPlaygroundAppId();
          return gameId ?? AppId6;
        }
        ...
        exceptionSignatureVerificationFailed(message) {
          this.throwMSSDKError$("SIGNATURE_VERIFICATION_FAILED" /* SIGNATURE_VERIFICATION_FAILED */,
          message);
        }
        handleMusicSettingsChanged$ = /* @__PURE__ */ __name((payload) => {
          const { name: name2 } = payload;
          if (name2 !== "music") return;
          const { Valid: V35 } = Ludex.Utils;
          const { value } = payload;
          if (!V35.isBoolean(value)) return;
          this.handlePlatformAudioSync$(value);
        }, "handleMusicSettingsChanged$");
        handlePlayerInfoLoaded$ = /* @__PURE__ */ __name(() => {
          const { player } = codex;
          const { Valid: V35 } = Ludex.Utils;
          const isMusicEnabled = player.getPlayerSetting("music");
          if (!V35.isBoolean(isMusicEnabled)) return;
          this.handlePlatformAudioSync$(isMusicEnabled);
        }, "handlePlayerInfoLoaded$");
        handlePlatformAudioSync$ = /* @__PURE__ */ __name((enabled) => {
          if (enabled) {
            this.sdk$.notifyGameUnmuted();
          } else {
            this.sdk$.notifyGameMuted();
          }
        }, "handlePlatformAudioSync$");
      };
  ...
  var init_MSPayments = __esm({
    "extensions/ludex/src/game-sdk/adapters/msgames/MSPayments.ts"() {
      ...
      init_google_analytics();
      init_Payments();
      PUBLIC_KEY = "<RSAKeyValue><Modulus>0hFO5sN1aB78G7NxMCdgAnHga8CmptR1Gq5WQ0L3OmkIU+XEQT0bq9JgzS\
IfW0K3pYkkO1dmDYoVmHWF13GCqPQYVENhRRA5jGKRpo+efXJ/dkodB3D8rsAOPN0BUjvYZxf2FgfWHkrblpkWZ6iTpZ5LobSeTT\
W97ZURGsdpolGQLSp8xsap38tBk0db0Pn1nn9It5vun/nJxthccM2rerc1rVI0inLVID/qvwBUM/iXBt4uwnOqIg/egLDewaySg2\
+SVt4SWTaGHB+qYoSrcceO1eHVGjRUemX6/dsAcVSOZDiszEEcDxY3EwhcPbKU762SX9jUQIeFi4UB+9ckMQ==</Modulus><Exp\
onent>AQAB</Exponent></RSAKeyValue>";
      _MSPayments = class _MSPayments extends Payments_default {
        ...
        async getRSAKeyFromXML$(xmlString) {
          ...
          const convertToUrl = /* @__PURE__ */ __name((base64) => base64.replace(/\+/g, "-").replace(
          /\//g, "_").replace(/=/g, ""), "convertToUrl");
          const jwk = {
            kty: "RSA",
...
.");
        ...
        async getAllAddOnsAsync$() {
          const gameId = this.extra$.getGameId();
          const response = await this.iap$.getAllAddOnsAsync({ productId: gameId });
          if ("code" in response) {
        ...
        async getPreviousPurchaseAsync(productId) {
          ...
          const isValid = await this.verifyPurchaseSuccessResponse$(response);
          if (!isValid) {
            this.extra$.exceptionSignatureVerificationFailed("Previous purchase signature verificati\
on failed.");
          }
          return response;
        }
        ...
        async getAllPurchasesAsync$() {
          ...
          if (!isValid) {
            this.extra$.exceptionSignatureVerificationFailed("All purchases signature verification f\
ailed.");
          }
          return response;
        }
    ...
    "extensions/ludex/src/game-sdk/adapters/msgames/MSPlayer.ts"() {
      ...
      _MSPlayer = class _MSPlayer extends Player_default {
        ...
        validateLoginAttempts$() {
          const { Browser: B3, Valid: V35, Object: O30, Time: T3 } = Ludex.Utils;
          const data = B3.getLocalStorage(LOCAL_STORE_KEY);
          let attempts = 0;
          const now = Date.now();
          if (O30.hasOwn(data, "loginAttempts") && V35.isNumber(data.loginAttempts)) {
            attempts = data.loginAttempts;
          }
          if (O30.hasOwn(data, "lastLoginAttempt") && V35.isNumber(data.lastLoginAttempt)) {
          ...
          B3.writeLocalStorage(LOCAL_STORE_KEY, {
        ...
        pickOwnDataKeys$(data, keys) {
          const { Object: O30 } = Ludex.Utils;
          const requiredData = {};
          for (const key of keys) {
            if (O30.hasOwn(data, key)) {
        ...
        async getDataAsync(keys) {
          if (this.isFallback$() || this.extra$.isGuest) {
            return super.getDataAsync(keys);
          }
          const data = await this.requestCloudSaveDataAsync$();
          if (keys.length < 1) return data;
          return this.pickOwnDataKeys$(data, keys);
        }
        async setDataAsync(data) {
          if (this.isFallback$() || this.extra$.isGuest) {
            return super.setDataAsync(data);
          }
          return this.updateCloudSaveDataAsync$(data);
        }
        async requestCloudSaveDataAsync$() {
          const gameId = this.extra$.getDevPlaygroundAppId();
          const config = gameId ? { gameId } : {};
          const response = await this.cloudSave$.getDataAsync(config);
          this.validateCloudSaveData$(response);
          return this.normalizeCloudSaveResponse$(response);
        }
        validateCloudSaveData$(response) {
          ...
          if (isCodePresent && isDescriptionPresent) {
            this.extra$.exceptionNetworkFailure(description);
          }
        }
        async updateCloudSaveDataAsync$(data) {
          const { Valid: V35, Json: J6 } = Ludex.Utils;
          const patch = {};
          for (const [key, value] of Object.entries(data)) {
            if (value === void 0) {
              this.extra$.exceptionInvalidParam(`Unsupported value type for key "${key}": undefined`);
            }
            if (value === null) {
              patch[key] = null;
            } else if (V35.isString(value) || V35.isNumber(value) || V35.isBoolean(value)) {
              patch[key] = value;
            } else if (V35.isObject(value) || Array.isArray(value)) {
              const serializedValue = J6.encode(value);
              if (!serializedValue) {
                this.extra$.exceptionInvalidParam(`Failed to serialize value for key "${key}"`);
              }
              patch[key] = serializedValue;
            } else {
              this.extra$.exceptionInvalidParam(`Unsupported value type for key "${key}"`);
            }
          }
          const serialized = JSON.stringify(patch);
          const serializedBytes = new TextEncoder().encode(serialized).length;
          if (serializedBytes > 1048576) {
            this.extra$.exceptionInvalidParam("Cloud save patch exceeds 1 MB limit");
          }
          const gameId = this.extra$.getDevPlaygroundAppId();
          ...
          if ("code" in response) {
            this.extra$.exceptionNetworkFailure(response.description);
          }
        }
        normalizeCloudSaveResponse$(response) {
          const { Json: J6, Valid: V35 } = Ludex.Utils;
          const result3 = {};
          if ("stringContent" in response && typeof response.stringContent === "string") {
            const parsed = J6.decode(response.stringContent);
            if (V35.isObject(parsed)) {
          ...
          for (const [key, value] of Object.entries(response)) {
            if (key === "stringContent") continue;
            if (value === null || value === void 0) continue;
            if (typeof value !== "string") {
              result3[key] = value;
              continue;
            }
            const parsed = J6.decode(value);
            const isDecoded = V35.isObject(parsed) || Array.isArray(parsed) || V35.isNumber(parsed) ||
            V35.isBoolean(parsed);
            result3[key] = isDecoded ? parsed : value;
          }
          return result3;
        }
      };
  ...
  var init_MSAdapter = __esm({
    "extensions/ludex/src/game-sdk/adapters/msgames/MSAdapter.ts"() {
      ...
      _MSAdapter = class _MSAdapter extends GameSDK_default2 {
        ...
        // ? Microsoft Games already provides mock ads for testing — no Ludex mock ads needed here.
        async getInterstitialAdAsync() {
          return new MSAdInstance_default("interstitial", this.sdk);
        }
        async getRewardedVideoAsync() {
          return new MSAdInstance_default("rewarded", this.sdk);
        }
    ...
    "extensions/ludex/src/utils/function/accessBlocker.ts"() {
      ...
      _AccessBlocker = class _AccessBlocker {
        ...
        getCallerLine$() {
          ...
          const callerLine = lineEnd === -1 ? stack.substring(lineStart) : stack.substring(lineStart,
          lineEnd);
  ...
  function autoDetectAndInitializeSDKAdapter() {
    ...
    if ("FBInstant" in w) {
      ...
      sdkName = "YoutubePlayables";
      sdkAdapter = new empty_script_default(window.ytgame);
    } else if ("TTMinis" in w) {
      sdkName = "TikTok";
      sdkAdapter = new empty_script_default(window.TTMinis);
    } else {
      ...
      EventEmitter2.prototype.removeListener = /* @__PURE__ */ __name(function removeListener(event, fn2, context, once) {
        ...
        if (listeners2.fn) {
          ...
          for (var i = 0, events = [], length = listeners2.length; i < length; i++) {
            if (listeners2[i].fn !== fn2 || once && !listeners2[i].once || context && listeners2[i].
            context !== context) {
  ...
  var CoreEvents = {
    ...
    /**
     * Event fired when the player settings is changed.
     */
    ...
    /**
     * Event fired when the screen is loading.
     */
    LOADING_SCREEN: "loading-screen",
    /**
     * Event fired when the screen is loaded.
     */
  ...
  // extensions/ludex/src/utils/browser/openIndexedDB.ts
  var gameName = "Block Puzzle Social";
  var dbInstances = {};
 ...
 ")}`
      ...
      return (target, propertyKey, descriptor) => {
        ...
        try {
          ...
          if (error instanceof Error) {
            ...
            console.warn("[Decorator:validateValue] unknown error", {
              cause: error
            });
          }
          return descriptor;
  ...
  var _WebWorker = class _WebWorker {
    ...
    static get inst() {
      if (!_WebWorker._inst$) {
        _WebWorker._inst$ = new _WebWorker();
      }
      return _WebWorker._inst$;
    }
    init() {
    ...
    static postMessage(action, payload) {
      if (!_WebWorker.inst.worker$) {
        throw new Error("Worker is not initialized");
      }
      _WebWorker.inst.worker$.postMessage({ action, payload });
    }
  };
  ...
  // extensions/ludex/src/utils/device/getSafeAreaBottom.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
...
ttom:env(safe-area-inset-bottom);";
    ...
    if (isIOS_default()) {
      ...
      const knownNotchDimensions = [
        "375,812",
        // iPhone X, XS, 11 Pro, 12 Mini, 13 Mini (approx)
        "360,780",
        // 12 Mini, 13 Mini (actual viewport usually)
        "414,896",
      ...
      if (knownNotchDimensions.includes(`${min},${max}`)) {
        return 34;
      }
      if (max / min > 2) {
        return 34;
  ...
  var getSafeAreaBottom_default = func51;
  ...
  var func52 = /* @__PURE__ */ __name(() => {
    try {
      const { context, canvas } = createCanvas_default({
        contextType: "webgl",
        type: "canvas"
      }) ?? {};
  ...
  var gpuRenderer_default = func52;
  ...
  var hardwareConcurrency_default = func53;
  ...
  var isSupportWebp_default = func59;
  ...
  var maxTextureSize_default = func60;
  ...
  var orientation_default = func61;
  ...
  var webglVersion_default = func62;
  ...
  init_performance();
  init_google_analytics();
  var func64 = /* @__PURE__ */ __name((promises) => {
  ...
  init_performance();
  init_google_analytics();
  var func65 = /* @__PURE__ */ __name(async (promise, timeout) => {
    try {
      if (timeout) {
  ...
  var handleAsync_default = func65;
  ...
  // extensions/ludex/src/utils/function/overlay.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  init_performance();
  init_google_analytics();
  var func67 = /* @__PURE__ */ __name((obj, key) => {
  ...
  init_performance();
  init_google_analytics();
  var func68 = /* @__PURE__ */ __name((input) => typeof input === "function", "func");
  var isFunction_default = func68;

  // extensions/ludex/src/utils/function/overlay.ts
  var func69 = /* @__PURE__ */ __name((original, obj) => {
    return new Proxy(original, {
      get: /* @__PURE__ */ __name((target, prop) => {
        if (hasOwn_default(obj, prop)) {
          const val2 = obj[prop];
          if (isFunction_default(val2)) {
            return val2.bind(obj);
          }
          return val2;
        }
        ...
        if (val && val.name) {
          console.warn(
            `Overlay: property or method "${prop}" does not exist on the ${target.constructor.name} \
object`,
            { val }
          );
        }
  ...
  init_performance();
  init_google_analytics();
  var func70 = /* @__PURE__ */ __name((firstTry, secondTry) => {
    try {
      return firstTry();
    } catch (firstError) {
      try {
  ...
  init_performance();
  init_google_analytics();
  var func71 = /* @__PURE__ */ __name(async (firstTry, secondTry) => {
    try {
  ...
  init_performance();
  init_google_analytics();
  var func72 = /* @__PURE__ */ __name((config) => {
  ...
  var func73 = /* @__PURE__ */ __name((source) => {
  ...
  var syncVarsFromSource_default = func73;
  ...
  init_performance();
  init_google_analytics();
  var func74 = /* @__PURE__ */ __name((promise, duration) => {
    if (duration <= 0) {
      return promise;
    }
    return Promise.race([
  ...
  init_performance();
  init_google_analytics();
  var func75 = /* @__PURE__ */ __name((duration) => {
  ...
  init_performance();
  init_google_analytics();
  var func76 = /* @__PURE__ */ __name((data) => {
    const inverse = {};
    for (const key in data) {
  ...
  var func77 = /* @__PURE__ */ __name((hash, codeMap) => {
    const str = hash;
  ...
  init_performance();
  init_google_analytics();
  var func78 = /* @__PURE__ */ __name((data) => typeof data === "string", "func");
  var isString_default = func78;
  ...
  var func79 = /* @__PURE__ */ __name((data, codeMap, isRecursive = false) => {
    let str = "";
  ...
  init_performance();
  init_google_analytics();
  var func80 = /* @__PURE__ */ __name((hash, token) => {
    try {
      if (!hash) return "";
      if (token) {
  ...
  var hashToString_default = func80;
  ...
  var func81 = /* @__PURE__ */ __name((str, customDict, level2 = 1) => {
    let word = str[0];
    const result3 = [];
  ...
  var lzwCompress_default = func81;
  ...
  var func82 = /* @__PURE__ */ __name((hash, customDict, level2 = 1) => {
    let entry = "";
    let result3 = "";
  ...
  var lzwDecompress_default = func82;
  ...
  init_performance();
  init_google_analytics();
  var func83 = /* @__PURE__ */ __name((str, token) => {
    try {
      if (!str) return "";
      if (token) {
  ...
  var stringToHash_default = func83;
  ...
  init_performance();
  init_google_analytics();
  var func84 = /* @__PURE__ */ __name((blob) => {
    return new Promise((resolve, reject) => {
  ...
  var blobToDataImage_default = func84;
  ...
  init_google_analytics();
  var img = new Image();
  var func85 = /* @__PURE__ */ __name((blob, forceNew = true, autoRevoke = true) => {
    return new Promise((resolve) => {
  ...
  var blobToHtmlImage_default = func85;
  ...
  init_performance();
  init_google_analytics();
  var func86 = /* @__PURE__ */ __name(async (blobUrl, fileName) => {
    const blob = await fetch(blobUrl).then((r) => r.blob()).catch(() => null);
    if (!blob) return null;
    return new File([blob], fileName);
  }, "func");
  var blobUrlToFile_default = func86;
  ...
  var func87 = /* @__PURE__ */ __name(async (element, type = "png") => {
  ...
  var elementToBase64_default = func87;
  ...
  var func88 = /* @__PURE__ */ __name(async (element, type = "png") => {
    try {
      if (!result2) {
  ...
  var elementToBlob_default = func88;
  ...
  init_performance();
  init_google_analytics();
  var func89 = /* @__PURE__ */ __name(async (url) => {
  ...
  init_performance();
  init_google_analytics();
  var func90 = /* @__PURE__ */ __name(async (url) => {
    return new Promise((resolve, reject) => {
  ...
  var func91 = /* @__PURE__ */ __name((url, scale = 1) => {
    return new Promise((resolve) => {
      ...
      img2.onload = () => {
        ...
        console.info(
          `%c ${dim.string}`,
          `${dim.style} background: transparent url(${url}) no-repeat center center; background-size\
: ${width}px ${height}px;`
        );
        resolve(true);
      };
  ...
  var _Mark = class _Mark {
    ...
    static setService(service) {
      if (!service) return;
      _Mark.inst.perf$ = service;
    }
    static measure(name2) {
      const perf = _Mark.inst.perf$;
      if (_Mark.isBaseService$(perf)) {
        perf.measure(name2);
      }
    }
    static start(name2) {
      const perf = _Mark.inst.perf$;
      if (_Mark.isConsole$(perf)) {
        perf.time(name2);
      } else if (_Mark.isPerformance$(perf)) {
        perf.mark(`${name2}_start`);
      } else if (_Mark.isBaseService$(perf)) {
        perf.start(name2);
      }
    }
    static stop(name2) {
  ...
  init_performance();
  init_google_analytics();
  var func92 = /* @__PURE__ */ __name((value, maxLength) => {
  ...
  var getShortNumber_default = func92;
  ...
  init_performance();
  init_google_analytics();
  var func94 = /* @__PURE__ */ __name((num) => {
    if (num > 0) return 1;
    if (num < 0) return -1;
    if (num === 0) return 0;
    return Number.NaN;
  }, "func");
  var sign_default = func94;
  ...
  // extensions/ludex/src/utils/object/camelCaseKeys.ts
  var func95 = /* @__PURE__ */ __name((obj) => {
    const newObj = {};
  ...
  var camelCaseKeys_default = func95;
  ...
  init_performance();
  init_google_analytics();
  var func96 = /* @__PURE__ */ __name((x, y) => {
    if (x === y) {
      return x !== 0 || 1 / x === 1 / y;
    }
    return x !== x && y !== y;
  }, "func");
  var is_default = func96;
...
n") {
  ...
  var func97 = /* @__PURE__ */ __name((source, target) => {
    return diffRecursive(source, target, /* @__PURE__ */ new WeakMap());
  }, "func");
  var diff_default = func97;
  ...
  init_performance();
  init_google_analytics();
  var func98 = /* @__PURE__ */ __name((data, keys = []) => {
    const result3 = {};
  ...
  init_performance();
  init_google_analytics();
  var func99 = /* @__PURE__ */ __name((source, input) => {
    const result3 = {};
      ...
      if (hasOwn_default(input, key)) {
        if (isObject_default(input[key]) && input[key] !== null) {
          if (isObject_default(source[key]) && source[key] !== null) {
            ...
            const filteredSubObject = func99(source[key], input[key]);
  ...
  init_performance();
  init_google_analytics();
  var func100 = /* @__PURE__ */ __name((value, object) => {
    return Object.values(object).includes(value);
  }, "func");
  var isIn_default = func100;
  ...
  init_performance();
  init_google_analytics();
  var func101 = /* @__PURE__ */ __name((key) => {
    return ["string", "number", "symbol"].indexOf(typeof key) > -1;
  }, "func");
  var isPropertyKey_default = func101;

  // extensions/ludex/src/utils/object/keyBy.ts
  var func102 = /* @__PURE__ */ __name((array, key) => {
    const result3 = {};
  ...
  // extensions/ludex/src/utils/object/snakeCaseKeys.ts
  var func103 = /* @__PURE__ */ __name((obj) => {
    const newObj = {};
    for (const key in obj) {
      const value = obj[key];
  ...
  var snakeCaseKeys_default = func103;
  ...
  init_performance();
  init_google_analytics();
  var func104 = /* @__PURE__ */ __name((object) => {
    return Object.keys(object).map((key) => {
      return object[key];
    });
  }, "func");
  var vals_default = func104;
  ...
  init_performance();
  init_google_analytics();
  var func105 = /* @__PURE__ */ __name((str) => {
    if (!str) return str;
    return str[0].toUpperCase() + str.slice(1);
  }, "func");
  var capitalize_default = func105;
  ...
  var func106 = /* @__PURE__ */ __name(async () => {
    try {
      if (!names) {
  ...
  var generateNameAsync_default = func106;
  ...
  init_performance();
  init_google_analytics();
  var func107 = /* @__PURE__ */ __name((radix = 16) => {
  ...
  var generateObjectId_default = func107;
  ...
  init_performance();
  init_google_analytics();
  var func108 = /* @__PURE__ */ __name((locale2) => {
  ...
  var getLanguageCode_default = func108;
  ...
  init_performance();
  init_google_analytics();
  var func109 = /* @__PURE__ */ __name((name2, length) => {
  ...
  var getShortName_default = func109;
  ...
  init_performance();
  init_google_analytics();
  var func110 = /* @__PURE__ */ __name((str) => {
    let hash = 0;
  ...
  init_performance();
  init_google_analytics();
  var func111 = /* @__PURE__ */ __name((value, length, pad = " ") => {
  ...
  init_performance();
  init_google_analytics();
  var func112 = /* @__PURE__ */ __name((payload) => {
  ...
  init_performance();
  init_google_analytics();
  var func113 = /* @__PURE__ */ __name((len, startWith) => {
  ...
  var func114 = /* @__PURE__ */ __name((prefix = "0x") => {
    let color = prefix;
    for (let i = 0; i < 6; i++) {
  ...
  var randomColor_default = func114;
  ...
  init_performance();
  init_google_analytics();
  var func115 = /* @__PURE__ */ __name((str) => {
    const result3 = str.normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/[đĐ]/g, (m) => m ===
    "\u0111" ? "d" : "D");
    return result3;
  }, "func");
  var removeDiacritics_default = func115;
  ...
  var func116 = /* @__PURE__ */ __name((timestamp, locales, options, fallbackMessage = "Soon") => {
    try {
  ...
  var getRelativeTime_default = func116;
  ...
  init_performance();
  init_google_analytics();
  var func117 = /* @__PURE__ */ __name((timestamp) => {
  ...
  var getTimeString_default = func117;
  ...
  init_performance();
  init_google_analytics();
  var func119 = /* @__PURE__ */ __name((milliseconds) => {
    return new Promise((resolve) => setTimeout(resolve, milliseconds));
  }, "func");
  var sleepAsync_default = func119;
  ...
  init_performance();
  init_google_analytics();
  var func120 = /* @__PURE__ */ __name((data) => typeof data === "boolean", "func");
  var isBoolean_default = func120;
  ...
  init_performance();
  init_google_analytics();
  var func121 = /* @__PURE__ */ __name(() => {
    if (true) return true;
    return !!codex?.player?.getPlayerDataByKey("debug");
  }, "func");
  var isDebugger_default = func121;
  ...
  init_performance();
  init_google_analytics();
  var func122 = /* @__PURE__ */ __name((data) => typeof data === "number", "func");
  var isNumber_default = func122;
  ...
  init_performance();
  init_google_analytics();
  var func123 = /* @__PURE__ */ __name((input) => {
  ...
  init_performance();
  init_google_analytics();
  var func124 = /* @__PURE__ */ __name((from, to, options) => {
  ...
  var isValueChangeAsync_default = func124;
  ...
  var DtosData = {};
  var ConstructorNames = /* @__PURE__ */ new WeakMap();
  var nextId = 0;
  var _BaseDtos = class _BaseDtos {
    static getName$(ctor = this) {
      let name2 = ConstructorNames.get(ctor);
      if (!name2) {
        name2 = `${ctor.name || "BaseDtos"}_${nextId++}`;
        ConstructorNames.set(ctor, name2);
      }
      return name2;
    }
    getSelf$() {
  ...
  var _AdsPlugin = class _AdsPlugin extends Ludex.Plugins.BasePlugin {
    ...
    init() {
      ...
      this.safeAreaBottom$ = D.getSafeAreaBottom();
    }
  ...
  var _AdsenseFunnel = class _AdsenseFunnel extends BaseFunnel_default {
    ...
    funnelSteps$ = [
      {
        ...
        required$: true,
        payload$: { adService: this.service },
    ...
    addEvent(event, payload) {
      const { adService } = payload ?? {};
      if (!adService) return;
      const isRelevantEvent = adService === this.service || event === Events_default.AD_LOAD_FAILED &&
      adService === "platform";
  ...
  var _PlatformAdsFunnel = class _PlatformAdsFunnel extends BaseFunnel_default {
    ...
    addEvent(event, payload) {
      if (payload?.adService !== this.service) return;
      super.addEvent(event, payload);
    }
  };
  ...
  var _AnalyticsPlugin = class _AnalyticsPlugin extends Ludex.Plugins.BasePlugin {
    ...
    mergePayload$(source, target) {
      ...
      return O30.merge(source, target);
    }
    add(analytic) {
    ...
    async initAdEvent(payload) {
      ...
      this.logFunnelEvent$(Events_default.AD_INIT, payload);
    }
    loadInterstitialAd(payload) {
      if (!this.isActive$()) return;
      const payloadWithPage = this.mergePayload$(payload, {
  ...
  var _BaseChannelManager = class _BaseChannelManager {
    ...
    callAudioPlayers$(funcName) {
      const { Object: O30 } = Ludex.Utils;
      const audioClips = O30.vals(this.audioClips$);
  ...
  var _Context2 = class _Context2 {
    ...
    isTournamentEntryPoint$(entryPoint) {
      return A3.has(
        ["facebook~game_list~tournaments", "fb_feed_tournament_unit", "messenger~bot_thread~tourname\
nts"],
        entryPoint
      );
    }
    ...
    async detectContextSessionType() {
      ...
      const { SOLO, TOURNAMENT: TOURNAMENT2, MATCHING_GROUP: MATCHING_GROUP2, SHARE_INVITE: SHARE_INVITE2,
      CHALLENGE_FRIEND: CHALLENGE_FRIEND3 } = ContextTypes_default;
      let sessionContextType = SOLO;
      if (type === TOURNAMENT2) {
        sessionContextType = TOURNAMENT2;
      }
      if (type === MATCHING_GROUP2) {
        sessionContextType = MATCHING_GROUP2;
      }
      if (type === CHALLENGE_FRIEND3 || type === SHARE_INVITE2) {
        sessionContextType = CHALLENGE_FRIEND3;
      }
    ...
    detectContextGameMode() {
      ...
      const { TOURNAMENT: TOURNAMENT2, MATCHING_GROUP: MATCHING_GROUP2, SHARE_INVITE: SHARE_INVITE2,
      CHALLENGE_FRIEND: CHALLENGE_FRIEND3 } = ContextTypes_default;
      let contextGameMode = ContextModes_default.SINGLE;
      if (contextSessionType === TOURNAMENT2) {
        contextGameMode = ContextModes_default.TOURNAMENT;
      }
      if (contextSessionType === SHARE_INVITE2 && !isPlayer) {
        contextGameMode = ContextModes_default.CHALLENGE_FRIEND;
      }
      if (contextSessionType === CHALLENGE_FRIEND3 && matchId && isOwnerContext) {
        contextGameMode = ContextModes_default.CHALLENGE_FRIEND;
      }
      if (contextSessionType === MATCHING_GROUP2) {
  ...
  // extensions/ludex/src/plugins/context/flows/ChallengeFromPostFlow.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  // extensions/ludex/src/plugins/context/register/StepRegistry.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  // extensions/ludex/src/plugins/context/constants/StepTypes.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  var StepType = /* @__PURE__ */ ((StepType2) => {
    StepType2["StartID"] = "__start__";
    return StepType2;
  })(StepType || {});
  var StepTypes_default = StepType;

  // extensions/ludex/src/plugins/context/exception/StepIdDuplicate.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  init_performance();
  init_google_analytics();
  var _StepIdDuplicate = class _StepIdDuplicate extends Error {
    constructor(stepId) {
      super(`Duplicate step id: ${stepId}`);
    }
  };
  __name(_StepIdDuplicate, "StepIdDuplicate");
  var StepIdDuplicate = _StepIdDuplicate;
  var StepIdDuplicate_default = StepIdDuplicate;

  // extensions/ludex/src/plugins/context/exception/StepIdInvalid.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  init_performance();
  init_google_analytics();
  var _StepIdInvalid = class _StepIdInvalid extends Error {
    constructor(stepId) {
      super(`Invalid step id: ${stepId}`);
    }
  };
  __name(_StepIdInvalid, "StepIdInvalid");
  var StepIdInvalid = _StepIdInvalid;
  var StepIdInvalid_default = StepIdInvalid;

  // extensions/ludex/src/plugins/context/exception/StepNotFound.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  init_performance();
  init_google_analytics();
  var _StepNotFound = class _StepNotFound extends Error {
    constructor(stepId) {
      super(`Step not found: ${stepId}`);
    }
  };
  __name(_StepNotFound, "StepNotFound");
  var StepNotFound = _StepNotFound;
  var StepNotFound_default = StepNotFound;

  // extensions/ludex/src/plugins/context/register/StepRegistry.ts
  var _StepRegistry = class _StepRegistry {
    steps$;
    ...
    addBefore(targetStepId, step) {
      this.validateStepId$(step.id);
      this.validateStepDuplicate$(step.id);
      if (targetStepId === StepTypes_default.StartID) {
        this.steps$.unshift(step);
        return;
      }
      const targetIndex = this.getStepIndexOrThrow$(targetStepId);
      this.steps$.splice(targetIndex, 0, step);
    }
    addAfter(targetStepId, step) {
      this.validateStepId$(step.id);
      this.validateStepDuplicate$(step.id);
      if (targetStepId === StepTypes_default.StartID) {
    ...
    replace(stepId, patch) {
      this.validateStepId$(stepId);
      const index = this.getStepIndexOrThrow$(stepId);
    ...
    async runAsync(context) {
      ...
      try {
        for (const step of this.steps$) {
          ...
          const { shouldContinue, targetScene } = await this.runStep$(step, context);
          if (shouldContinue) {
            rows.push({
              stepId: step.id,
              targetScene,
        ...
        this.logResult$(rows, startedAt);
      }
      return false;
    }
    async runStep$(step, context) {
      const shouldContinue = await step.runAsync(context);
      const targetScene = context.sceneName ?? null;
      return { shouldContinue, targetScene };
    }
    logResult$(rows, startedAt) {
      const totalMs = this.getDuration$(startedAt);
      console.groupCollapsed(`\u{1F500} Steps Result (${totalMs}ms)`);
      console.table(rows);
      console.groupEnd();
    }
    validateStepId$(stepId) {
      if (typeof stepId !== "string" || stepId.trim().length === 0) {
        throw new StepIdInvalid_default(`${stepId}`);
      }
    }
    validateStepDuplicate$(stepId) {
    ...
    getStepIndexOrThrow$(stepId) {
      const index = this.findIndex$(stepId);
  ...
  var StepRegistry = _StepRegistry;
  var StepRegistry_default = StepRegistry;

  // extensions/ludex/src/plugins/context/steps/ChallengeFromPostStep.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  init_performance();
  init_google_analytics();
  var createChallengeFromPostStep = /* @__PURE__ */ __name(() => ({
    id: "ChallengeFromPost",
    runAsync: /* @__PURE__ */ __name(async (context) => {
      const opponentId = context.contextData.playerId;
      if (typeof opponentId !== "string") return true;
      const { match, player } = codex;
      ...
      if (isCurrentPlayer) {
        ...
        try {
          ...
          console.warn("ChallengeFromPostStep", error);
          await match.single.start.processAsync({ playerId: playerId2 });
        }
      }
  ...
  }), "createChallengeFromPostStep");
  var ChallengeFromPostStep_default = createChallengeFromPostStep;

  // extensions/ludex/src/plugins/context/steps/SwitchSceneStep.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  init_performance();
  init_google_analytics();
  var createSwitchSceneStep = /* @__PURE__ */ __name(() => ({
    id: "SwitchScene",
    runAsync: /* @__PURE__ */ __name(async (context) => {
  ...
  }), "createSwitchSceneStep");
  var SwitchSceneStep_default = createSwitchSceneStep;

  // extensions/ludex/src/plugins/context/flows/ChallengeFromPostFlow.ts
  var { SHARE_INVITE, CHALLENGE_FRIEND } = ContextTypes_default;
  var createChallengeFromPostFlow = /* @__PURE__ */ __name(() => ({
    id: "ChallengeFromPostFlow",
    when: /* @__PURE__ */ __name((context) => {
      const {
        contextData: { type, playerId: playerId2 },
        contextSessionType
      } = context;
      if (type !== SHARE_INVITE) return false;
      if (typeof playerId2 !== "string") return false;
      if (contextSessionType !== CHALLENGE_FRIEND) return false;
      return true;
    }, "when"),
    do: new StepRegistry_default([ChallengeFromPostStep_default(), SwitchSceneStep_default()])
  }), "createChallengeFromPostFlow");
  var ChallengeFromPostFlow_default = createChallengeFromPostFlow;

  // extensions/ludex/src/plugins/context/flows/ChallengeFromMessageFlow.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  // extensions/ludex/src/plugins/context/steps/ChallengeFromMessageStep.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  // extensions/ludex/src/plugins/context/steps/ChallengeFromMessageStep.ts
  var processContinueChallengeFromMessageAsync = /* @__PURE__ */ __name(async (payload) => {
    const { match, player } = codex;
  ...
  }, "processContinueChallengeFromMessageAsync");
  var processJoinChallengeFromMessageAsync = /* @__PURE__ */ __name(async (payload) => {
    const { match, player } = codex;
  ...
  var processResultChallengeFromMessageAsync = /* @__PURE__ */ __name(async (payload) => {
    const { match, player } = codex;
    const { contextId: contextId2, matchId, playerId: inviterId } = payload;
    const curPlayerId = player.getPlayerId();
    try {
      ...
      return "ChallengeResultScene";
    } catch (e) {
      return "DashboardScene";
    }
  }, "processResultChallengeFromMessageAsync");
  var processAwaitChallengeFromMessageAsync = /* @__PURE__ */ __name(async (payload) => {
    const { match, player } = codex;
    const { contextId: contextId2, matchId, playerId: inviterId } = payload;
    const curPlayerId = player.getPlayerId();
    try {
      ...
      return await processResultChallengeFromMessageAsync(payload);
    }
  }, "processAwaitChallengeFromMessageAsync");
  var processChallengeFromMessageAsync = /* @__PURE__ */ __name(async (payload) => {
    try {
      await processContinueChallengeFromMessageAsync(payload);
    } catch (error) {
      console.warn("processContinueChallengeFromMessageAsync", error);
      if (error instanceof PlayerHasFinishedMatch_default) {
        return await processAwaitChallengeFromMessageAsync(payload);
      }
      if (error instanceof PlayerNotJoinInMatch_default) {
        return await processJoinChallengeFromMessageAsync(payload);
      }
      return "DashboardScene";
    }
    return "GameScene";
  }, "processChallengeFromMessageAsync");
  var createChallengeFromMessageStep = /* @__PURE__ */ __name(() => ({
    id: "ChallengeFromMessage",
    runAsync: /* @__PURE__ */ __name(async (context) => {
      const { contextId: contextId2, contextData } = context;
      const { matchId, playerId: playerId2, opponentId } = contextData;
      if (typeof matchId !== "string") return true;
      if (typeof playerId2 !== "string") return true;
      if (typeof opponentId !== "string") return true;
      const sceneName = await processChallengeFromMessageAsync({
        contextId: contextId2,
        matchId,
        playerId: playerId2,
        opponentId
  ...
  }), "createChallengeFromMessageStep");
  var ChallengeFromMessageStep_default = createChallengeFromMessageStep;

  // extensions/ludex/src/plugins/context/flows/ChallengeFromMessageFlow.ts
  var { CHALLENGE_FRIEND: CHALLENGE_FRIEND2 } = ContextTypes_default;
  var createChallengeFromMessageFlow = /* @__PURE__ */ __name(() => ({
    id: "ChallengeFromMessageFlow",
    when: /* @__PURE__ */ __name((context) => {
      const {
        contextData: { type, matchId, playerId: playerId2, opponentId },
        contextSessionType
      } = context;
      if (type !== CHALLENGE_FRIEND2) return false;
      if (typeof matchId !== "string") return false;
      if (typeof playerId2 !== "string") return false;
      if (typeof opponentId !== "string") return false;
      if (contextSessionType !== CHALLENGE_FRIEND2) return false;
      return true;
    }, "when"),
    do: new StepRegistry_default([ChallengeFromMessageStep_default(), SwitchSceneStep_default()])
  }), "createChallengeFromMessageFlow");
  var ChallengeFromMessageFlow_default = createChallengeFromMessageFlow;

  // extensions/ludex/src/plugins/context/flows/FirstSessionFlow.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  // extensions/ludex/src/plugins/context/steps/StartSingleForFirstSessionStep.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  init_performance();
  init_google_analytics();
  var createStartSingleForFirstSessionStep = /* @__PURE__ */ __name(() => ({
  ...
  }), "createStartSingleForFirstSessionStep");
  var StartSingleForFirstSessionStep_default = createStartSingleForFirstSessionStep;

  // extensions/ludex/src/plugins/context/flows/FirstSessionFlow.ts
  var createFirstSessionFlow = /* @__PURE__ */ __name(() => ({
    id: "FirstSessionFlow",
    when: /* @__PURE__ */ __name((context) => {
      const { isFirstSession } = context;
      return isFirstSession;
    }, "when"),
    do: new StepRegistry_default([StartSingleForFirstSessionStep_default(), SwitchSceneStep_default()])
  }), "createFirstSessionFlow");
  var FirstSessionFlow_default = createFirstSessionFlow;

  // extensions/ludex/src/plugins/context/flows/MatchingGroupFlow.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  // extensions/ludex/src/plugins/context/steps/MatchingGroupJoinStep.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  init_performance();
  init_google_analytics();
  var createMatchingGroupJoinStep = /* @__PURE__ */ __name(() => ({
    id: "MatchingGroupJoin",
    runAsync: /* @__PURE__ */ __name(async (context) => {
      const { playerId: opponentId, playerScore: opponentScore } = context.contextData;
      if (typeof opponentId !== "string") return true;
      if (typeof opponentScore !== "number") return true;
      const { match, player } = codex;
  ...
  }), "createMatchingGroupJoinStep");
  var MatchingGroupJoinStep_default = createMatchingGroupJoinStep;

  // extensions/ludex/src/plugins/context/flows/MatchingGroupFlow.ts
  var { MATCHING_GROUP } = ContextTypes_default;
  var createMatchingGroupFlow = /* @__PURE__ */ __name(() => ({
    id: "MatchingGroupFlow",
    when: /* @__PURE__ */ __name((context) => {
      const {
        contextData: { playerId: playerId2, playerScore },
        contextSessionType
      } = context;
      if (typeof playerId2 !== "string") return false;
      if (typeof playerScore !== "number") return false;
      if (contextSessionType !== MATCHING_GROUP) return false;
      return true;
    }, "when"),
    do: new StepRegistry_default([MatchingGroupJoinStep_default(), SwitchSceneStep_default()])
  }), "createMatchingGroupFlow");
  var MatchingGroupFlow_default = createMatchingGroupFlow;

  // extensions/ludex/src/plugins/context/flows/PreFlow.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  // extensions/ludex/src/plugins/context/steps/EntryPointActionStep.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  function requestSetLocale$(locale2) {
    const { event } = codex;
    event.emit(Events2.REQUEST_LANGUAGE, { locale: locale2 });
  }
  __name(requestSetLocale$, "requestSetLocale$");
  var processEntryPointActionAsync = /* @__PURE__ */ __name(async (action) => {
    const { player } = codex;
    switch (action) {
      case "reset_data":
  ...
  }, "processEntryPointActionAsync");
  var createEntryPointActionStep = /* @__PURE__ */ __name(() => ({
    id: "EntryPointAction",
    runAsync: /* @__PURE__ */ __name(async (context) => {
      try {
        const { action } = context.contextData;
        if (!V7.isString(action)) return true;
        await processEntryPointActionAsync(action);
        return true;
      } catch (error) {
        console.warn("EntryPointActionStep", error);
        return true;
      }
    }, "runAsync")
  }), "createEntryPointActionStep");
  var EntryPointActionStep_default = createEntryPointActionStep;

  // extensions/ludex/src/plugins/context/steps/LogUserAnalyticsStep.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  var logUserAnalytics$ = /* @__PURE__ */ __name((isFirstSession) => {
    try {
  ...
  var createLogUserAnalyticsStep = /* @__PURE__ */ __name(() => ({
    id: "LogUserAnalytics",
    runAsync: /* @__PURE__ */ __name(async (context) => {
      setTimeout(() => {
  ...
  }), "createLogUserAnalyticsStep");
  var LogUserAnalyticsStep_default = createLogUserAnalyticsStep;

  // extensions/ludex/src/plugins/context/flows/PreFlow.ts
  var createPreFlow = /* @__PURE__ */ __name(() => ({
    id: "PreFlow",
    when: /* @__PURE__ */ __name((_context) => true, "when"),
    do: new StepRegistry_default([EntryPointActionStep_default(), LogUserAnalyticsStep_default()])
  }), "createPreFlow");
  var PreFlow_default = createPreFlow;

  // extensions/ludex/src/plugins/context/flows/NormalFlow.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  // extensions/ludex/src/plugins/context/steps/PrepareDashboardSceneStep.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  init_performance();
  init_google_analytics();
  var createPrepareDashboardSceneStep = /* @__PURE__ */ __name(() => ({
    id: "PrepareDashboardScene",
    runAsync: /* @__PURE__ */ __name(async (context) => {
      context.sceneName = "DashboardScene";
      return true;
    }, "runAsync")
  }), "createPrepareDashboardSceneStep");
  var PrepareDashboardSceneStep_default = createPrepareDashboardSceneStep;

  // extensions/ludex/src/plugins/context/flows/NormalFlow.ts
  var createNormalFlow = /* @__PURE__ */ __name(() => ({
    id: "NormalFlow",
    when: /* @__PURE__ */ __name((_context) => true, "when"),
    do: new StepRegistry_default([PrepareDashboardSceneStep_default(), SwitchSceneStep_default()])
  }), "createNormalFlow");
  var NormalFlow_default = createNormalFlow;

  // extensions/ludex/src/plugins/context/flows/TournamentFlow.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  // extensions/ludex/src/plugins/context/steps/ContinueTournamentStep.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  // extensions/ludex/src/plugins/context/exception/ContextIdInvalid.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  init_performance();
  init_google_analytics();
  var _ContextIdInvalid = class _ContextIdInvalid extends Error {
    constructor() {
      super("ContextIdInvalid");
    }
  };
  __name(_ContextIdInvalid, "ContextIdInvalid");
  var ContextIdInvalid = _ContextIdInvalid;
  var ContextIdInvalid_default = ContextIdInvalid;

  // extensions/ludex/src/plugins/context/steps/ContinueTournamentStep.ts
  var {
    Utils: { Valid: V8 }
  } = Ludex;
  var createContinueTournamentStep = /* @__PURE__ */ __name(() => ({
    id: "ContinueTournament",
    runAsync: /* @__PURE__ */ __name(async (context) => {
      try {
        const { match, player } = codex;
        const playerId2 = player.getPlayerId();
        if (V8.isEmpty(context.contextId)) {
          throw new ContextIdInvalid_default();
        }
        await match.tournament.continue.processAsync({ playerId: playerId2, contextId: context.contextId });
        context.sceneName = "GameScene";
      } catch (e) {
      }
      return true;
    }, "runAsync")
  }), "createContinueTournamentStep");
  var ContinueTournamentStep_default = createContinueTournamentStep;

  // extensions/ludex/src/plugins/context/flows/TournamentFlow.ts
  var { TOURNAMENT } = ContextTypes_default;
  var createTournamentFlow = /* @__PURE__ */ __name(() => ({
    id: "TournamentFlow",
    when: /* @__PURE__ */ __name((context) => {
      const { contextSessionType } = context;
      return contextSessionType === TOURNAMENT;
    }, "when"),
    do: new StepRegistry_default([ContinueTournamentStep_default(), SwitchSceneStep_default()])
  }), "createTournamentFlow");
  var TournamentFlow_default = createTournamentFlow;

  // extensions/ludex/src/plugins/context/register/FlowRegistry.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  // extensions/ludex/src/plugins/context/constants/FlowTypes.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  var FlowType = /* @__PURE__ */ ((FlowType2) => {
    FlowType2["StartID"] = "__start__";
    return FlowType2;
  })(FlowType || {});
  var FlowTypes_default = FlowType;

  // extensions/ludex/src/plugins/context/exception/FlowIdDuplicate.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  init_performance();
  init_google_analytics();
  var _FlowIdDuplicate = class _FlowIdDuplicate extends Error {
    constructor(flowId) {
      super(`Duplicate flow id: ${flowId}`);
    }
  };
  __name(_FlowIdDuplicate, "FlowIdDuplicate");
  var FlowIdDuplicate = _FlowIdDuplicate;
  var FlowIdDuplicate_default = FlowIdDuplicate;

  // extensions/ludex/src/plugins/context/exception/FlowIdInvalid.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  init_performance();
  init_google_analytics();
  var _FlowIdInvalid = class _FlowIdInvalid extends Error {
    constructor(flowId) {
      super(`Invalid flow id: ${flowId}`);
    }
  };
  __name(_FlowIdInvalid, "FlowIdInvalid");
  var FlowIdInvalid = _FlowIdInvalid;
  var FlowIdInvalid_default = FlowIdInvalid;

  // extensions/ludex/src/plugins/context/exception/FlowNotFound.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  init_performance();
  init_google_analytics();
  var _FlowNotFound = class _FlowNotFound extends Error {
    constructor(flowId) {
      super(`Flow not found: ${flowId}`);
    }
  };
  __name(_FlowNotFound, "FlowNotFound");
  var FlowNotFound = _FlowNotFound;
  var FlowNotFound_default = FlowNotFound;

  // extensions/ludex/src/plugins/context/register/FlowRegistry.ts
  var _FlowRegistry = class _FlowRegistry {
    flows$;
    ...
    addBefore(targetFlowId, flow) {
      this.validateFlowId$(flow.id);
      this.validateFlowDuplicate$(flow.id);
      if (targetFlowId === FlowTypes_default.StartID) {
        this.flows$.unshift(flow);
        return;
      }
      const targetIndex = this.getFlowIndexOrThrow$(targetFlowId);
      this.flows$.splice(targetIndex, 0, flow);
    }
    addAfter(targetFlowId, flow) {
      this.validateFlowId$(flow.id);
      this.validateFlowDuplicate$(flow.id);
      if (targetFlowId === FlowTypes_default.StartID) {
    ...
    replace(flowId, patch) {
      this.validateFlowId$(flowId);
      const index = this.getFlowIndexOrThrow$(flowId);
      const currentFlow = this.flows$[index];
    ...
    async runAsync(context) {
      ...
      try {
        for (const flow of this.flows$) {
          ...
          const { matched, done } = await this.matchAndRunFlow$(flow, context);
          rows.push({
            flowId: flow.id,
            matched,
            done,
    ...
    async matchAndRunFlow$(flow, context) {
      let matched = false;
      try {
        matched = flow.when(context);
      } catch (error) {
        console.warn(`FlowRegistry.when(${flow.id})`, error);
      }
      if (!matched) return { matched: false, done: false };
      const done = await flow.do.runAsync(context);
      return { matched: true, done };
    }
    logResult$(rows, startedAt) {
      const totalMs = this.getDuration$(startedAt);
      console.groupCollapsed(`\u{1F500} Flows Result (${totalMs}ms)`);
      console.table(rows);
      console.groupEnd();
    }
    validateFlowId$(flowId) {
      if (typeof flowId !== "string" || flowId.trim().length === 0) {
        throw new FlowIdInvalid_default(`${flowId}`);
      }
    }
    validateFlowDuplicate$(flowId) {
    ...
    findIndex$(flowId) {
      this.validateFlowId$(flowId);
      return this.flows$.findIndex((f) => f.id === flowId);
    }
    getFlowIndexOrThrow$(flowId) {
      const index = this.findIndex$(flowId);
  ...
  var FlowRegistry = _FlowRegistry;
  var FlowRegistry_default = FlowRegistry;
  ...
  var _Loader = class _Loader {
    ...
    constructor(codex2) {
      this.codex = codex2;
      this.flows = new FlowRegistry_default([
        PreFlow_default(),
    ...
    async processContextData() {
      ...
      console.groupCollapsed("\u{1F500} ContextLoader");
      console.table([
        __spreadValues(__spreadValues({}, contextInfo), contextData)
      ]);
      console.groupEnd();
      const done = await this.flows.runAsync(contextInfo);
      if (!done) {
        this.codex.event.emit(Ludex.Events.SWITCH_SCENE, {
          sceneName: "DashboardScene",
          sceneData: { isFromLoader: true }
        });
      }
    }
    configureFlows(configure) {
      try {
  ...
  var _EventPlugin = class _EventPlugin extends Ludex.Plugins.BasePlugin {
    ...
    catchUp(event, callback) {
      ...
      this.addHistory$(event, "once", "catchup");
      callback(payload);
    }
    off(event, callback) {
    ...
    getEventListeners(event) {
      ...
      const listeners2 = history.filter((item) => {
        return item.name === event && ["listening", "catchup"].includes(item.status);
      });
      return listeners2.map((item) => item.name);
    }
    getHistory() {
      const { storage } = this.codex;
  ...
  var {
    ...
    Utils: { Object: O6, String: S3, Valid: V10 }
  } = Ludex;
  var _LeaderboardAPI = class _LeaderboardAPI {
    ...
    async getLeadersAsync(id, url, payload) {
      ...
      if (!O6.hasOwn(result3, "data") || !Array.isArray(result3.data)) return [];
      return result3.data;
    }
    async getLeaderboardAsync(id) {
      ...
      if (Mockup.Leaderboards.Enabled) {
        ...
        if (O6.hasOwn(result3, "data") && typeof result3.data === "object") {
    ...
    async getLeaderboardsAsync(options) {
      ...
      if (Mockup.Leaderboards.Enabled) {
        ...
        result3 = await get(`${url}?${params}`, {}, OtherHost);
        if (O6.hasOwn(result3, "data") && Array.isArray(result3.data)) {
          result3 = result3.data;
        } else {
          result3 = [];
        }
    ...
    async createLeaderboardAsync(payload) {
      ...
      if (Mockup.Leaderboards.Enabled) {
        ...
        if (O6.hasOwn(result3, "data") && V10.isObject(result3.data)) {
          result3 = result3.data;
        }
      }
      if (!O6.hasOwn(result3, "_id") || result3._id !== id) {
  ...
  // extensions/ludex/src/plugins/leaderboards/LeaderboardPlugin.ts
  var {
    Utils: { Array: A5, Valid: V11, Json: J3, Object: O7 },
    Configs: {
  ...
  var _LeaderboardPlugin = class _LeaderboardPlugin extends Ludex.Plugins.BasePlugin {
    ...
    isExistLeaderboardId(leaderboardId) {
      ...
      return O7.vals(configs).some((config) => config.id === leaderboardId);
    }
    getLeaderboardName(leaderboardId) {
      const { configs$: configs } = this;
      const config = A5.search(O7.vals(configs), (config2) => config2.id === leaderboardId);
    ...
    setLeaderboard$(name2, leaderboard) {
      if (!leaderboard) return;
      const { storage } = this.codex;
      storage.setStorageData("leaderboard", "leaderboards", {
        [name2]: leaderboard
      });
    }
    async receiveLeaderboardAsync$(name2, responses) {
      ...
      const rawLeaders = O7.vals(currentLeaders);
      ...
      if (this.configs$[name2].autoSortRank) {
        sortedLeaders = sortedLeaders.map((leader, index) => O7.merge(leader, { rank: index + 1 }));
      }
      const keyedLeaders = O7.keyBy(sortedLeaders, "playerId");
    ...
    async toLeaders$(leaders) {
      ...
      const leadersWithProfile = leaders.map((leader) => {
        ...
        if (!profile2) {
          ...
          return O7.merge(leader, { name: name2, photo: "default" });
        }
        return O7.merge(leader, { name: profile2.name, photo: profile2.photo });
      });
  ...
  var _MatchAPI = class _MatchAPI extends BaseAPI_default {
    ...
    async finishMatchAsync(payload) {
      ...
      const result3 = await post(url, { matchId, score: score2, level: level2, extraData }, {}, this.
      getAPIHost());
      return this.returnValidMatchData$(result3);
    }
  ...
  init_performance();
  init_google_analytics();
  var { Object: O8, Valid: V12, Json: J4 } = Ludex.Utils;
  var _BaseHandler = class _BaseHandler {
    ...
    logData$(name2, matchState) {
      if (!V12.isDebugger()) return;
      console.groupCollapsed(`\u{1F4E6} MatchState: ${name2}`);
      this.stateData$[name2] = J4.clone(matchState);
      const _a = matchState, { profiles, customData } = _a, base = __objRest(_a, ["profiles", "custo\
mData"]);
      console.info("\u{1F4BE} Base");
      console.table(O8.clone(base));
      console.info("\u{1F4BE} Profile");
      console.table(O8.clone(profiles));
      console.info("\u{1F4BE} Custom");
      console.table(O8.clone(customData));
      console.groupEnd();
    }
    logDiff$() {
      const { After, Before } = this.stateData$;
      if (!After || !Before) return;
      const diff = O8.diff(Before, After);
      if (!V12.isEmpty(diff)) {
        const _a = diff, { profiles = {}, customData = {} } = _a, base = __objRest(_a, ["profiles", "\
customData"]);
        ...
        if (!V12.isEmpty(profiles)) {
          console.info("\u{1F4BE} Profile");
          console.table(O8.clone(profiles));
        }
        if (!V12.isEmpty(customData)) {
          console.info("\u{1F4BE} Custom");
          console.table(O8.clone(customData));
        }
        console.groupEnd();
  ...
  // extensions/ludex/src/plugins/match/handlers/analytic/LogMatchStartHandler.ts
  var {
    Plugins: { Analytics: { Events: Events4 } = {} },
    Utils: { String: S4, Valid: V13 }
  } = Ludex;
  ...
  var _AwaitMatchHandler = class _AwaitMatchHandler extends BaseHandler_default {
    ...
    updateMatchGeneral$(matchState, matchData) {
      ...
      matchState.customData = O9.merge(matchState.customData, extraData);
    }
  ...
  var _GetMatchProfilesHandler = class _GetMatchProfilesHandler extends BaseHandler_default {
    ...
    updateMatchProfile$(matchState, profileId, data) {
      ...
      const profile = new Dtos3.Match.Profile({
        id: profileId,
        name: name2,
        photo: photo2
      }).toObject();
  ...
  // extensions/ludex/src/plugins/match/handlers/context/CreateContextHandler.ts
  var { Valid: V14, Object: O10 } = Ludex.Utils;
  var _CreateContextHandler = class _CreateContextHandler extends BaseHandler_default {
    ...
    async createAsync$(opponentId) {
      ...
      if (!V14.isString(contextId2)) {
        throw new CreateContextFailed_default();
      }
      return contextId2;
    }
    validateError$(error) {
      if (!O10.hasOwn(error, "code")) throw error;
    ...
    validateErrorMessage$(error) {
      if (!O10.hasOwn(error, "message")) throw error;
      if (!V14.isString(error.message)) throw error;
    }
  ...
  init_google_analytics();
  var {
    Plugins: { Analytics: { Events: Events5 } = {} },
    Utils: { String: S5, Valid: V15 }
  } = Ludex;
  var _LogMatchFinishedHandler = class _LogMatchFinishedHandler extends BaseHandler_default {
    ...
    validateMode$(mode) {
      if (!V15.isString(mode)) {
        throw new MatchModeNotDefined_default();
      }
    }
    validateLevel$(level2) {
      if (!V15.isNumber(level2)) {
        throw new LevelNotDefined_default();
      }
    }
    getLevelName$(level2) {
  ...
  var { Valid: V17, Object: O13 } = Utils4;
 ...
 \u0111i\u1EC3m!`
  ...
  var _FinishChallengeMatchConcrete = class _FinishChallengeMatchConcrete extends BaseConcrete_default {
    async processAsync(payload) {
      try {
        ...
        const flow = new NothingHandler_default(this);
        const finishMatch = new FinishMatchHandler_default(this, {
          useAPI: true,
          extraData
        });
  ...
  var { Array: A6, Object: O14 } = Utils5;
  var _GetOpponentChallengeContextHandler = class _GetOpponentChallengeContextHandler extends BaseHandler_default {
    ...
    async getContextPlayers$(ignorePlayers) {
      try {
        ...
        if (O14.hasOwn(error, "code") && error.code === "NETWORK_FAILURE") {
  ...
  var _ChooseContextHandler = class _ChooseContextHandler extends BaseHandler_default {
    ...
    async chooseAsync$() {
      try {
        ...
        if (!O15.hasOwn(error, "code")) throw error;
        if (error.code !== "SAME_CONTEXT") throw error;
      }
      const contextId2 = GameSDK.context.getID();
      if (typeof contextId2 !== "string") {
  ...
  var _ResultMatchHandler = class _ResultMatchHandler extends BaseHandler_default {
    ...
    updateMatchGeneral$(matchState, matchData) {
      const { extraData } = matchData;
      matchState.status = MatchStatus_default.FINISHED;
      matchState.customData = O17.merge(matchState.customData, extraData);
    }
    updatePlayerIds$(matchState, matchData) {
      const { whitePlayerId, blackPlayerId } = matchData;
      const { customData } = matchState;
  ...
  var _ChooseContextConcrete = class _ChooseContextConcrete extends BaseConcrete_default {
    ...
    startFlowTournament$ = /* @__PURE__ */ __name(async (playerId2) => {
      try {
        ...
        await this.match.tournament.continue.processAsync({
          playerId: playerId2,
          contextId: contextId2
        });
      } catch (e) {
  ...
  var _SetLeaderboardScoreHandler = class _SetLeaderboardScoreHandler extends BaseHandler_default {
    ...
    async setupSetScorePayload$(matchState) {
      ...
      if (!V19.isNumber(score2)) {
        throw new ScoreNotValid_default();
      }
      if (!V19.isString(leaderboardId)) {
    ...
    async sendChallengeMessageAsync$(matchState, wideframes) {
      ...
      const message = {
        ...
        text: {
          default: `${playerName} got ${playerScore} scores. So easy! Can you?`,
          localizations: {
            vi_VN: `${playerName} \u0111\xE3 \u0111\u1EA1t ${playerScore} \u0111i\u1EC3m! Qu\xE1 d\u1EC5 lu\xF4n. Ch\u01A1i l\u1EA1\
i n\xE0o!`
          }
        },
        image: wideframes,
  ...
  var _SetProfileDataHandler = class _SetProfileDataHandler extends BaseHandler_default {
    ...
    updateProfileMatchData$(matchState) {
      ...
      const profileMerged = O18.merge(profiles[id], this.payload$);
  ...
  var _StartGroupConcrete = class _StartGroupConcrete extends BaseConcrete_default {
    async processAsync(payload) {
      try {
        ...
        const flow = new NothingHandler_default(this);
        const groupContext = new GroupContextHandler_default(this, __spreadValues({
          matchTag
        }, options));
  ...
  var _GetProfileHandler = class _GetProfileHandler extends BaseHandler_default {
    ...
    updateMatchData$(data, matchState) {
      ...
      const profile = new Dtos10.Match.Profile({
        id: playerId2,
        name: name2,
        photo: photo2
      }).toObject();
  ...
  var _StartSingleConcrete = class _StartSingleConcrete extends BaseConcrete_default {
    async processAsync(payload) {
      try {
        ...
        const { playerId: playerId2 } = payload;
        const flow = new NothingHandler_default(this);
        const switchContext = new SwitchContextHandler_default(this, {
          contextId: "SOLO"
        });
        flow.setNext(switchContext);
        const prepareMatch = new PrepareMatchHandler_default(this, {
  ...
  init_google_analytics();
  var {
    Plugins: { Analytics: { Events: Events6 } = {} },
    Utils: { String: S6, Valid: V21 }
  } = Ludex;
  ...
  var _ContinueTournamentConcrete = class _ContinueTournamentConcrete extends BaseConcrete_default {
    async processAsync(payload) {
      try {
        ...
        const flow = new NothingHandler_default(this);
        const continueTournament = new ContinueTournamentHandler_default(this, {
          contextId: contextId2
        });
  ...
  init_google_analytics();
  var {
    Plugins: { Analytics: { Events: Events7 } = {} }
  } = Ludex;
  ...
  var _CreateLeaderboardHandler = class _CreateLeaderboardHandler extends BaseHandler_default {
    ...
    validatePayload$() {
      ...
      if (!V23.isString(leaderboardId)) {
        throw new LeaderboardIdNotValid_default();
      }
    }
    validatePlayerId$(playerId2) {
      if (!V23.isString(playerId2)) {
        throw new PlayerIdNotValid_default();
      }
    }
  ...
  var _PostScoreTournamentHandler = class _PostScoreTournamentHandler extends BaseHandler_default {
    ...
    async postScoreTournamentAsync$(matchState) {
      ...
      const eventName = openShareScorePopup ? Analytics2.Events.TOURNAMENT_SHARE : Analytics2.Events.
      TOURNAMENT_POST_SCORE;
      try {
        ...
        if (V24.isObject(error) && "code" in error && error.code === "USER_INPUT") {
          const { event } = codex;
  ...
  init_performance();
  init_google_analytics();
  var { Valid: V25, Object: O19 } = Ludex.Utils;
  var _JoinTournamentHandler = class _JoinTournamentHandler extends BaseHandler_default {
    ...
    validateTournamentId$(tournamentId) {
      if (!V25.isString(tournamentId)) {
        throw new TournamentIdNotValid_default();
      }
    }
    validateContextId$(contextId2) {
      if (!V25.isString(contextId2)) {
        throw new ContextIdNotValid_default();
      }
    }
    validateLeaderboardId$(leaderboardId) {
      if (!V25.isString(leaderboardId) || leaderboardId === "") {
        throw new LeaderboardIdNotValid_default();
      }
    }
    async joinTournamentAsync$(tournamentId) {
      ...
      try {
        ...
        if (!O19.hasOwn(error, "code")) throw error;
        if (error.code !== "SAME_CONTEXT") throw error;
      }
    }
  };
  ...
  var _GetMatchCustomDataHandler = class _GetMatchCustomDataHandler extends BaseHandler_default {
    ...
    updateMatchCustomData$(matchState, extraData) {
      const dataMerged = O20.merge(matchState.customData, extraData);
  ...
  var _SetMatchCustomDataHandler = class _SetMatchCustomDataHandler extends BaseHandler_default {
    ...
    updateMatchCustomData$(matchState) {
      const customDataMerged = O21.merge(matchState.customData, this.payload$);
  ...
  var _MatchCustomDataDtos = class _MatchCustomDataDtos extends BaseDtos_default {
    ...
    validateLevel(level2) {
      if (!V26.isNumber(level2) || level2 < 0) {
        this.exception$("level", MESSAGE_INVALID5);
      }
    }
    validateRescued(rescued) {
      if (!V26.isNumber(rescued) || rescued < 0) {
    ...
    validatePlayerId(playerId2) {
      if (!V26.isString(playerId2)) {
        this.exception$("playerId", MESSAGE_INVALID5);
      }
    }
    validateOpponentId(opponentId) {
      if (!V26.isString(opponentId) && opponentId !== null) {
        this.exception$("opponentId", MESSAGE_INVALID5);
      }
    }
    validateTournamentId(tournamentId) {
      if (!V26.isString(tournamentId) && tournamentId !== null) {
        this.exception$("tournamentId", MESSAGE_INVALID5);
      }
    }
    validateLeaderboardId(leaderboardId) {
      if (!V26.isString(leaderboardId) && leaderboardId !== null) {
  ...
  var updatePlayerProfileAsync = /* @__PURE__ */ __name(async (payload) => {
    ...
    if (!O22.hasOwn(result3, "data")) return {};
    return result3.data || {};
  }, "updatePlayerProfileAsync");

  // extensions/ludex/src/plugins/player/PlayerPlugin.ts
  var {
    Utils: { Array: A7, Object: O23, Valid: V28, Function: F3 },
    Configs: { AppId: AppId4 },
    Events: { PLAYER_SETTINGS_CHANGED }
  } = Ludex;
  var _PlayerPlugin = class _PlayerPlugin extends Ludex.Plugins.BasePlugin {
    ...
    async syncProfileToServer() {
      ...
      if (!V28.isString(ASID) && "getASIDAsync" in GameSDK.player) {
        const [id, error] = await F3.handleAsync(GameSDK.player.getASIDAsync(), 1e4);
        if (!error && id) {
          ASID = id;
    ...
    setSetting(name2, value) {
      ...
      event.emit(PLAYER_SETTINGS_CHANGED, { name: name2, value });
    }
    setGameData(data) {
      const currentData = this.getGameData() ?? {};
      const newData = O23.merge(currentData, data);
    ...
    async requestConnectedPlayers() {
      ...
      const connectedPlayersKeyed = O23.keyBy(connectedPlayersUnique, "playerId");
  ...
  var _PlayerGameDataDtos = class _PlayerGameDataDtos extends BaseDtos_default {
    ...
    validateLevel(level2) {
      if (!V30.isNumber(level2) || level2 < 0) {
        this.exception$("level", "is invalid");
      }
    }
    validateCoins(coins2) {
      if (!V30.isNumber(coins2) || coins2 < 0) {
  ...
  var _ProfileAPI = class _ProfileAPI {
    ...
    async getPlayersAsync(payload) {
      ...
      if (!O25.hasOwn(result3, "data") || !Array.isArray(result3.data)) return [];
      return result3.data;
    }
  };
  ...
  var { Array: A8, Valid: V32, Object: O26, Function: F4 } = Utils8;
  var _ProfilePlugin = class _ProfilePlugin extends Ludex.Plugins.BasePlugin {
    ...
    async requestProfiles(playerIds) {
      ...
      const profilePromises = playerIdsChunks.map((playerIds2) => this.profileAPI$.getPlayersAsync({
      playerIds: playerIds2 }));
      const profilesResponses = await F4.allSettled(profilePromises);
    ...
    convertToProfiles$(result3) {
      ...
      for (const data of result3) {
        if (!O26.hasOwn(data, "playerId")) continue;
        if (!V32.isString(data.playerId)) continue;
  ...
  init_performance();
  init_google_analytics();
  var gameName2 = "Block Puzzle Social";
  var {
    Utils: { Object: O27, Valid: V33, Browser: B2 }
  } = Ludex;
  var _StoragePlugin = class _StoragePlugin extends Ludex.Plugins.BasePlugin {
    ...
    async initFromWebStorage$(name2, initState8) {
      ...
      const data = await B2.getIndexedDB(`${gameName2}_S_${name2}`);
      if (!V33.isObject(data)) return;
      const keys = Object.keys(initState8);
      for (const key of keys) {
        if (!O27.hasOwn(data, key)) continue;
    ...
    setStorageData(storage, field, data) {
      let nextData;
      if (V33.isObject(data)) {
        const currentData = this.getStorageData(storage, field);
        nextData = O27.merge(currentData, data);
      } else {
        nextData = data;
      }
    ...
    async saveToWebStorage$(storage, flushMemory = false) {
      const data = this.getStorage(storage);
      await B2.setIndexedDB(`${gameName2}_S_${storage}`, data);
      if (flushMemory) {
        O27.assign(this.storages$[storage], {});
      }
    }
  };
  ...
  var _VisibilityPlugin = class _VisibilityPlugin extends Ludex.Plugins.BasePlugin {
    ...
    init() {
      ...
      this.setupGameSDKEvents$();
      this.setupNativeBridgeEvents$();
    }
    setupBrowserEvents$() {
  ...
  init_google_analytics();
  var {
    Utils: { Object: O28, String: S8 },
    Plugins: {
      Ads: { Status, Types: Types2, AdError: AdError2, AdInstance: AdInstance3 }
    }
  } = Ludex;
  var _NormalAdInstance = class _NormalAdInstance extends AdInstance3 {
    ...
    constructor(type, placementId) {
      ...
      this.service$ = S8.toSnakeCase(GameSDK.getSDKName());
      this.instance$ = null;
    }
    ...
    async createInstanceByType$(type) {
      try {
        ...
        if (!O28.hasOwn(error, "code")) return null;
  ...
  var {
    ...
    Plugins: Plugins2,
    Utils: { Device: D2, Object: O29, Json: J5, String: S9, Valid: V34, Time: T2, Function: F5, Mark: Mark2 }
  } = Ludex;
  var _MagicCodex = class _MagicCodex extends codex_default {
    ...
    processContextSession$ = /* @__PURE__ */ __name(async () => {
      ...
      try {
        ...
        this.monitorError?.sendException(F5.toError(error));
      }
    ...
    addPlugins$() {
      ...
      this.installPlugin$("Language", empty_script_default);
    ...
    installPlugin$(name2, plugin, isModule = false) {
      const property = S9.toCamelCase(S9.capitalize(name2));
    ...
    initMonitorErrorPlugin$ = /* @__PURE__ */ __name(() => {
      ...
      if (playerId2 && playerId2 !== "0000" && ListPlayerDevIds.indexOf(playerId2) >= 0) return;
    ...
    processErrorsQueue$ = /* @__PURE__ */ __name(() => {
      ...
      for (const error of window.__errorQueue) {
        if (error instanceof Error) {
          ...
          const errorObj = F5.toError(error);
    ...
    handleUpdateLudexConfig$ = /* @__PURE__ */ __name((data) => {
      try {
        ...
        Ludex.Configs = O29.merge(Ludex.Configs, data.config);
    ...
    handleStorageCurrentRemoteConfig$ = /* @__PURE__ */ __name(() => {
      ...
      for (const key in playerRemoteConfig) {
        if (O29.hasOwn(playerRemoteConfig, key)) {
    ...
    async updatePlayerProfileToNotificationService$() {
      try {
        ...
        const isNEZP = "isNEZP" in GameSDK.extra && GameSDK.extra.isNEZP();
        const profileData = {
          appId: AppId5,
          ASID,
          playerId: playerId2,
    ...
    initGoogleAnalytics$() {
      ...
      const { Enabled, ConsoleLog } = Analytics3.GoogleAnalytics ?? {};
      if (!Enabled) return;
    ...
    initClarityAnalytics$() {
      if (!this.analytics) return;
      const { Enabled, ConsoleLog } = Analytics3.ClarityAnalytics ?? {};
      if (!Enabled) return;
    ...
    initFirebaseAnalytics$() {
      if (!this.analytics) return;
      const { Enabled, ConsoleLog } = Analytics3.FirebaseAnalytics ?? {};
      if (!Enabled) return;
      if (typeof empty_script_default !== "function" || !(empty_script_default.prototype instanceof Object)) {
    ...
    initFacebookAnalytics$() {
      if (!this.analytics) return;
      const { Enabled, Prefix, ConsoleLog } = Analytics3.FacebookAnalytics ?? {};
      if (!Enabled || !GameSDK.isGameSDK("FacebookInstant")) return;
