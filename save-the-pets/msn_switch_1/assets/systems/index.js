...
System.register("chunks:///systems.js", [
    ...
    var e, t, n, a, r, i, s, o, c, l, u, d, h, p, f, m, g, v, $, y, S, E, A, w, b, C, D, R, T, L, F, x, _, I, M, P, N, k, O, U, B, G, z, H, V, Y, q, Q, W, K, j, X, Z, J, ee, te, ne, ae, re, ie, se, oe, ce, le, ue, de;
    return {
        setters: [
            function(M) {
                e = M.h, t = M.e, n = M.a, a = M.t, r = M.d, i = M.G, s = M.H, o = M.i, c = M.C, l = M.n, u = M.g, d = M.M, h = M.P, p = M.I, f = M.v, m = M.k, g = M.J, v = M.L, $ = M.K, y = M.s, S = M.u, E = M.w, A = M.R, w = M.N, b = M.T, C = M.B, D = M.x, R = M.q, T = M.z, L = M.F, F = M.O, x = M.Q, _ = M.b, I = M.c;
            },
            function(e) {
        ...
        execute: function execute() {
            ...
            var ge = Ludex, ve = ge.Events, $e = ge.Configs.Ads, ye = $e.Enabled, Se = $e.PreloadAds, Ee = $e.ShowAdOnLoad, Ae = ge.Utils, we = Ae.Time, be = Ae.Decorator, Ce = codex.event, De = (he = be.tryCatch(), fe = e((pe = function() {
                function e() {
                    var t = this;
            ...
            var Re, Te, Le, Fe = Ludex, xe = Fe.Events, _e = Fe.Configs.GameEngine, Ie = _e.DynamicAtlas, Me = _e.PreferredFPS, Pe = Fe.Utils, Ne = Pe.Valid, ke = Pe.Device, Oe = codex.event, Ue = function() {
                function e() {
                    var t = this;
            ...
            var Be = l.Layout, Ge = l.DesignSize, ze = Ge.Portrait, He = Ge.Landscape, Ve = l.AcceptPortraitRatio, Ye = Ludex, qe = Ye.Utils.Decorator, Qe = Ye.Configs.GameEngine.AutoResizeCanvas, We = Ye.Events, Ke = codex, je = Ke.ads, Xe = Ke.event, Ze = (Re = qe.debounce(100), Le = e((Te = function() {
                function e() {
                    var t = this;
                    r(this, e), this.listenResizeEvent$ = function() {
                    ...
                    }, o(this, "handleBodyResize", Le, this), this.setupOrientationByCanvasSize$ = function() {
                        ...
                        var g = c.worldSizeToCssSize(h.width), v = c.worldSizeToCssSize(h.height), $ = new W(g, v);
            ...
            var mt, gt, vt, $t = codex.storage, yt = function() {
                function e() {
            ...
            var St = Ludex, Et = St.Configs.GameEngine.DynamicAssets, At = Et.Resolution, wt = Et.IgnoreFiles, bt = Et.Compression, Ct = St.Events, Dt = St.Utils, Rt = Dt.Array, Tt = Dt.Function, Lt = Dt.Device, Ft = Dt.Decorator, xt = codex, _t = xt.event, It = xt.storage, Mt = xt.getBuildVersion, Pt = [
                ".png",
                ".jpg",
                ".jpeg",
                ".webp"
            ], Ut = (mt = Ft.debounce(1e3), vt = e((gt = function() {
                var a;
                function e() {
                    var _$e, t = this;
                    r(this, e), this.isProcessing$ = !1, this.yield10msIfNeeded$ = Tt.timeSlice(10), this.targetScale$ = 1, this.sessionQuality$ = 3, this.failedAssets$ = new Set, this.isAssetUpgraded$ = new Set, this.upgradableAssets$ = new Map, this.initStorage$ = n(function() {
                        ...
                        var _$e, t = Math.round(Lt.pixelRatio()), n = At.Available, a = At.Source, r = f(n).sort(function(e, t) {
                            return e - t;
                        }), i = u(r);
                        try {
                        ...
                        J.prototype._refreshTexture = function() {
                            ...
                            if (this.name && !this.refreshed) {
                                var i = this.rect, s = i.x, o = i.y, c = i.width, l = i.height, u = Number((s * e).toFixed(2)), d = Number((o * e).toFixed(2)), f = new ee(u, d, Math.round(c * e), Math.round(l * e)), m = new W(f.width, f.height);
                ...
                function e() {
                    ...
                    r(this, e), this.isEffective$ = !0, this.forceUpdateDynamicAtlas$ = !1, this.mutex$ = Xt.mutex(), this.renderTimes$ = [], this.lastRenderTime$ = 0, this.renderTimeInterval$ = 5e3, this.atlasInfo$ = null, this.lastAtlasInfo$ = null, this.atlasIds$ = {}, this.collectInfo$ = new Map, this.packedFrames$ = new Set, this.debugCanvases$ = {}, this.listenEvents$ = function() {
                        ...
                        if (Vt || d > s || h > o) {
                            ...
                            var _$e, f, m = t.debugCanvases$[t.getAtlasIndex$()];
                            m && (null == (f = m.getContext("2d")) || f.clearRect(0, 0, m.width, m.height));
                        }
                        ...
                        var p = e._texture, f = p.width, m = p.height;
                        if (d + u.w > f || h + u.h > m) return null;
                        var g = c.image;
                        if (!g) return null;
            ...
            var sn = Ludex.Utils.Error, on = "./wideframes", cn = "".concat(on, "/result-challenge.png"), ln = "".concat(on, "/update-challenge.png"), un = "".concat(on, "/images/avatar-fallback.png"), dn = {
                ...
                return _ts_generator(this, function(_state) {
                    switch(_state.label){
                        case 0:
                            return t = sn.lift({}), n = sn.pipe(gn(e), vn(e), $n(e), mn(e))(t), [
                                4,
                                sn.applyAsync(fn)(n)
                            ];
                        case 1:
                ...
                return function(t) {
                    return m(m({}, t), {}, {
                        playerPhoto: m(m({}, dn.playerPhoto), {}, {
                            name: e.playerId,
                            image: e.playerPhoto
                        }),
                        opponentPhoto: m(m({}, dn.opponentPhoto), {}, {
                            name: e.opponentId,
                ...
                return function(t) {
                    ...
                    return n || a ? m(m({}, t), {}, {
                        leftScore: m(m({}, dn.leftScore), {}, {
                            text: n ? "".concat(void 0 === r ? 0 : r) : "???"
                        }),
                        rightScore: m(m({}, dn.rightScore), {}, {
            ...
            var Sn = Ludex.Utils.Error, En = "./wideframes", wn = "".concat(En, "/images/avatar-fallback.png"), bn = {
                ...
                return _ts_generator(this, function(_state) {
                    switch(_state.label){
                        case 0:
                            return t = Sn.lift({}), n = Sn.pipe(Tn(e), Ln(e), Rn)(t), [
                                4,
                                Sn.applyAsync(Dn)(n)
                            ];
                        case 1:
                ...
                return function(t) {
                    for(var n = e.leaders, a = m({}, t), r = 0; r < n.length; r++){
                        var i = n[r], s = i.id, o = i.name, c = i.photo, l = i.score, u = 1292 + 180 * r, d = 1360 + 180 * r;
                        a["photo_".concat(s)] = m(m({}, bn.leaderPhoto), {}, {
                            position: [
                            ...
                            name: s,
                            image: c
                        }), a["name_".concat(s)] = m(m({}, bn.leaderName), {}, {
                            position: [
                            ...
                            name: s,
                            text: o
                        }), a["score_".concat(s)] = m(m({}, bn.leaderScore), {}, {
                            position: [
            ...
            var Fn = Ludex.Utils, xn = Fn.Error, _n = (Fn.Valid, Fn.Function), In = codex, Mn = In.frameCapture, Pn = In.language, Nn = In.monitorError, kn = "./wideframes", Bn = {
                ...
                return function(t) {
                    ...
                    return m(m({}, t), {}, {
                        playerScore: m(m({}, Bn.playerScore), {}, {
                ...
                var t = Qn(), n = Wn(), a = jn(), r = m(m({}, Bn.message), {}, {
                ...
                var e;
                return null != (e = g[Pn.getCurrentLocale()]) ? e : "104px";
            }, Kn = function Kn(e) {
            ...
            var Xn = Ludex.Utils.Error, Zn = codex, Jn = Zn.frameCapture, ea = Zn.language, ta = "./wideframes", ra = {
                ...
                return function(t) {
                    ...
                    return m(m({}, t), {}, {
                        playerScore: m(m({}, ra.playerScore), {}, {
                            text: "".concat(e.playerScore),
                            font: "".concat(n, " ").concat(r, " ").concat(a, ",")
                        })
                    });
            ...
            var fa = Ludex.Utils.Error, ma = "./wideframes", va = "".concat(ma, "/images/avatar-fallback.png"), $a = {
                wideframe: {
                    type: "image",
                    name: "update-challenge",
                    depth: 0,
                    image: "".concat(ma, "/update-challenge.png"),
                    size: [
                        952,
                        492
                    ],
                ...
                return function(t) {
                    return m(m({}, t), {}, {
                        playerPhoto: m(m({}, $a.playerPhoto), {}, {
                            image: e.playerPhoto,
                            name: e.playerId
                        }),
                        opponentPhoto: m(m({}, $a.opponentPhoto), {}, {
                            image: e.opponentPhoto,
                            name: e.opponentId
                        })
                    });
            ...
            var Ta = Ludex, La = Ta.Events, Fa = Ta.Configs.GameEngine.HybridFileCache, xa = Fa.Enabled, _a = Fa.PreviewMode, Ia = Fa.BuildMode, Ma = Ta.Utils, Pa = Ma.Object, Na = Ma.Function, ka = Ma.Json, Oa = Ma.Decorator, Ua = codex, Ba = Ua.event, Ga = Ua.storage, za = Ua.getBuildVersion, Ha = U.instance, Va = Ha.downloader, Ya = Ha.pipeline, qa = Ha.fetchPipeline, Qa = /.*\/([-a-z0-9@]+)\.([^.]+)$/, Wa = (wa = Oa.throttle(1e3), Ca = e((ba = function() {
                var a;
                function e() {
                    var _$e, t = this;
                    r(this, e), this.supportTypes$ = [], this.bundledFiles$ = {}, this.originHandler$ = {}, this.nativeAssetDictionary$ = {}, this.initStorage$ = n(function() {
                        ...
                        return _ts_generator(this, function(_state) {
                            switch(_state.label){
                                ...
                                case 3:
                                    return Ba.emit(La.BUNDLE_READY), [
                                        7
                                    ];
                                case 4:
                                    return [
                        ...
                        Ba.on(La.SCENE_LOADED, t.requestUpdateStorage), P.on(i.CLEAR_HYBRID_FILE_CACHE, t.clearCache$);
            ...
            var Ka = Ludex, ja = Ka.Events, Xa = Ka.Utils.Array, Za = codex, Ja = Za.player, er = Za.event, tr = Za.language, nr = Za.monitorError, ar = function() {
                ...
                function e() {
                    ...
                    r(this, e), this.initDefaultLanguage$ = n(function() {
                        return _ts_generator(this, function(_state) {
                            return tr.add("en", me, !0), t.setLanguage$("en"), [
                                2
                            ];
                        });
            ...
            var pr = Ludex, fr = pr.Utils.Mark, mr = pr.Events, gr = pr.Configs.PerformanceMonitor.FpsTracking, vr = codex.event, $r = function() {
                function e() {
                    var t = this;
                    r(this, e), this.markName$ = "FPS Tracking", this.listenEvents$ = function() {
                        vr.catchUp(mr.GAME_READY, t.handleStartTraceFps$);
                ...
                return t(e, [
                    {
                        key: "mark",
                        get: function get() {
                            return gr.Enabled ? fr : null;
                        }
                    },
                    {
                        key: "init",
                        value: function value() {
                            var _$e = gr.TrackingDuration, t = gr.TrackingInterval;
            ...
            var Ar = Ludex.Configs, wr = Ar.Languages, br = Ar.Leaderboards, Cr = Ar.RemoteConfig, Dr = Ar.FrameCapture, Rr = Ar.DailyRewards, Tr = Ar.AdaptivePerformance, Lr = Ar.Debugger, Fr = Lr.CanvasRecorder, xr = Lr.Profiler, _r = Ar.GameEngine, Ir = _r.HybridFileCache, Mr = _r.DynamicAssets, Pr = _r.DynamicAtlas, Nr = function() {
                function e() {
            ...
            var kr = codex, Or = kr.event, Ur = kr.monitorError, Br = Ludex, Gr = Br.Events, zr = Br.Configs.PerformanceMonitor, Hr = Br.Utils, Vr = Hr.Mark, Yr = Hr.Function, qr = GameSDK, Qr = function() {
                function e() {
                    ...
                    r(this, e), this.markName$ = "Load Scene", this.testScene$ = {}, this.isClearedMark$ = !1, this.callbackSwitchScene$ = null, this.mutex$ = Yr.mutex(), this.listenEvents$ = function() {
                        ...
                        var n, a, r;
                        return _ts_generator(this, function(_state) {
                            return n = e.sceneName, a = e.sceneData, console.debug("Switching", r = t.correctSceneName$(n), null != a ? a : {}), r && (T.isSceneLoaded(r) || D.showLoadingFullScreen(r), t.startScene$(m(m({}, e), {}, {
                                sceneName: r
                            }))), [
                                2
                            ];
                        ...
                        return _ts_generator(this, function(_state) {
                            switch(_state.label){
                                ...
                                case 4:
                                    return s = _state.sent(), t.setSceneData$(s, null != a ? a : {}), T.markIsSceneLoaded(n), Or.emit(Gr.SCENE_LOADED, {
                                        sceneName: n
                        ...
                        return _ts_generator(this, function(_state) {
                            switch(_state.label){
                                ...
                                case 3:
                                    return _state.sent(), T.markIsSceneLoaded(n), Or.emit(Gr.SCENE_LOADED, {
                                        sceneName: n,
                                        isPreload: !0
            ...
            var Wr = Ludex, Kr = Wr.Events, jr = Wr.Utils, Xr = jr.Object, Zr = jr.Valid, Jr = jr.Time, ei = codex, ti = ei.event, ni = ei.monitorError, ai = function() {
                function e() {
                    ...
                    r(this, e), this.screens$ = {}, this.onPrefabReadyCallbacks$ = {}, this.bindEventHandlers$ = function() {
                        ...
                        return Zr.isString(e) && Xr.vals(L).includes(e);
                        ...
                        return _ts_generator(this, function(_state) {
                            ...
                            return [
                                2,
                                (n.node.addChild(a), a.active = !1, t.screens$[e.name] = m(m({}, e), {}, {
                                    state: "ready",
                                    screen: r
                        ...
                        var n = t.screens$[e];
                        t.hasPrefab$(n) && (t.screens$[e] = m(m({}, n), {}, {
            ...
            var ri, ii = Ludex, si = ii.Configs, oi = si.Core, ci = si.Ads, li = si.Match, ui = si.Player, di = si.GameEngine.HybridFileCache, hi = ii.Events, pi = ii.Plugins.Analytics, fi = (void 0 === pi ? {} : pi).Events, mi = ii.Utils, gi = mi.Device, vi = mi.Time, $i = codex, yi = $i.context, Si = $i.event, Ei = $i.analytics, Ai = $i.monitorError;
            new (t(function e() {
                var t = this;
                r(this, e), this.adsManager$ = null, this.matchManager$ = null, this.playerManager$ = null, this.logEngineReady$ = function() {
                    ...
                    window.performance.mark("Process Pre Start Game", {
                        detail: {
                            devtools: {
                                dataType: "marker",
                                color: "secondary"
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 1:
                                _state.sent(), _state.label = 2;
                            case 2:
                                return window.performance.mark("Wait SDK Initiated", {
                                    detail: {
                                        devtools: {
                                            dataType: "marker",
                                            color: "secondary"
                            ...
                            case 3:
                                ...
                                return window.performance.mark("Wait Game Resume", {
                                    detail: {
                                        devtools: {
                                            dataType: "marker",
                                            color: "secondary"
                            ...
                            case 5:
                                return window.performance.mark("Game Resumed", {
                                    detail: {
                                        devtools: {
                                            dataType: "marker",
                                            color: "tertiary"
                    ...
                    GameSDK.isGameSDK("Playable") ? T.switchScene(C.PLAYABLE_SCENE) : T.switchScene(C.BOOT_SCENE);
                }, this.preloadScenes$ = function() {
                    GameSDK.isGameSDK("Playable") || ("solo" === yi.getSessionContextType() ? T.preloadDashboardScene() : T.preloadGameScene());
                    ...
                    try {
                        var t = gi.isES5(), n = gi.heapMemory(), a = gi.pixelRatio(), r = gi.audioState(), i = gi.orientation(), s = gi.gpuRenderer(), o = gi.isSupportWebp();
                        return {
                            log_type: e,
                            is_es5: t,
                            pixel_ratio: a,
                            ...
                            support_webp: o,
                            gpu_renderer: s,
                            webgl_version: gi.webglVersion(),
                            max_texture_size: gi.maxTextureSize(),
                            hardware_concurrency: gi.hardwareConcurrency()
                        };
                    } catch (e) {
            ...
            var wi = ce.ccclass, bi = ce.executeInEditMode, Ci = "Optimized2DPipeline", Di = "default", Ri = le.SceneFlags.UI | le.SceneFlags.BLEND | le.SceneFlags.OPAQUE | le.SceneFlags.DRAW_INSTANCING, Ti = function() {
                function e() {
                    var t = this;
            ...
            if (le) {
                var Li = new Ti;
                le.setCustomPipeline(Ci, Li), console.info("[".concat(Ci, "] Registered successfully."));
            }
