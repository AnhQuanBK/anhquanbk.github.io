...
(() => {
  ...
  var init_define_GAME_CONFIG = __esm({
    "<define:__GAME_CONFIG__>"() {
      define_GAME_CONFIG_default = { AppId: "pop-jewels", AppDescription: "", ApiHost: "", OtherHost: "",
      Ads: { Enabled: true, PreloadAds: true, NotifyPlayerBeforeShow: false, ShowAdOnLoad: { Enabled: false,
      DelaySeconds: 0, PlacementId: "ad_demo_01" }, DegradationTracking: { ResetTimeMinutes: 5, MaxFailedAttempts: 8 },
      AdServiceConfigs: { AdSense: { Enabled: false, UsePreload: false, DataAdClient: "ca-pub-123456\
7890", DataAdChannel: "1234567890", DataAdBreakTest: false, DataAdFrequencyHint: 30 }, Savana: { Enabled: false,
      ...
      InterstitialAdOptions: [{ DeviceOS: "default", AdService: "platform", PlacementId: "interstiti\
al_platform", SecondsFirstTime: 45, SecondsBetweenAds: 90 }], RewardedVideoAdOptions: [{ DeviceOS: "\
default", AdService: "platform", PlacementId: "rewarded_video_platform", SecondsFirstTime: 0, SecondsBetweenAds: 0 }],
      RewardedInterstitialAdOptions: [], BannerDisplayAdOptions: [] }, Languages: { Enabled: true, DetectPlayerLocale: true },
      GameSDKOptions: { AllowWithoutSDK: false, UseNameGenerator: true, MSGames: { LoginOnStart: false,
      MaxLoginAttemptsPerDay: 1 }, TikTok: { GameId: "", ClientKey: "", Orientation: "VERTICAL" }, Yandex: {
      LoginOnStart: false, MaxLoginAttemptsPerDay: 1 }, Playable: { AppleAppStoreUrl: "", GooglePlayStoreUrl: "" },
      TranssionH5: { GaId: "G-XXXXXXXXXX" }, YoutubePlayables: { AutoLogGameReady: false } }, Core: {
      InitAsync: true, AverageLoadTime: 5, StartSDKAfterLoadGame: true, FastCheckTournamentContext: true,
      AutoSwitchGameUrl: "" }, GameEngine: { ForceDesktopDPR: 2, AutoResizeCanvas: true, PreferredFPS: {
      ...
      preset: "drawing" } }, IgnoreFiles: [] }, HybridFileCache: { Enabled: false, BuildMode: { Enabled: true,
      ...
      ".json"] } } }, Gameplay: { StartAdAtLevel: 1, MaxRescueCount: 1, Tutorial: { Enabled: true, ForceUseTutorial: false } },
      ...
      Enabled: false }, RemoteConfig: { Enabled: false } } }, Analytics: { Enabled: true, Distribution: {
      Enabled: false, Buckets: 1 }, GoogleAnalytics: { Enabled: true, ConsoleLog: false, DebugMode: false },
      ...
      PerformanceMonitor: { CoreFlows: false, EngineFlows: false, GameSDKFlows: false, LoadResources: false,
      FpsTracking: { Enabled: false, TrackingDuration: 60, TrackingInterval: 10 } }, RemoteConfig: {
      Enabled: false, Options: { ForceReloadGame: false, FetchIntervalInSeconds: 300 }, ServiceType: "\
mockup", DefaultConfigId: "default", SupportedDataTypes: ["Ludex", "Gameplay"], MockupConfig: { Enabled: true },
      SelfHostedConfig: { Enabled: false, AppId: "", ApiKey: "", ApiUrl: "" } }, Network: { MaximumRequest: 6,
      Timeout: 15e3, Retries: 3 }, Leaderboards: { Enabled: true, LeaderboardList: [] }, Notification: {
      Enabled: false, ApiUrl: "https://notifications.sunstudio.io" }, DailyRewards: { Enabled: false,
      MaxDays: 7, MockTime: 0, CheckInterrupt: false }, Mockup: { Ads: { Enabled: false, ErrorRate: 5,
      GiphyApiKey: "VmjHIRsfrwCAssDS4mDo9DoImxJm1lLM", SafeAreaBottom: 0 }, Match: { Enabled: false,
      ...
      Enabled: false, ErrorRates: 5, RandomDelayMs: 1e3, Products: [] }, SwitchGame: { Enabled: true } },
      Profile: { Enabled: false, ErrorRate: 5, RandomDelayMs: 1e3, AvatarUrl: "https://picsum.photos\
/seed/%1/300/300", RandomNameApiKey: "a1f7164dc9d2468b953aef67b0a19355" }, Leaderboards: { Enabled: false,
      MinScore: 10, MaxScore: 100, ErrorRate: 5, NumOfLeaders: { Min: 10, Max: 50 }, DefaultLimit: 60,
      RandomDelayMs: 1e3 } }, Debugger: { Console: { Enabled: true, UseGroup: true, UseInGameConsole: false },
      Profiler: { Enabled: false }, EventLogging: { Enabled: false }, CanvasRecorder: { Enabled: false,
      OnlyCore: false, PanelExpanded: false, Options: { Type: "png", Quality: 0.85, RecordFps: 60, SyncFps: true } },
      MonitorError: { Enabled: false, ApiKey: "", Service: "BugSnag", TrackUser: false, TrackPerformance: false,
      FilterErrors: { Codes: { Accepted: [], Ignored: ["USER_INPUT", "NETWORK_FAILURE"] }, Messages: {
      Accepted: [], Ignored: ["Load image failed"] } }, Feedback: false }, ListPlayerDevIds: ["0000"],
      InputRecorder: { Enabled: false, Logging: true, PlaybackDelay: 0, TimeScale: 1, UseVisualizer: true,
      SkipInactivity: { Enabled: true, MinTime: 3e3 }, MouseEvents: { mousedown: true, mouseup: true,
      mousemove: true, mouseenter: true, mouseleave: true, mouseout: true, mouseover: true } } }, AdaptivePerformance: {
      Enabled: false, Quality: { Min: 1, Max: 2, AdjustStep: 0.1 }, Options: { FpsThreshold: 48, CheckInterval: 2e3,
      AutoUpgradeQuality: true, OnlyUpdateWhenSwitchScene: false }, TrackingSceneNames: ["GameScene"] },
      FrameCapture: { Enabled: true, Options: { Quality: 0.85, RenderType: "jpeg", UseBlobIfPossible: true,
      FallbackWithWideframe: "Default" } }, Auth: { Enabled: true }, Audio: { Enabled: true }, Match: {
      Enabled: true }, Player: { Enabled: true }, Profile: { Enabled: true }, Context: { Enabled: true },
      Missions: { Enabled: false }, Visibility: { Enabled: false } };
    }
  });
  ...
  var init_define_GAME_SDK_CONFIG = __esm({
    "<define:__GAME_SDK_CONFIG__>"() {
      define_GAME_SDK_CONFIG_default = { AllowWithoutSDK: false, UseNameGenerator: true, YoutubePlayables: {
      AutoLogGameReady: false } };
    }
  });
  ...
  // extensions/ludex/libs/common/auto-switch-game.ts
  var init_auto_switch_game = __esm({
    "extensions/ludex/libs/common/auto-switch-game.ts"() {
      "use strict";
      (/* @__PURE__ */ __name((function autoSwitchGame() {
        try {
          if (true) return;
          ...
          const defaultParams = {
            inline: "1",
            // render inline instead of the game detail page
            ocid: "cgpwa-switch"
            // MSN entry point source (msstart_sdk_init.entryPointId)
          };
          ...
          console.warn("Error auto switching game", _error);
        }
      }), "autoSwitchGame"))();
    }
  });
  ...
  COOKIE_BACKUP_KEY, cookieEnv, detectCookieEnv, shimDocumentCookie, isGAScriptInit, loadGAScript, resolveGADebugMode,
  initGoogleAnalytics, processGoogleAnalytics, updateUserProperties, finalizeAnalyticsInitialization,
  ...
  var init_init_core = __esm({
    "extensions/ludex/libs/init-core.ts"() {
      ...
      COOKIE_BACKUP_KEY = "__cookie__";
      cookieEnv = null;
      detectCookieEnv = /* @__PURE__ */ __name(() => {
        if (cookieEnv) return cookieEnv;
        if (window.origin === "null") {
          cookieEnv = "opaque_origin";
          return cookieEnv;
        }
        try {
          document.cookie = "__probe__=1";
          const writable = document.cookie.indexOf("__probe__=1") !== -1;
          document.cookie = "__probe__=; expires=Thu, 01 Jan 1970 00:00:00 GMT";
          cookieEnv = writable ? "cookie_ok" : "cookie_silent_blocked";
        } catch (e) {
          cookieEnv = "cookie_throws";
        }
        return cookieEnv;
      }, "detectCookieEnv");
      shimDocumentCookie = /* @__PURE__ */ __name(() => {
        if (detectCookieEnv() === "cookie_ok") return;
        let backup = "";
        try {
          backup = localStorage.getItem(COOKIE_BACKUP_KEY) ?? "";
        } catch (e) {
        }
        try {
          Object.defineProperty(document, "cookie", {
            configurable: true,
            get: /* @__PURE__ */ __name(() => backup, "get"),
            set: /* @__PURE__ */ __name((value) => {
              const [name2, cookieValue] = value.split(";")[0].trim().split("=");
              const entries = backup.split("; ").filter((entry) => entry && entry.indexOf(`${name2}=`) !==
              0);
              if (cookieValue) entries.push(`${name2}=${cookieValue}`);
              backup = entries.join("; ");
              try {
                localStorage.setItem(COOKIE_BACKUP_KEY, backup);
              } catch (e) {
              }
            }, "set")
          });
        } catch (error) {
          console.warn("Failed to shim document.cookie", error);
        }
      }, "shimDocumentCookie");
      ...
      resolveGADebugMode = /* @__PURE__ */ __name((userId) => {
        if (!Ludex?.Configs?.Analytics?.GoogleAnalytics?.DebugMode) return false;
        if (true) return true;
        const devIds = Ludex?.Configs?.Debugger?.ListPlayerDevIds ?? [];
        return !!userId && devIds.indexOf(userId) >= 0;
      }, "resolveGADebugMode");
      initGoogleAnalytics = /* @__PURE__ */ __name((userId, entryPoint, tagIds) => {
        try {
          ...
          const buildVersion2 = 2;
          const distConfig = Ludex?.Configs?.Analytics?.Distribution;
          const distEnabled = distConfig?.Enabled ?? false;
          const distBuckets = distConfig?.Buckets ?? 1;
          const shouldDistribute = distEnabled && distBuckets > 1;
          const distSuffix = shouldDistribute ? `.${Ludex.Utils.Hash.distribute(userId, distBuckets)}` :
          "";
          const resolvedBuild = `${buildVersion2}${distSuffix}`;
          window.BuildVersion = resolvedBuild;
          for (const tagId of tagIds) {
            window.gtag("config", tagId, __spreadValues({
              cookie_flags: "SameSite=None;Secure",
              build: resolvedBuild,
              medium: entryPoint,
              campaign: campaign_id,
              groups: "GA"
            }, window.__gaDebugMode ? { debug_mode: true } : {}));
          }
      ...
      processGoogleAnalytics = /* @__PURE__ */ __name(async () => {
        ...
        try {
          ...
          window.__gaDebugMode = resolveGADebugMode(userId);
          try {
          ...
          logAnalyticsEvent("analytics_status", {
            mode: detectCookieEnv(),
  ...
  function trace() {
    ...
    if (args[0] === "event") {
      ...
      args[2].build = window.BuildVersion || buildVersion;
      args[2].send_to = "GA";
  ...
  // extensions/ludex/libs/polyfill/youtube.ts
  var isDevelopment, sanitizeUrl, OriginalXHR, _YoutubeAdapterRequest, YoutubeAdapterRequest, OriginalImage,
  _YoutubeAdapterImage, YoutubeAdapterImage;
  var init_youtube = __esm({
    "extensions/ludex/libs/polyfill/youtube.ts"() {
      "use strict";
      isDevelopment = true;
      sanitizeUrl = /* @__PURE__ */ __name((url) => {
      ...
      _YoutubeAdapterRequest = class _YoutubeAdapterRequest extends OriginalXHR {
        open(method, url, async, user, password) {
          const sanitizedUrl = typeof url === "string" ? isDevelopment ? url : sanitizeUrl(url) : url;
          super.open(method, sanitizedUrl, async !== false, user, password);
        }
      };
      __name(_YoutubeAdapterRequest, "YoutubeAdapterRequest");
      YoutubeAdapterRequest = _YoutubeAdapterRequest;
      window.XMLHttpRequest = YoutubeAdapterRequest;
      OriginalImage = window.Image;
      _YoutubeAdapterImage = class _YoutubeAdapterImage extends OriginalImage {
        get src() {
          return super.src;
        }
        set src(url) {
          super.src = isDevelopment ? url : sanitizeUrl(url);
        }
      };
      __name(_YoutubeAdapterImage, "YoutubeAdapterImage");
      YoutubeAdapterImage = _YoutubeAdapterImage;
      window.Image = YoutubeAdapterImage;
    }
  });
  ...
  var init_TemplateManager = __esm({
    "extensions/ludex/src/game-sdk/elements/TemplateManager.ts"() {
      ...
      addAsyncPopupTemplate = /* @__PURE__ */ __name(async () => {
        return addTemplate({
  ...
  var _BaseAsyncPopup, BaseAsyncPopup, BaseAsyncPopup_default;
  var init_BaseAsyncPopup = __esm({
    "extensions/ludex/src/game-sdk/common/BaseAsyncPopup.ts"() {
      ...
      _BaseAsyncPopup = class _BaseAsyncPopup {
        ...
        onYes = /* @__PURE__ */ __name((callback) => {
        ...
        handleCallback$ = /* @__PURE__ */ __name((callback) => (e) => {
  ...
  // extensions/ludex/src/game-sdk/common/SwitchGameAsyncPopup.ts
  var SwitchGameAsyncPopup_exports = {};
  __export(SwitchGameAsyncPopup_exports, {
    default: () => SwitchGameAsyncPopup_default
  });
  var _SwitchGameAsyncPopup, SwitchGameAsyncPopup, SwitchGameAsyncPopup_default;
  var init_SwitchGameAsyncPopup = __esm({
    "extensions/ludex/src/game-sdk/common/SwitchGameAsyncPopup.ts"() {
      "use strict";
      init_define_GAME_CONFIG();
      init_define_GAME_SDK_CONFIG();
      ...
      init_youtube();
      init_BaseAsyncPopup();
      _SwitchGameAsyncPopup = class _SwitchGameAsyncPopup extends BaseAsyncPopup_default {
        show(appId) {
          this.title$.textContent = "Switch Game";
          this.okButton$.textContent = "Switch";
          this.noButton$.textContent = "Dismiss";
          const content = `Do you want to switch to another game?
App ID: ${appId}`;
          super.show(content);
        }
      };
      __name(_SwitchGameAsyncPopup, "SwitchGameAsyncPopup");
      SwitchGameAsyncPopup = _SwitchGameAsyncPopup;
      SwitchGameAsyncPopup_default = SwitchGameAsyncPopup;
    }
  });

  // extensions/ludex/src/game-sdk/common/MockSwitchGame.ts
  var MockSwitchGame_exports = {};
  __export(MockSwitchGame_exports, {
    default: () => MockSwitchGame_default
  });
  var _MockSwitchGame, MockSwitchGame, MockSwitchGame_default;
  var init_MockSwitchGame = __esm({
    "extensions/ludex/src/game-sdk/common/MockSwitchGame.ts"() {
      "use strict";
      init_define_GAME_CONFIG();
      init_define_GAME_SDK_CONFIG();
      ...
      init_google_analytics();
      init_youtube();
      _MockSwitchGame = class _MockSwitchGame {
        extra;
        popup$ = null;
        constructor(adapter) {
          this.extra = adapter.extra;
        ...
        async switchGameAsync(appId, data) {
          this.extra.checkPopupShown();
          if (!appId) {
            this.extra.exceptionInvalidParam("appId is required");
          }
          ...
          await new Promise((resolve, reject) => {
            ...
            this.popup$.onYes(this.handleOnYes$(appId, data, resolve));
            this.popup$.onNo(this.handleOnNo$(reject));
            this.popup$.show(appId);
            this.extra.isPopupShown = true;
          });
        }
        async loadPopupAsync$() {
          if (this.popup$) return;
          const SwitchGameAsyncPopup2 = (await Promise.resolve().then(() => (init_SwitchGameAsyncPopup(), SwitchGameAsyncPopup_exports))).
          default;
          if (typeof SwitchGameAsyncPopup2 !== "function") return;
          this.popup$ = new SwitchGameAsyncPopup2();
          await this.popup$.setupTemplate();
        }
        handleOnYes$ = /* @__PURE__ */ __name((appId, data, resolve) => () => {
          this.extra.isPopupShown = false;
          console.info("MockSwitchGame > switched to", appId, data);
          resolve(true);
        }, "handleOnYes$");
        handleOnNo$ = /* @__PURE__ */ __name((reject) => () => {
          this.extra.isPopupShown = false;
      ...
      __name(_MockSwitchGame, "MockSwitchGame");
      MockSwitchGame = _MockSwitchGame;
      MockSwitchGame_default = MockSwitchGame;
    }
  });
  ...
  var init_Extra = __esm({
    "extensions/ludex/src/game-sdk/sdk/Extra.ts"() {
      ...
      _Extra = class _Extra {
        ...
        async switchGameAsync(appId, data) {
          await this.createMockSwitchGame$();
          if (!this.mockSwitchGame$) {
            this.exceptionUnsupported();
          }
          return this.mockSwitchGame$.switchGameAsync(appId, data);
        }
        async createMockSwitchGame$() {
          if (this.mockSwitchGame$) return;
          const MockSwitchGame2 = (await Promise.resolve().then(() => (init_MockSwitchGame(), MockSwitchGame_exports))).
          default;
          if (typeof MockSwitchGame2 !== "function") return;
          this.mockSwitchGame$ = new MockSwitchGame2(this.adapter$);
        }
    ...
    "extensions/ludex/src/game-sdk/sdk/OverlayViews.ts"() {
      ...
      _OverlayViews = class _OverlayViews {
        ...
        createOverlayView(_fullyQualifiedOverlayViewFilename, _pathToCSS, _initialData, _onInitializedSuccessCallback, _onInitializedErrorCallback) {
          this.extra$.exceptionClientUnsupportedOperation(
            "createOverlayView callback-based is not supported in mock mode"
          );
        }
        createOverlayViewWithXMLString(_xmlString, _pathToCSS, _initialData, _onInitializedSuccessCallback, _onInitializedErrorCallback) {
          this.extra$.exceptionClientUnsupportedOperation(
            "createOverlayViewWithXMLString callback-based is not supported in mock mode"
          );
        }
        ...
        async createOverlayViewWithXMLStringAsync(_overlayViewContentOverride, _domElement, _iFrameStyle, _pathToCSS, _initialData, _pathToOverlayFiles) {
          this.extra$.exceptionClientUnsupportedOperation(
            "createOverlayViewWithXMLStringAsync is not supported in mock mode"
          );
        }
        async createProfilePictureOverlayViewAsync(_domElement, _imageStyle, _iFrameStyle) {
          this.extra$.exceptionClientUnsupportedOperation(
            "createProfilePictureOverlayViewAsync is not supported in mock mode"
          );
        }
        async createProfileNameOverlayViewAsync(_domElement, _textStyle, _iFrameStyle, _pathToCss) {
          this.extra$.exceptionClientUnsupportedOperation(
            "createProfileNameOverlayViewAsync is not supported in mock mode"
          );
        }
...
ion"];
      ...
      _Payments = class _Payments {
        ...
        async initPaymentInfoAsync() {
          ...
          const { Enabled: Enabled2 } = Mockup3.GameSDK.Payments;
          if (!Enabled2) return;
    ...
    "extensions/ludex/src/game-sdk/sdk/Player.ts"() {
      ...
      _Player = class _Player {
        ...
        updateCurrentPlayerInfo$(playerId2) {
          const {
            Utils: { Browser: B5, Valid: V37, Object: O32, String: S10 }
          } = Ludex;
...
amentType")
  ...
  // extensions/ludex/src/game-sdk/adapters/youtube-playables/YTAdInstance.ts
  var ErrorCodes, _YTAdInstance, YTAdInstance, YTAdInstance_default;
  var init_YTAdInstance = __esm({
    "extensions/ludex/src/game-sdk/adapters/youtube-playables/YTAdInstance.ts"() {
      "use strict";
      init_define_GAME_CONFIG();
      init_define_GAME_SDK_CONFIG();
      ...
      _YTAdInstance = class _YTAdInstance extends AdInstance_default {
        sdk$;
        isAdShowInProgress$ = false;
        constructor(type, placementId, sdk2) {
...
g ads");
          ...
          try {
            ...
            switch (this.type$) {
              case "interstitial":
                await this.showInterstitialAdAsync();
                break;
              case "rewarded":
                await this.showRewardedAdAsync();
                break;
              default:
                throw this.makeErrorWithCode$(ErrorCodes.INVALID_OPERATION, `Unknown ad type: ${this.
                type$}`);
            }
            console.debug("YTAdInstance showAsync completed");
          } catch (error) {
        ...
        showInterstitialAdAsync() {
          return this.sdk$.ads.requestInterstitialAd();
        }
        async showRewardedAdAsync() {
          const placementId = this.getPlacementID();
          const success2 = await this.sdk$.ads.requestRewardedAd(placementId);
          if (!success2) {
            throw this.makeErrorWithCode$(
              ErrorCodes.USER_INPUT,
              `User cancelled the rewarded ad with placement ID: ${placementId}.`
            );
          }
        }
        makeErrorWithCode$(code, error) {
          ...
          if (typeof error === "string") {
            message = error;
          } else if (O32.hasOwn(error, "message") && typeof error.message === "string") {
            message = error.message;
          } else if (O32.hasOwn(error, "description") && typeof error.description === "string") {
          ...
          if (O32.hasOwn(error, "code") && typeof error.code === "string") {
            errCode = error.code;
          } else if (O32.hasOwn(error, "errorType") && typeof error.errorType === "number") {
            const errorTypeNames = ["UNKNOWN", "API_UNAVAILABLE", "INVALID_PARAMS", "SIZE_LIMIT_EXCE\
EDED"];
            errCode = errorTypeNames[error.errorType] ?? `YT_ERROR_TYPE_${error.errorType}`;
          }
          return new SDKCommonError_default(errCode, message);
        }
      };
      __name(_YTAdInstance, "YTAdInstance");
      YTAdInstance = _YTAdInstance;
      YTAdInstance_default = YTAdInstance;
    }
  });

  // extensions/ludex/src/game-sdk/adapters/youtube-playables/YTExtra.ts
  var _YTExtra, YTExtra, YTExtra_default;
  var init_YTExtra = __esm({
    "extensions/ludex/src/game-sdk/adapters/youtube-playables/YTExtra.ts"() {
      "use strict";
      init_define_GAME_CONFIG();
      init_define_GAME_SDK_CONFIG();
      ...
      init_youtube();
      init_Extra();
      _YTExtra = class _YTExtra extends Extra_default {
        sdk$;
        constructor(adapter) {
          super(adapter);
        ...
        updatePlatformConfigs$() {
          ...
          const { YoutubePlayables } = gameConfig;
          if (!YoutubePlayables) return;
        }
        // * Note: gameReady() should be called only when the game is fully loaded and interactive.
        gameReady() {
          this.sdk$.game.gameReady();
          this.mark$("YT.gameReady");
        }
        // * Note: firstFrameReady() should be called when the game begins init/loading (first visual frame is ready).
        firstFrameReady() {
          this.sdk$.game.firstFrameReady();
          this.mark$("YT.firstFrameReady");
        }
        mark$(name2) {
          try {
            performance.mark(name2);
          } catch (e) {
            console.info("Failed to record performance mark:", e);
          }
        }
        logError(error) {
          try {
            this.sdk$.health.logError();
            this.mark$("YT.logError");
            console.error("YT Health Error:", error);
          } catch (e) {
        ...
        logWarning(warning) {
          try {
            ...
            this.mark$("YT.logWarning");
            console.warn("YT Health Warning:", warning);
          } catch (e) {
            console.warn("Failed to log warning to YT health:", e);
          }
        }
        async sendScore(score2) {
          try {
            this.mark$("YT.sendScore");
            await this.sdk$.engagement.sendScore({ value: score2 });
          } catch (error) {
            this.logError(error);
            console.error("Failed to send score to YT engagement:", error);
            throw error;
          }
        }
        async openYTContent(id) {
          try {
            this.mark$("YT.openYTContent");
            await this.sdk$.engagement.openYTContent({ id });
          } catch (error) {
            this.logError(error);
            console.error("Failed to open YT content:", error);
            throw error;
          }
        }
        async shareInviteCode(inviteCode) {
          try {
            this.mark$("YT.shareInviteCode");
            await this.sdk$.game.shareInviteCode(inviteCode);
          } catch (error) {
            this.logError(error);
            throw error;
          }
      ...
      __name(_YTExtra, "YTExtra");
      YTExtra = _YTExtra;
      YTExtra_default = YTExtra;
    }
  });

  // extensions/ludex/src/game-sdk/adapters/youtube-playables/YTPlayer.ts
  var _YTPlayer, YTPlayer, YTPlayer_default;
  var init_YTPlayer = __esm({
    "extensions/ludex/src/game-sdk/adapters/youtube-playables/YTPlayer.ts"() {
      "use strict";
      init_define_GAME_CONFIG();
      init_define_GAME_SDK_CONFIG();
      ...
      init_youtube();
      init_Player();
      _YTPlayer = class _YTPlayer extends Player_default {
        constructor(adapter) {
          super(adapter);
          this.sdk$ = adapter.sdk;
          this.extra$ = adapter.extra;
        ...
        async getDataAsync(keys) {
          ...
          try {
            const dataString = await this.sdk$.game.loadData();
            if (!dataString) return {};
            const {
              Utils: { Json: J6, Valid: V37, Object: O32 }
            } = Ludex;
            const data = J6.decode(dataString);
            if (!V37.isObject(data)) return {};
        ...
        async setDataAsync(data) {
          ...
          try {
            const currentDataString = await this.sdk$.game.loadData();
            const {
              Utils: { Json: J6, Valid: V37, Object: O32 }
            } = Ludex;
            let currentData = {};
            if (currentDataString) {
              const decoded = J6.decode(currentDataString);
              if (V37.isObject(decoded)) {
                currentData = decoded;
              }
            }
            const newData = O32.merge(currentData, data);
            const serialized = J6.encode(newData);
            await this.sdk$.game.saveData(serialized);
          } catch (error) {
            this.extra$.logError(error);
            throw error;
          }
        }
        async getSignedPlayerInfoAsync() {
      ...
      __name(_YTPlayer, "YTPlayer");
      YTPlayer = _YTPlayer;
      YTPlayer_default = YTPlayer;
    }
  });

  // extensions/ludex/src/game-sdk/adapters/youtube-playables/YTAdapter.ts
  var _YTAdapter, YTAdapter, YTAdapter_default;
  var init_YTAdapter = __esm({
    "extensions/ludex/src/game-sdk/adapters/youtube-playables/YTAdapter.ts"() {
      "use strict";
      init_define_GAME_CONFIG();
      init_define_GAME_SDK_CONFIG();
      ...
      init_YTExtra();
      init_YTPlayer();
      _YTAdapter = class _YTAdapter extends GameSDK_default2 {
        sdk;
        locale$ = null;
        constructor(sdk2) {
          super();
        ...
        initialize$() {
          super.initialize$();
          this.extra = new YTExtra_default(this);
          this.player = new YTPlayer_default(this);
        }
        async tryGetLocale$() {
          try {
            this.locale$ = await this.sdk.system.getLanguage();
          } catch (error) {
            this.extra.logError(error);
          }
        }
        ...
        async checkSDKInitialized$() {
          ...
          this.extra.exceptionInvalidOperation("YouTube Playables SDK is not initialized");
        }
        async initializeAsync() {
          if (this.isInitialized) return;
          ...
          try {
            ...
            this.tryGetLocale$();
            this.extra.firstFrameReady();
            this.setupLifecycleListeners$();
            this.isInitialized = true;
          } catch (error) {
            console.debug(error);
            if (this.isNeedSDK$()) {
              throw new Error("Youtube Playables SDK not initialized");
            }
            console.warn("Youtube Playables SDK not initialized, running without platform sdk");
          }
        }
        async startGameAsync() {
          await super.startGameAsync();
          this.autoCallGameReady$();
        }
        autoCallGameReady$() {
          const gameConfig = define_GAME_SDK_CONFIG_default;
          if (!gameConfig) return;
          const { YoutubePlayables } = gameConfig;
          if (!YoutubePlayables) return;
          if (!YoutubePlayables.AutoLogGameReady) return;
          this.extra.gameReady();
        }
        ...
        // ? YouTube Playables already provides mock ads for testing — no Ludex mock ads needed here.
        async getInterstitialAdAsync(placementId) {
          return new YTAdInstance_default("interstitial", placementId, this.sdk);
        }
        async getRewardedVideoAsync(placementId) {
          return new YTAdInstance_default("rewarded", placementId, this.sdk);
        }
        async getRewardedInterstitialAsync() {
          this.extra.exceptionUnsupported();
        }
        async loadBannerAdAsync() {
          this.extra.exceptionUnsupported();
        }
      ...
      __name(_YTAdapter, "YTAdapter");
      YTAdapter = _YTAdapter;
      YTAdapter_default = YTAdapter;
    }
  });
  ...
  function autoDetectAndInitializeSDKAdapter() {
    ...
    if ("FBInstant" in w) {
      ...
      sdkAdapter = new YTAdapter_default(window.ytgame);
  ...
  var init_GameSDK2 = __esm({
    "extensions/ludex/src/GameSDK.ts"() {
      ...
      window.GameSDK = autoDetectAndInitializeSDKAdapter();
 ...
 ")}`
  ...
  // extensions/ludex/src/utils/device/getSafeAreaTop.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  var func50 = /* @__PURE__ */ __name(() => {
    try {
      ...
      const val = parseInt(sat, 10);
      if (!isNaN(val) && val > 0) return val;
    } catch (e) {
    }
    try {
      const div = document.createElement("div");
      div.style.cssText = "position:absolute;top:0;left:0;z-index:-9999;visibility:hidden;padding-to\
p:env(safe-area-inset-top);";
  ...
  var getSafeAreaTop_default = func50;
  ...
  var func51 = /* @__PURE__ */ __name(() => {
    ...
    return /iPhone|iPad|iPod/i.test(navigator.userAgent) || isIPadOS13Plus;
  }, "func");
  var isIOS_default = func51;
...
ttom:env(safe-area-inset-bottom);";
    ...
    if (!isIOS_default()) return 0;
    const { width, height } = window.screen;
    const min = Math.min(width, height);
    const max = Math.max(width, height);
    const isIPad = /iPad/i.test(navigator.userAgent) || navigator.platform === "MacIntel" && navigator.
    maxTouchPoints > 1;
    if (!isIPad) {
      return max >= 780 ? 34 : 0;
    }
    const homeButtonDimensions = [
      "768,1024",
      // iPad, iPad mini (various gens, home button)
      "810,1080",
      // iPad 7th-9th gen (home button)
      "834,1112"
      // iPad Air 3rd gen, iPad Pro 10.5" (home button)
    ];
    const hasHomeButton = homeButtonDimensions.includes(`${min},${max}`);
    return hasHomeButton ? 0 : 20;
  }, "func");
  var getSafeAreaBottom_default = func52;
  ...
  var gpuRenderer_default = func53;
  ...
  var hardwareConcurrency_default = func54;
  ...
  var isSupportWebp_default = func60;
  ...
  var maxTextureSize_default = func61;
  ...
  var orientation_default = func62;
  ...
  var webglVersion_default = func63;
  ...
  var device_default = {
    ...
    getSafeAreaTop: getSafeAreaTop_default,
  ...
  init_google_analytics();
  init_youtube();
  var func65 = /* @__PURE__ */ __name((promises) => {
  ...
  init_google_analytics();
  init_youtube();
  var func66 = /* @__PURE__ */ __name(async (promise, timeout) => {
    try {
      if (timeout) {
  ...
  var handleAsync_default = func66;
  ...
  init_google_analytics();
  init_youtube();
  var func68 = /* @__PURE__ */ __name((obj, key) => {
  ...
  init_google_analytics();
  init_youtube();
  var func69 = /* @__PURE__ */ __name((input) => typeof input === "function", "func");
  var isFunction_default = func69;

  // extensions/ludex/src/utils/function/overlay.ts
  var func70 = /* @__PURE__ */ __name((original, obj) => {
...
object`,
  ...
  init_google_analytics();
  init_youtube();
  var func71 = /* @__PURE__ */ __name((firstTry, secondTry) => {
    try {
      return firstTry();
    } catch (firstError) {
      try {
  ...
  init_google_analytics();
  init_youtube();
  var func72 = /* @__PURE__ */ __name(async (firstTry, secondTry) => {
    try {
  ...
  init_google_analytics();
  init_youtube();
  var func73 = /* @__PURE__ */ __name((config) => {
  ...
  var func74 = /* @__PURE__ */ __name((source) => {
  ...
  var syncVarsFromSource_default = func74;
  ...
  init_google_analytics();
  init_youtube();
  var func75 = /* @__PURE__ */ __name((promise, duration) => {
    if (duration <= 0) {
      return promise;
    }
    return Promise.race([
  ...
  init_google_analytics();
  init_youtube();
  var func76 = /* @__PURE__ */ __name((duration) => {
  ...
  init_google_analytics();
  init_youtube();
  var func77 = /* @__PURE__ */ __name((data) => {
    const inverse = {};
    for (const key in data) {
  ...
  var func78 = /* @__PURE__ */ __name((hash, codeMap) => {
    const str = hash;
  ...
  var decodeMap_default = func78;

  // extensions/ludex/src/utils/hash/distribute.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  // extensions/ludex/src/utils/hash/fnv1a.ts
  init_define_GAME_CONFIG();
  init_define_GAME_SDK_CONFIG();
  init_console();
  init_track_events();
  ...
  var func79 = /* @__PURE__ */ __name((input) => {
    let hash = FNV_OFFSET_BASIS_32;
    for (let i = 0; i < input.length; i++) {
      hash ^= input.charCodeAt(i);
      hash = imul32(hash, FNV_PRIME_32);
    }
    return hash >>> 0;
  }, "func");
  var fnv1a_default = func79;

  // extensions/ludex/src/utils/hash/distribute.ts
  var func80 = /* @__PURE__ */ __name((seed, count) => {
    if (count <= 0) return -1;
    if (count === 1) return 0;
    return fnv1a_default(seed) % count;
  }, "func");
  var distribute_default = func80;
  ...
  init_google_analytics();
  init_youtube();
  var func81 = /* @__PURE__ */ __name((data) => typeof data === "string", "func");
  var isString_default = func81;
  ...
  var func82 = /* @__PURE__ */ __name((data, codeMap, isRecursive = false) => {
    let str = "";
  ...
  init_google_analytics();
  init_youtube();
  var func83 = /* @__PURE__ */ __name((hash, token) => {
    try {
      if (!hash) return "";
      if (token) {
  ...
  var hashToString_default = func83;
  ...
  var func84 = /* @__PURE__ */ __name((str, customDict, level2 = 1) => {
    let word = str[0];
    const result3 = [];
  ...
  var lzwCompress_default = func84;
  ...
  var func85 = /* @__PURE__ */ __name((hash, customDict, level2 = 1) => {
    let entry = "";
    let result3 = "";
  ...
  var lzwDecompress_default = func85;
  ...
  init_google_analytics();
  init_youtube();
  var func86 = /* @__PURE__ */ __name((str, token) => {
    try {
      if (!str) return "";
      if (token) {
  ...
  var stringToHash_default = func86;
  ...
  init_google_analytics();
  init_youtube();
  var func87 = /* @__PURE__ */ __name((blob) => {
    return new Promise((resolve, reject) => {
  ...
  var blobToDataImage_default = func87;
  ...
  init_youtube();
  var img = new Image();
  var func88 = /* @__PURE__ */ __name((blob, forceNew = true, autoRevoke = true) => {
    return new Promise((resolve) => {
  ...
  var blobToHtmlImage_default = func88;
  ...
  init_google_analytics();
  init_youtube();
  var func89 = /* @__PURE__ */ __name(async (blobUrl, fileName) => {
    const blob = await fetch(blobUrl).then((r) => r.blob()).catch(() => null);
    if (!blob) return null;
    return new File([blob], fileName);
  }, "func");
  var blobUrlToFile_default = func89;
  ...
  var func90 = /* @__PURE__ */ __name(async (element, type = "png") => {
  ...
  var elementToBase64_default = func90;
  ...
  var func91 = /* @__PURE__ */ __name(async (element, type = "png") => {
    try {
      if (!result2) {
  ...
  var elementToBlob_default = func91;
  ...
  init_google_analytics();
  init_youtube();
  var func92 = /* @__PURE__ */ __name(async (url) => {
  ...
  init_google_analytics();
  init_youtube();
  var func93 = /* @__PURE__ */ __name(async (url) => {
    return new Promise((resolve, reject) => {
  ...
  var func94 = /* @__PURE__ */ __name((url, scale = 1) => {
    return new Promise((resolve) => {
...
: ${width}px ${height}px;`
  ...
  init_google_analytics();
  init_youtube();
  var func95 = /* @__PURE__ */ __name((value, maxLength) => {
  ...
  var getShortNumber_default = func95;
  ...
  init_google_analytics();
  init_youtube();
  var func97 = /* @__PURE__ */ __name((num) => {
    if (num > 0) return 1;
    if (num < 0) return -1;
    if (num === 0) return 0;
    return Number.NaN;
  }, "func");
  var sign_default = func97;
  ...
  // extensions/ludex/src/utils/object/camelCaseKeys.ts
  var func98 = /* @__PURE__ */ __name((obj) => {
    const newObj = {};
  ...
  var camelCaseKeys_default = func98;
  ...
  init_google_analytics();
  init_youtube();
  var func99 = /* @__PURE__ */ __name((x, y) => {
    if (x === y) {
      return x !== 0 || 1 / x === 1 / y;
    }
    return x !== x && y !== y;
  }, "func");
  var is_default = func99;
...
n") {
  ...
  var func100 = /* @__PURE__ */ __name((source, target) => {
    return diffRecursive(source, target, /* @__PURE__ */ new WeakMap());
  }, "func");
  var diff_default = func100;
  ...
  init_google_analytics();
  init_youtube();
  var func101 = /* @__PURE__ */ __name((data, keys = []) => {
    const result3 = {};
  ...
  init_google_analytics();
  init_youtube();
  var func102 = /* @__PURE__ */ __name((source, input) => {
    const result3 = {};
      ...
      if (hasOwn_default(input, key)) {
        if (isObject_default(input[key]) && input[key] !== null) {
          if (isObject_default(source[key]) && source[key] !== null) {
            ...
            const filteredSubObject = func102(source[key], input[key]);
  ...
  var filterDeep_default = func102;
  ...
  init_google_analytics();
  init_youtube();
  var func103 = /* @__PURE__ */ __name((value, object) => {
    return Object.values(object).includes(value);
  }, "func");
  var isIn_default = func103;
  ...
  init_google_analytics();
  init_youtube();
  var func104 = /* @__PURE__ */ __name((key) => {
    return ["string", "number", "symbol"].indexOf(typeof key) > -1;
  }, "func");
  var isPropertyKey_default = func104;

  // extensions/ludex/src/utils/object/keyBy.ts
  var func105 = /* @__PURE__ */ __name((array, key) => {
    const result3 = {};
  ...
  // extensions/ludex/src/utils/object/snakeCaseKeys.ts
  var func106 = /* @__PURE__ */ __name((obj) => {
    const newObj = {};
    for (const key in obj) {
      const value = obj[key];
  ...
  var snakeCaseKeys_default = func106;
  ...
  init_google_analytics();
  init_youtube();
  var func107 = /* @__PURE__ */ __name((object) => {
    return Object.keys(object).map((key) => {
      return object[key];
    });
  }, "func");
  var vals_default = func107;
  ...
  init_google_analytics();
  init_youtube();
  var func108 = /* @__PURE__ */ __name((str) => {
    if (!str) return str;
    return str[0].toUpperCase() + str.slice(1);
  }, "func");
  var capitalize_default = func108;
  ...
  var func109 = /* @__PURE__ */ __name(async () => {
    try {
      if (!names) {
  ...
  var generateNameAsync_default = func109;
  ...
  init_google_analytics();
  init_youtube();
  var func110 = /* @__PURE__ */ __name((radix = 16) => {
  ...
  var generateObjectId_default = func110;
  ...
  init_google_analytics();
  init_youtube();
  var func111 = /* @__PURE__ */ __name((locale2) => {
  ...
  var getLanguageCode_default = func111;
  ...
  init_google_analytics();
  init_youtube();
  var func112 = /* @__PURE__ */ __name((name2, length) => {
  ...
  var getShortName_default = func112;
  ...
  init_google_analytics();
  init_youtube();
  var func113 = /* @__PURE__ */ __name((str) => {
    let hash = 0;
  ...
  init_google_analytics();
  init_youtube();
  var func114 = /* @__PURE__ */ __name((value, length, pad = " ") => {
  ...
  init_google_analytics();
  init_youtube();
  var func115 = /* @__PURE__ */ __name((payload) => {
  ...
  init_google_analytics();
  init_youtube();
  var func116 = /* @__PURE__ */ __name((len, startWith) => {
  ...
  var func117 = /* @__PURE__ */ __name((prefix = "0x") => {
    let color = prefix;
    for (let i = 0; i < 6; i++) {
  ...
  var randomColor_default = func117;
  ...
  init_google_analytics();
  init_youtube();
  var func118 = /* @__PURE__ */ __name((str) => {
    const result3 = str.normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/[đĐ]/g, (m) => m ===
    "\u0111" ? "d" : "D");
    return result3;
  }, "func");
  var removeDiacritics_default = func118;
  ...
  var func119 = /* @__PURE__ */ __name((timestamp, locales, options, fallbackMessage = "Soon") => {
    try {
  ...
  var getRelativeTime_default = func119;
  ...
  init_google_analytics();
  init_youtube();
  var func120 = /* @__PURE__ */ __name((timestamp) => {
  ...
  var getTimeString_default = func120;
  ...
  init_google_analytics();
  init_youtube();
  var func122 = /* @__PURE__ */ __name((milliseconds) => {
    return new Promise((resolve) => setTimeout(resolve, milliseconds));
  }, "func");
  var sleepAsync_default = func122;
  ...
  init_google_analytics();
  init_youtube();
  var func123 = /* @__PURE__ */ __name((data) => typeof data === "boolean", "func");
  var isBoolean_default = func123;
  ...
  init_google_analytics();
  init_youtube();
  var func124 = /* @__PURE__ */ __name(() => {
    if (true) return true;
    return !!codex?.player?.getPlayerDataByKey("debug");
  }, "func");
  var isDebugger_default = func124;
  ...
  init_google_analytics();
  init_youtube();
  var func125 = /* @__PURE__ */ __name((data) => typeof data === "number", "func");
  var isNumber_default = func125;
  ...
  init_google_analytics();
  init_youtube();
  var func126 = /* @__PURE__ */ __name((input) => {
  ...
  init_google_analytics();
  init_youtube();
  var func127 = /* @__PURE__ */ __name((from, to, options) => {
  ...
  var isValueChangeAsync_default = func127;
  ...
  window.GameName = "Pop Jewels";
  window.CommitId = "efab336a-6068123b";
...
nts"],
  ...
  init_google_analytics();
  init_youtube();
  var FONT_SYS_FAMILY = `nunito,-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen,Ubuntu,Can\
tarell,"Fira Sans","Droid Sans","Helvetica Neue",sans-serif`;
  ...
  var {
    ...
    Utils: { Browser: B2, Image: I, Object: O6, Valid: V10 }
  } = Ludex;
  var _FrameCapturePlugin = class _FrameCapturePlugin extends Ludex.Plugins.BasePlugin {
    ...
    getRenderImages$(renderOptions) {
      ...
      for (const imageOption of imageOptions) {
        ...
        const isImageValid = V10.isString(image) && image !== "";
        if (!name2) {
  ...
  // extensions/ludex/src/plugins/language/LanguagePlugin.ts
  var {
    Utils: { Object: O7, Function: F3, Browser: B3, Valid: V11 },
    Configs: {
      Languages: { DetectPlayerLocale }
    }
  } = Ludex;
  function nullOrNotEmpty(value) {
    if (V11.isEmpty(value)) return null;
    return value;
  }
  ...
  var {
    ...
    Utils: { Object: O8, String: S3, Valid: V12 }
  } = Ludex;
  var _LeaderboardAPI = class _LeaderboardAPI {
    ...
    async createLeaderboardAsync(payload) {
      ...
      if (Mockup.Leaderboards.Enabled) {
        ...
        if (O8.hasOwn(result3, "data") && V12.isObject(result3.data)) {
          result3 = result3.data;
        }
      }
  ...
  // extensions/ludex/src/plugins/leaderboards/LeaderboardPlugin.ts
  var {
    Utils: { Array: A5, Valid: V13, Json: J3, Object: O9 },
    Configs: {
  ...
  init_google_analytics();
  init_youtube();
  var { Object: O10, Valid: V14, Json: J4 } = Ludex.Utils;
...
customData"]);
        ...
        if (!V14.isEmpty(profiles)) {
          console.info("\u{1F4BE} Profile");
          console.table(O10.clone(profiles));
        }
        if (!V14.isEmpty(customData)) {
          console.info("\u{1F4BE} Custom");
          console.table(O10.clone(customData));
        }
        console.groupEnd();
  ...
  // extensions/ludex/src/plugins/match/handlers/context/CreateContextHandler.ts
  var { Valid: V16, Object: O12 } = Ludex.Utils;
  var _CreateContextHandler = class _CreateContextHandler extends BaseHandler_default {
    ...
    validateErrorMessage$(error) {
      ...
      if (!V16.isString(error.message)) throw error;
    }
  ...
  var _LogMatchFinishedHandler = class _LogMatchFinishedHandler extends BaseHandler_default {
    ...
    validateMode$(mode) {
      if (!V17.isString(mode)) {
        throw new MatchModeNotDefined_default();
      }
    }
    validateLevel$(level2) {
      if (!V17.isNumber(level2)) {
        throw new LevelNotDefined_default();
      }
    }
    getLevelName$(level2) {
  ...
  var { Valid: V19, Object: O15 } = Utils4;
...
i n\xE0o!`
  ...
  var _PostScoreTournamentHandler = class _PostScoreTournamentHandler extends BaseHandler_default {
    ...
    async postScoreTournamentAsync$(matchState) {
      ...
      try {
        ...
        if (V26.isObject(error) && "code" in error && error.code === "USER_INPUT") {
          const { event } = codex;
  ...
  init_google_analytics();
  init_youtube();
  var { Valid: V27, Object: O21 } = Ludex.Utils;
  var _JoinTournamentHandler = class _JoinTournamentHandler extends BaseHandler_default {
    ...
    validateLeaderboardId$(leaderboardId) {
      if (!V27.isString(leaderboardId) || leaderboardId === "") {
        throw new LeaderboardIdNotValid_default();
      }
    }
  ...
  var _MatchProfileDtos = class _MatchProfileDtos extends BaseDtos_default {
    ...
    validateId(id) {
      if (!V29.isString(id) || !id) {
        this.exception$("id", MESSAGE_INVALID6);
      }
    }
    validateName(name2) {
      if (!V29.isString(name2) || !name2) {
        this.exception$("name", MESSAGE_INVALID6);
      }
    }
    validatePhoto(photo2) {
      if (!V29.isString(photo2)) {
  ...
  // extensions/ludex/src/plugins/player/PlayerPlugin.ts
  var {
    Utils: { Array: A7, Object: O25, Valid: V30, Function: F4 },
  ...
  var { Array: A8, Valid: V34, Object: O28, Function: F5 } = Utils8;
  ...
  var _GoogleAnalytics = class _GoogleAnalytics extends BaseAnalytics2 {
    ...
    addLevelName$(payload) {
      ...
      const matchState = match.getMatchState();
      const matchLevel = matchState.customData.level;
      const playerLevel = player.getGameData()?.level;
      const level2 = matchState.id != null ? matchLevel : playerLevel;
  ...
  var {
    ...
    Plugins: Plugins2,
    Utils: { Device: D2, Object: O31, Json: J5, String: S9, Valid: V36, Time: T2, Function: F6, Mark: Mark2 }
  } = Ludex;
  var _MagicCodex = class _MagicCodex extends codex_default {
    ...
    addPlugins$() {
      ...
      this.installPlugin$("Visibility", empty_script_default);
