  ...
  "extensions/ludex/src/game-sdk/adapters/msgames/MSExtra.ts"() {
    ...
    _MSExtra = class _MSExtra extends Extra_default {
      ...
      handleMusicSettingsChanged$ = /* @__PURE__ */ __name((payload) => {
        ...
        const { Valid: V36 } = Ludex.Utils;
        const { value } = payload;
        if (!V36.isBoolean(value)) return;
        console.log("handleMusicSettingsChanged$", name2, value);
      ...
      handlePlayerInfoLoaded$ = /* @__PURE__ */ __name(() => {
        ...
        if (!V36.isBoolean(isMusicEnabled)) return;
  ...
  "extensions/ludex/src/game-sdk/adapters/msgames/MSPlayer.ts"() {
    ...
    _MSPlayer = class _MSPlayer extends Player_default {
      ...
      async getDataAsync(keys) {
        ...
        const gameId = this.extra$.getDevPlaygroundAppId();
        const data = await this.requestCloudSaveDataAsync$(gameId ?? void 0);
        const requiredData = {};
        for (const key of keys) {
          if (O32.hasOwn(data, key)) {
      ...
      async setDataAsync(data) {
        const gameId = this.extra$.getDevPlaygroundAppId() ?? void 0;
...
window.CommitId = "62ea11d8-5379a661";
window.BuildVersion = 20;
