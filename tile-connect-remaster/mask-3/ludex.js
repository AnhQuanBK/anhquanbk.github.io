...
var init_define_GAME_CONFIG = __esm({
  "<define:__GAME_CONFIG__>"() {
    define_GAME_CONFIG_default = { AppId: "tile-connect-remaster", AppDescription: "", ApiHost: "htt\
ps://fbig-singleplay-apps.citigo.site", OtherHost: "https://fbig-leaderboards.citigo.site", Ads: { Enabled: true,
    PreloadAds: true, NotifyPlayerBeforeShow: false, ShowAdOnLoad: { Enabled: false, DelaySeconds: 0,
    PlacementId: "ad_demo_01" }, DegradationTracking: { ResetTimeMinutes: 5, MaxFailedAttempts: 8 },
...
ndroid" }, { AdService: "platform", PlacementId: "banner_03", Position: "bottom", BannerHeight: 50, SecondsReload: 60,
    ...
    Yandex: { LoginOnStart: false, MaxLoginAttemptsPerDay: 1 }, Playable: { AppleAppStoreUrl: "", GooglePlayStoreUrl: "" },
    TranssionH5: { GaId: "G-XXXXXXXXXX" } }, Core: { InitAsync: true, AverageLoadTime: 5, StartSDKAfterLoadGame: true,
    ...
    Enabled: true, AtlasDebug: true, AutoAtlasSize: true, UsePowerOfTwo: false, TextureBleeding: true,
    ...
    mozjpeg: true }, WEBP: { quality: 80, lossless: false, alphaQuality: 60, smartSubsample: true, preset: "\
drawing" } }, IgnoreFiles: [] }, HybridFileCache: { Enabled: true, BuildMode: { Enabled: true, InvalidateMode: "\
both", SupportedExtensions: [".json"] }, PreviewMode: { Enabled: false, CacheScene: false, CachePrefab: false,
    CacheUuidExtension: false, InvalidateMode: "commitId", SupportedExtensions: [".json", ".cconb"] } } },
    Gameplay: { StartAdAtLevel: 1, MaxRescueCount: 1, Tutorial: { Enabled: true, ForceUseTutorial: false } },
    ...
    GameSDKFlows: false, LoadResources: false, FpsTracking: { Enabled: false, TrackingDuration: 60, TrackingInterval: 10 } },
    ...
    MaxDays: 7, MockTime: 0, CheckInterrupt: false }, Mockup: { Ads: { Enabled: true, ErrorRate: 5, GiphyApiKey: "\
VmjHIRsfrwCAssDS4mDo9DoImxJm1lLM", SafeAreaBottom: 0 }, Match: { Enabled: false, ErrorRate: 5, PlayerInfo: {
    Id: "player-mock", Name: "Player Mock", Photo: "", Signature: "" }, OpponentInfo: { Id: "opponen\
t-mock", Name: "Opponent Mock", Photo: "", Signature: "" } }, GameSDK: { SlowAPI: { Enabled: false, ErrorRate: 5,
    StartDelay: 1e3, InitialDelay: 1e3, PlayerDataDelay: 1e3 }, Context: { Enabled: false }, Player: {
    SubscribeBot: { Enabled: false, CanSubscribeBot: true }, ConnectedPlayers: { Enabled: false, ErrorRate: 5,
    RandomDelayMs: 1e3, NumOfPlayers: 3 } }, AddShortcut: { Enabled: false, CanCreateShortcut: true },
...
var isTemplateExist, prompts, addTemplate, addLoadingTemplate, addBannerMockupTemplate, addAdsMockupTemplate;
var init_TemplateManager = __esm({
  "extensions/ludex/src/game-sdk/elements/TemplateManager.ts"() {
    ...
    addBannerMockupTemplate = /* @__PURE__ */ __name(async () => {
      return addTemplate({
        template: banner_mockup_default,
        selector: "#banner-mockup"
      });
    }, "addBannerMockupTemplate");
    addAdsMockupTemplate = /* @__PURE__ */ __name(async () => {
      return addTemplate({
...
var loadErrorCodes, _MockBannerInstance, MockBannerInstance, MockBannerInstance_default;
...
bundle=low_bandwidth`;
      ...
      setupBannerSizeAndPosition$ = /* @__PURE__ */ __name(() => {
...
var showMockPopupAd, loadErrorCodes2, showErrorCodes, _MockAdInstance, MockAdInstance, MockAdInstance_default;
...
bundle=low_bandwidth`;
      ...
      async loadAsync() {
        const isError = Math.random() * 100 <= this.errorRate$;
        const { Image: I2, Time: T3 } = Ludex.Utils;
        if (!isError) {
          this.adContent$ = await this.getAdContentAsync$();
          if (!this.adContent$) {
      ...
      async getAdContentAsync$() {
        ...
        if (!V36.isObject(json)) return null;
...
window.CommitId = "d9f5a1bd-3d306d5a";
