...
// extensions/ludex/src/plugins/ads/instances/AdInstance.ts
var _AdInstance = class _AdInstance extends BaseInstance_default {
  loadAsync() {
...
init_init();
init_google_analytics();
var _BannerInstance = class _BannerInstance extends AdInstance_default {
  async loadAsync() {
    this.exception$("This method is not implemented");
  }
  async showAsync() {
...
var _NormalAdInstance = class _NormalAdInstance extends AdInstance2 {
  service$;
  instance$;
  instanceQueue$ = [];
  constructor(type, placementId) {
