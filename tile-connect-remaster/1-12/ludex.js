...
var init_MSExtra = __esm({
  "extensions/ludex/src/game-sdk/adapters/msgames/MSExtra.ts"() {
    ...
    _MSExtra = class _MSExtra extends Extra_default {
      ...
      listenEvent$() {
        const { event } = codex;
        const { PLAYER_SETTINGS_CHANGED: PLAYER_SETTINGS_CHANGED2 } = Ludex.Events;
        event.on(PLAYER_SETTINGS_CHANGED2, (payload) => this.handlePlatformAudioSync$(payload));
      }
