...
both", SupportedExtensions: [".json"] }, PreviewMode: { Enabled: false, CacheScene: false, CachePrefab: false,
    CacheUuidExtension: false, InvalidateMode: "commitId", SupportedExtensions: [".json"] } } }, Gameplay: {
    StartAdAtLevel: 1, MaxRescueCount: 1, Tutorial: { Enabled: true, ForceUseTutorial: false } }, Firebase: {
    Enabled: false, Options: { AppId: "", ApiKey: "", ProjectId: "", AuthDomain: "", StorageBucket: "",
...
var init_MSAdapter = __esm({
  "extensions/ludex/src/game-sdk/adapters/msgames/MSAdapter.ts"() {
    ...
    _MSAdapter = class _MSAdapter extends GameSDK_default2 {
      ...
      /**
       * @deprecated MSN stopped supporting display ads since 10/2025
       */
