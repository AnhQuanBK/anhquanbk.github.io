...
tps://fbig-singleplay-apps-dev.sunstudio.io", OtherHost: "https://leaderboards-dev.sunstudio.io", Ads: {
    Enabled: true, PreloadAds: true, NotifyPlayerBeforeShow: false, ShowAdOnLoad: { Enabled: false, DelaySeconds: 0,
...
ewarded_video_adsense", SecondsFirstTime: 0, SecondsBetweenAds: 0 }], RewardedInterstitialAdOptions: [
    ...
    BannerHeight: 50, SecondsReload: 60, Platform: "ALL" }] }, Languages: { DetectPlayerLocale: false },
    GameSDKOptions: { AllowWithoutSDK: true, UseNameGenerator: false, MSGames: { LoginOnStart: false,
    MaxLoginAttemptsPerDay: 1 }, Yandex: { LoginOnStart: false, MaxLoginAttemptsPerDay: 1 }, TranssionH5: {
    GaId: "G-XXXXXXXXXX" } }, Core: { InitAsync: false, AverageLoadTime: 5, StartSDKAfterLoadGame: false,
    FastCheckTournamentContext: true }, GameEngine: { ForceDesktopDPR: false, AutoResizeCanvas: true,
    PreferredFPS: { Mobile: 60, Desktop: 120 }, DynamicAtlas: { IOS: { Enabled: false, AutoAtlasSize: false,
    MaxAtlasCount: 2, MaxAtlasSize: 4096, MaxFrameSize: 2048 }, Android: { Enabled: false, AutoAtlasSize: false,
    MaxAtlasCount: 2, MaxAtlasSize: 4096, MaxFrameSize: 2048 }, Desktop: { Enabled: true, AutoAtlasSize: false,
    MaxAtlasCount: 2, MaxAtlasSize: 4096, MaxFrameSize: 2048 }, UsePowerOfTwo: false, TextureBleeding: true,
    AllowNonePackable: false, TextureAtlasOptimize: true, OnlyOptimizeWhenRenderTooLong: true }, DynamicAssets: {
    Enabled: false, Debug: false, Resolution: { Adjust: 1, Original: 2 }, Compression: { PNG: { colors: 256,
    quality: 50, dither: 0.6, palette: true, compressionLevel: 8 }, JPEG: { quality: 50, mozjpeg: true },
    WEBP: { quality: 35, lossless: false, alphaQuality: 40, smartSubsample: true, preset: "drawing" } },
    IgnoreFiles: [] }, HybridFileCache: { Enabled: true, BuildMode: { Enabled: false, InvalidateMode: "\
version", SupportedExtensions: [".json", ".cconb"] }, PreviewMode: { Enabled: true, CacheScene: false,
    CachePrefab: false, CacheUuidExtension: true, InvalidateMode: "commitId", SupportedExtensions: [
    ".json", ".cconb"] } } }, Gameplay: { StartAdAtLevel: 1, MaxRescueCount: 1, Tutorial: { Enabled: true,
    ForceUseTutorial: false } }, Firebase: { Enabled: false, Options: { AppId: "", ApiKey: "", ProjectId: "",
    AuthDomain: "", StorageBucket: "", MeasurementId: "", MessagingSenderId: "" }, Services: { Analytics: {
    Enabled: false }, Performance: { Enabled: false }, RemoteConfig: { Enabled: false } } }, Analytics: {
    GoogleAnalytics: { Enabled: true, ConsoleLog: true }, ClarityAnalytics: { Enabled: false, ConsoleLog: false,
    ScreenshotCanvas: { Interval: 1500, ByEvent: ["APP_READY", "PAGE_VIEW", "BUTTON_CLICK", "AD_SHOW\
ING", "LEVEL_START", "LEVEL_END"] } }, FirebaseAnalytics: { Enabled: false, ConsoleLog: false }, FacebookAnalytics: {
    Prefix: "fba", Enabled: false, ConsoleLog: false } }, PerformanceMonitor: { CoreFlows: true, EngineFlows: true,
    FpsTracking: { Enabled: true, TrackingDuration: 60, TrackingInterval: 10 }, LoadResources: true },
    ...
    MaximumRequest: 6, Timeout: 15e3, Retries: 3 }, Leaderboards: { LeaderboardList: [] }, Notification: {
    Enabled: false, ApiUrl: "https://notifications.sunstudio.io" }, DailyRewards: { MaxDays: 7, MockTime: 15e3,
    CheckInterrupt: false }, Mockup: { Ads: { Enabled: true, ErrorRate: 5, GiphyApiKey: "VmjHIRsfrwC\
AssDS4mDo9DoImxJm1lLM", SafeAreaBottom: 0 }, Match: { Enabled: false, ErrorRate: 5, PlayerInfo: { Id: "\
player-mock", Name: "Player Mock", Photo: "", Signature: "" }, OpponentInfo: { Id: "opponent-mock", Name: "\
Opponent Mock", Photo: "", Signature: "" } }, GameSDK: { SlowAPI: { Enabled: false, ErrorRate: 5, StartDelay: 1e3,
    InitialDelay: 1e3, PlayerDataDelay: 1e3 }, Context: { Enabled: true }, Player: { SubscribeBot: {
    Enabled: false, CanSubscribeBot: true }, ConnectedPlayers: { Enabled: true, ErrorRate: 5, RandomDelayMs: 1e3,
    NumOfPlayers: 3 } }, AddShortcut: { Enabled: false }, Tournament: { Enabled: true, ErrorRates: 5,
    RandomDelayMs: 1e3, NumOfTournament: { Normal: 10, HostPage: 2 } }, Payments: { Enabled: false, ErrorRates: 5,
    RandomDelayMs: 1e3, Products: [] } }, Profile: { Enabled: true, ErrorRate: 5, RandomDelayMs: 1e3,
    AvatarUrl: "https://picsum.photos/seed/%1/300/300", RandomNameApiKey: "a1f7164dc9d2468b953aef67b\
0a19355" }, Leaderboards: { Enabled: true, MinScore: 10, MaxScore: 100, ErrorRate: 5, NumOfLeaders: {
    Min: 10, Max: 50 }, DefaultLimit: 60, RandomDelayMs: 1e3 }, LoadingScreen: { Enabled: false } },
    Debugger: { Console: { Enabled: false }, Profiler: { Enabled: false }, EventLogging: { Enabled: true },
...
var init_define_GAME_SDK_CONFIG = __esm({
  "<define:__GAME_SDK_CONFIG__>"() {
    define_GAME_SDK_CONFIG_default = { AllowWithoutSDK: true, UseNameGenerator: false };
  }
});
...
var SwitchAsyncPopup_exports = {};
__export(SwitchAsyncPopup_exports, {
  default: () => SwitchAsyncPopup_default
});
  ...
  "extensions/ludex/src/game-sdk/sdk/Context.ts"() {
    ...
    Context = class {
      ...
      async loadSwitchAsyncPopup$() {
        ...
        const SwitchAsyncPopup2 = (await Promise.resolve().then(() => (init_SwitchAsyncPopup(), SwitchAsyncPopup_exports))).
        default;
        if (typeof SwitchAsyncPopup2 !== "function") return;
        this.switchAsyncPopup$ = new SwitchAsyncPopup2();
        await this.switchAsyncPopup$.setupTemplate();
      }
      async loadChooseAsyncPopup$() {
        if (this.chooseAsyncPopup$) return;
        const ChooseAsyncPopup2 = (await Promise.resolve().then(() => (init_ChooseAsyncPopup(), ChooseAsyncPopup_exports))).
        default;
        if (typeof ChooseAsyncPopup2 !== "function") return;
      ...
      async loadCreateAsyncPopup$() {
        ...
        const CreateAsyncPopup2 = (await Promise.resolve().then(() => (init_CreateAsyncPopup(), CreateAsyncPopup_exports))).
        default;
        if (typeof CreateAsyncPopup2 !== "function") return;
  ...
  "extensions/ludex/src/game-sdk/sdk/Extra.ts"() {
    ...
    Extra = class {
      ...
      async delayInitialAsync() {
        ...
        await T5.sleepAsync(SlowAPI.InitialDelay);
      }
      async delayStartAsync() {
        ...
        await T5.sleepAsync(SlowAPI.StartDelay);
      }
      async delayPlayerDataAsync() {
        ...
        await T5.sleepAsync(SlowAPI.PlayerDataDelay);
      }
      awaitRandomDelay(randomDelayMs = 1e3) {
        const {
          Utils: { Time: T5 }
        } = Ludex;
        return T5.sleepAsync(Math.random() * randomDelayMs);
      }
      ...
      getErrorMessage(error) {
        const { Valid: V39, Object: O33 } = Ludex.Utils;
        if (!O33.hasOwn(error, "message") || !V39.isString(error.message)) return null;
...
n"];
    ...
    Payments = class {
      ...
      async awaitRandomDelay$() {
        const {
          Configs: {
            Mockup: {
              GameSDK: {
                Payments: { RandomDelayMs: RandomDelayMs3 }
              }
            }
          }
        } = Ludex;
        return this.extra.awaitRandomDelay(RandomDelayMs3);
      }
      randomError(errors) {
        const {
          Configs: {
      ...
      getProductsData$() {
        const {
          Utils: { Browser: B7, Valid: V39 }
        } = Ludex;
        const data = B7.getLocalStorage(PRODUCTS_DATA_MOCK_KEY);
        if (!V39.isObject(data)) return {};
        return data;
      }
      ...
      writeProductsData$(products) {
        ...
        if (!V39.isObject(products)) return;
        B7.writeLocalStorage(PRODUCTS_DATA_MOCK_KEY, products);
      }
      getPurchasesData$() {
        const {
          Utils: { Browser: B7, Valid: V39 }
        } = Ludex;
        const data = B7.getLocalStorage(PURCHASES_DATA_MOCK_KEY);
        if (!V39.isObject(data)) return {};
        return data;
      }
      writePurchasesData$(playerId2, purchases) {
        ...
        B7.writeLocalStorage(PURCHASES_DATA_MOCK_KEY, data);
      }
      handleOnYes$ = (resolve) => () => {
        this.extra.isPopupShown = false;
        resolve(true);
...
// extensions/ludex/src/game-sdk/common/MockConnectedPlayers.ts
var MockConnectedPlayers_exports = {};
__export(MockConnectedPlayers_exports, {
  default: () => MockConnectedPlayers_default
});
var LOCAL_STORE_KEY, MockConnectedPlayers, MockConnectedPlayers_default;
var init_MockConnectedPlayers = __esm({
  "extensions/ludex/src/game-sdk/common/MockConnectedPlayers.ts"() {
    "use strict";
    init_define_GAME_CONFIG();
    init_define_GAME_SDK_CONFIG();
    ...
    init_google_analytics();
    init_GameSDK2();
    LOCAL_STORE_KEY = "MockConnectedPlayers";
    MockConnectedPlayers = class {
      extra;
      constructor(extra) {
        this.extra = extra;
      }
      async getConnectedPlayersAsync() {
        ...
        const { ErrorRate: ErrorRate3, NumOfPlayers, RandomDelayMs: RandomDelayMs3 } = Mockup3.GameSDK.
        Player.ConnectedPlayers;
        if (this.randomExceptionError("getConnectedPlayersAsync", ErrorRate3)) {
          this.extra.exceptionNetworkFailure("Get connected players error");
        }
        await this.extra.awaitRandomDelay(RandomDelayMs3);
        return this.createPlayers(NumOfPlayers);
      }
      createPlayers(amount) {
        const {
          Profile: { AvatarUrl: AvatarUrl2 },
          Match: { PlayerInfo, OpponentInfo }
        } = Ludex.Configs.Mockup;
        let connectedPlayers = this.loadLocalStorage();
        if (!connectedPlayers) {
          connectedPlayers = [];
        }
        const currentId = GameSDK.player.getID();
        const playerId2 = PlayerInfo?.Id;
        const opponentId = OpponentInfo?.Id;
        const isPlayerExist = connectedPlayers.some((player) => player.getID() === playerId2);
        const isOpponentExist = connectedPlayers.some((player) => player.getID() === opponentId);
        if (isPlayerExist) {
          connectedPlayers = connectedPlayers.filter((player) => player.getID() !== playerId2);
        }
        if (isOpponentExist) {
          connectedPlayers = connectedPlayers.filter((player) => player.getID() !== opponentId);
        }
        if (opponentId !== currentId) {
          connectedPlayers.push({
            getID: () => opponentId,
            getName: () => OpponentInfo?.Name ?? "",
            getPhoto: () => AvatarUrl2.replace("%1", opponentId ?? "")
          });
        }
        if (playerId2 !== currentId) {
          connectedPlayers.push({
            getID: () => playerId2,
            getName: () => PlayerInfo?.Name ?? "",
            getPhoto: () => AvatarUrl2.replace("%1", playerId2 ?? "")
          });
        }
        if (connectedPlayers.length !== amount) {
          for (let i = connectedPlayers.length; i < amount; i++) {
            const playerId3 = `connected-player-${i}`;
            const player = {
              getID: () => playerId3,
              getName: () => `Connected Player ${i}`,
              getPhoto: () => AvatarUrl2.replace("%1", playerId3)
            };
            connectedPlayers.push(player);
          }
        }
        this.saveLocalStorage(connectedPlayers);
        return this.loadLocalStorage();
      }
      loadLocalStorage() {
        const { Browser: B7, Object: O33 } = Ludex.Utils;
        const data = B7.getLocalStorage(LOCAL_STORE_KEY);
        if (!data) return [];
        const connectedPlayers = O33.vals(data);
      ...
      saveLocalStorage(profiles) {
        const { Browser: B7 } = Ludex.Utils;
        ...
        for (const p of profiles) {
          ...
          connectedPlayers.push(data2);
        }
        const data = __spreadValues({}, connectedPlayers);
        B7.writeLocalStorage(LOCAL_STORE_KEY, data);
      }
      randomExceptionError(message, errorRate) {
    ...
    MockConnectedPlayers_default = MockConnectedPlayers;
  }
});
  ...
  "extensions/ludex/src/game-sdk/sdk/Player.ts"() {
    ...
    Player = class {
      ...
      initPlayerInfo(playerId2) {
        ...
        B7.writeLocalStorage(this.infoKey, this.currentPlayerInfo);
      }
      ...
      async getDataAsync(keys) {
        ...
        const {
          Utils: { Browser: B7, Valid: V39, Object: O33 }
        } = Ludex;
        const data = B7.getLocalStorage(this.dataKey);
        if (!V39.isObject(data)) return {};
        const dataObject = {};
        for (const key of keys) {
          if (O33.hasOwn(data, key)) {
      ...
      async setDataAsync(data) {
        ...
        B7.writeLocalStorage(this.dataKey, data);
      }
      ...
      updateCurrentPlayerInfo(playerId2) {
        const {
          Utils: { Browser: B7, Valid: V39, Object: O33, String: S10 }
        } = Ludex;
        let currentId = playerId2 ?? "";
        let currentName = "Nameless";
        if (this.extra.isGuest) {
          const data = B7.getLocalStorage(this.infoKey);
          if (V39.isObject(data) && O33.hasOwn(data, "playerId") && V39.isString(data.playerId)) {
            currentId = data.playerId;
          }
          if (V39.isObject(data) && O33.hasOwn(data, "playerName") && V39.isString(data.playerName)) {
            currentName = data.playerName;
          }
        }
        if (V39.isEmpty(currentId)) {
      ...
      async loadMockConnectedPlayers$() {
        ...
        const MockConnectedPlayers2 = (await Promise.resolve().then(() => (init_MockConnectedPlayers(), MockConnectedPlayers_exports))).
        default;
        if (typeof MockConnectedPlayers2 !== "function") return;
        this.connectedPlayers$ = new MockConnectedPlayers2(this.extra);
      }
    };
...
var CreateTournamentAsyncPopup_exports = {};
__export(CreateTournamentAsyncPopup_exports, {
  default: () => CreateTournamentAsyncPopup_default
});
...
var ShareTournamentAsyncPopup_exports = {};
__export(ShareTournamentAsyncPopup_exports, {
  default: () => ShareTournamentAsyncPopup_default
});
...
on"];
    ...
    Tournament = class {
      ...
      async createMockTournamentsData() {
        ...
        const allTournaments = O33.vals(tournamentsData);
      ...
      createDefaultTournaments$(length) {
        const {
          Utils: { String: S10, Array: A10, Number: N2 },
          Configs: {
            Mockup: {
              GameSDK: {
      ...
      async awaitRandomDelay$() {
        const {
          Configs: {
            Mockup: {
              GameSDK: {
                Tournament: { RandomDelayMs: RandomDelayMs3 }
              }
            }
          }
        } = Ludex;
      ...
      async loadCreateTournamentPopupAsync$() {
        if (this.createAsyncPopup$) return;
        const CreateAsyncPopup2 = (await Promise.resolve().then(() => (init_CreateTournamentAsyncPopup(), CreateTournamentAsyncPopup_exports))).
        default;
        if (typeof CreateAsyncPopup2 !== "function") return;
        this.createAsyncPopup$ = new CreateAsyncPopup2();
        await this.createAsyncPopup$.setupTemplate();
      ...
      async loadSharePopupAsync$() {
        ...
        const ShareAsyncPopup = (await Promise.resolve().then(() => (init_ShareTournamentAsyncPopup(), ShareTournamentAsyncPopup_exports))).
        default;
      ...
      async getTournamentsAsync() {
        ...
        const tournaments = O33.vals(tournamentsData);
      ...
      getTournamentsData$() {
        ...
        const data = B7.getLocalStorage(TOURNAMENTS_DATA_MOCK_KEY);
        if (!V39.isObject(data)) return {};
        return data;
      }
      writeTournamentsData$(tournaments) {
        ...
        if (!V39.isObject(tournaments)) return;
        B7.writeLocalStorage(TOURNAMENTS_DATA_MOCK_KEY, tournaments);
      }
      ...
      getTournamentLeadersData$(tournamentId) {
        const {
          Utils: { Browser: B7, Object: O33 }
        } = Ludex;
        const data = B7.getLocalStorage(TOURNAMENT_LEADERS_MOCK_KEY);
      ...
      writeTournamentLeadersData$(tournamentId, tournamentLeaders) {
        ...
        if (!Array.isArray(tournamentLeaders)) return;
        const data = B7.getLocalStorage(TOURNAMENT_LEADERS_MOCK_KEY) ?? {};
        O33.assign(data, { [tournamentId]: tournamentLeaders });
        B7.writeLocalStorage(TOURNAMENT_LEADERS_MOCK_KEY, data);
      }
    };
...
bundle=low_bandwidth`;
      ...
      async loadAsync() {
        ...
        const {
          Utils: { Image: I2, Time: T5 }
        } = Ludex;
        if (!isError) {
          this.adContent$ = await this.getAdContentAsync$();
          await I2.loadImage(this.adContent$);
        } else {
          await T5.sleepAsync(1e3);
      ...
      async showAsync() {
        ...
        console.debug("showAsync", imgTag, this.mockAdElement$);
      ...
      setupBannerSizeAndPosition$ = () => {
        ...
        const correctHeight = isBottom ? GameSDK.getBannerHeight(bannerAdOption) : BannerHeight;
        this.mockAdElement$.style.width = BannerWidth ? `${BannerWidth}px` : "100%";
        this.mockAdElement$.style.height = correctHeight ? `${correctHeight}px` : "50vh";
      ...
      getBannerAdOption$() {
        ...
        return A10.search(BannerDisplayAdOptions, (option) => option.PlacementId === this.placementId);
      }
    };
...
var showMockPopupAd, loadErrorCodes2, showErrorCodes, MockAdInstance, MockAdInstance_default;
...
bundle=low_bandwidth`;
      ...
      async loadAsync() {
        const isError = Math.random() * 100 <= this.errorRate;
        const { Image: I2, Time: T5 } = Ludex.Utils;
        if (!isError) {
          this.adContent$ = await this.getAdContentAsync$();
          if (!this.adContent$) {
      ...
      async getAdContentAsync$() {
        ...
        const { Valid: V39 } = Ludex.Utils;
        if (!V39.isObject(json)) return null;
...
var init_GameSDK = __esm({
  "extensions/ludex/src/game-sdk/sdk/GameSDK.ts"() {
    ...
    GameSDK2 = class {
      ...
      getPlatform() {
        const { Device: D3 } = Ludex.Utils;
        if (D3.isAndroid()) return "ANDROID";
        if (D3.isIOS()) return "IOS";
        if (D3.isDesktop()) return "WEB";
        if (D3.isMobile()) return "MOBILE_WEB";
        return null;
      }
      getSDKName() {
        return "Ludex";
      ...
      getEntryPointData() {
        const {
          Utils: { Browser: B7, Json: J7 }
        } = Ludex;
        const { payload = "{}" } = B7.getQueryParams();
      ...
      async loadBannerAdAsync(placementId) {
        ...
        if (!this.bannerAdInstances[placementId]) {
          const MockBannerInstance2 = (await Promise.resolve().then(() => (init_MockBannerInstance(), MockBannerInstance_exports))).
          default;
          if (typeof MockBannerInstance2 !== "function") {
      ...
      async getInterstitialAdAsync(placementId) {
        if (!this.interstitialAdInstance) {
          const MockAdInstance2 = (await Promise.resolve().then(() => (init_MockAdInstance(), MockAdInstance_exports))).
          default;
          if (typeof MockAdInstance2 !== "function") {
      ...
      async getRewardedInterstitialAsync(placementId) {
        if (!this.rewardedInterstitialInstance) {
          ...
          this.rewardedInterstitialInstance = new MockAdInstance2("rewarded_interstitial", placementId);
        }
      ...
      async getTournamentAsync() {
        ...
        const { Array: A10, Valid: V39 } = Ludex.Utils;
        if (!V39.isString(currentContextID)) {
...
var MinScore, MaxScore, NumOfLeaders, ErrorRate, DefaultLimit, RandomDelayMs, V11, B4, T2, O9, N, LeadersMockKey,
...
var init_LeaderboardAPIMock = __esm({
  "extensions/ludex/src/plugins/leaderboards/api/LeaderboardAPIMock.ts"() {
    ...
    ({
      ...
      Utils: { Valid: V11, Browser: B4, Time: T2, Object: O9, Number: N }
    } = Ludex);
    ...
    LeaderboardAPIMock = class {
      ...
      async getLeaders(leaderboardId, payload) {
        ...
        const leadersData = this.getLeadersData(leaderboardId);
        const leadersSort = O9.vals(leadersData);
      ...
      async getLeaderboardsAsync(options) {
        ...
        const leaderBoardsSort = O9.vals(leaderBoards);
        if (type === void 0) {
      ...
      async setScoreAsync(id, playerId2, score2) {
        ...
        const leaders = O9.vals(players[id]);
        this.sortLeadersRank(leaders);
      ...
      getLeaderBoardsData() {
        const data = B4.getLocalStorage(LeaderboardsMockKey);
        if (!V11.isObject(data)) return {};
        return data;
      }
      writeLeaderBoardsData(data) {
        if (!V11.isObject(data)) return;
        B4.writeLocalStorage(LeaderboardsMockKey, data);
      }
      getLeaderBoard(id) {
        const leaderBoards = this.getLeaderBoardsData();
      ...
      getPlayersData() {
        const data = B4.getLocalStorage(LeadersMockKey);
        if (!V11.isObject(data)) return {};
        return data;
      }
      writePlayersData(id, data) {
        ...
        O9.assign(players[id], data[id]);
        B4.writeLocalStorage(LeadersMockKey, players);
      }
...
var ProfileAPIMock_exports = {};
__export(ProfileAPIMock_exports, {
  default: () => ProfileAPIMock_default
});
var AvatarUrl, ErrorRate2, RandomDelayMs2, S7, V35, B5, T3, ProfilesMockKey, namesMock, ProfileAPIMock,
ProfileAPIMock_default;
var init_ProfileAPIMock = __esm({
  "extensions/ludex/src/plugins/profile/api/ProfileAPIMock.ts"() {
    "use strict";
    init_define_GAME_CONFIG();
    init_define_GAME_SDK_CONFIG();
    ...
    ({
      Configs: {
        Mockup: {
          Profile: { AvatarUrl, ErrorRate: ErrorRate2, RandomDelayMs: RandomDelayMs2 }
        }
      },
      Utils: { String: S7, Valid: V35, Browser: B5, Time: T3 }
    } = Ludex);
    ProfilesMockKey = "ProfilesMockKey";
    namesMock = ["player", "ng\u01B0\u1EDDi ch\u01A1i", "\u73A9\u5BB6", "\u0438\u0433\u0440\u043E\u043A",
    "\u30D7\u30EC\u30FC\u30E4\u30FC", "\uD50C\uB808\uC774\uC5B4", "\u03C0\u03B1\u03AF\u03C7\u03C4\u03B7\u03C2",
    "\u0E9C\u0EB9\u0EC9\u200B\u0EAB\u0EBC\u0EB4\u0EC9\u0E99", "\u1000\u1005\u102C\u1038\u101E\u1019\u102C\u1038"];
    ProfileAPIMock = class {
      async getPlayersAsync(payload) {
        ...
        const { playerIds } = payload;
        for (const playerId2 of playerIds) {
          let profile = profilesData[playerId2];
          if (!profile) {
            profile = this.createProfile(playerId2);
          }
          profiles.push(profile);
        }
        return { data: profiles };
      }
      createProfile(playerId2) {
        const _id = S7.generateObjectId();
        let name2 = this.randomName(_id);
        let photo2 = this.randomPhoto(_id);
        let score2 = this.randomScore();
        let level2 = this.randomLevel();
        const { player } = codex;
        if (playerId2 === player.getPlayerId()) {
          const data = player.getPlayer();
          name2 = data.name;
          photo2 = data.photo;
          score2 = data.data.score;
          level2 = data.data.gameData.level;
        }
        const profile = { _id, playerId: playerId2, name: name2, photo: photo2, score: score2, level: level2 };
        this.writeProfilesData({ [playerId2]: profile });
        return profile;
      }
      randomName(id) {
      ...
      getProfilesData() {
        const data = B5.getLocalStorage(ProfilesMockKey);
      ...
      writeProfilesData(profiles) {
        ...
        B5.writeLocalStorage(ProfilesMockKey, data);
      }
      randomResponseError(message) {
        const isError = Math.random() * 100 < ErrorRate2;
        if (!isError) return false;
        console.warn("[ProfileAPIMock]", message);
        return true;
      }
      async awaitRandomDelay() {
        await T3.sleepAsync(Math.random() * RandomDelayMs2);
      }
    };
    ProfileAPIMock_default = ProfileAPIMock;
  }
});
...
// extensions/ludex/src/plugins/ads/instances/AdInstance.ts
var AdInstance2 = class extends BaseInstance_default {
  loadAsync() {
...
var BaseChannelManager = class {
  ...
  callAudioPlayers(funcName) {
    const { Object: O33 } = Ludex.Utils;
    const audioClips = O33.vals(this.audioClips);
...
var {
  ...
  Utils: { Browser: B2, Image: I, Object: O7, Valid: V10 }
} = Ludex;
var FrameCapturePlugin = class extends Ludex.Plugins.BasePlugin {
  ...
  setTestRenderOptions(payload) {
    ...
    const options = O7.camelCaseKeys(payload);
    this.testRenderOptions = O7.merge(this.testRenderOptions, options);
  }
  createCanvas() {
    if (!this.canvas) {
  ...
  getRenderImages(renderOptions) {
    const imageOptions = O7.vals(renderOptions).filter((option) => option.type === "image");
  ...
  drawObjects(payload) {
    const options = O7.vals(payload).sort((a, b) => a.depth - b.depth);
...
// extensions/ludex/src/plugins/language/LanguagePlugin.ts
var {
  Utils: { Object: O8, Function: F3, Browser: B3 },
  Configs: {
...
var LanguagePlugin = class extends Ludex.Plugins.BasePlugin {
  ...
  getLocaleData(locale2) {
    ...
    if (!O8.hasOwn(this.data, correctLocale)) {
...
var {
  ...
  Utils: { Object: O10, String: S3, Valid: V12 }
} = Ludex;
var LeaderboardAPI = class {
  ...
  async getLeadersAsync(id, url, payload) {
    ...
    if (!O10.hasOwn(result3, "data") || !Array.isArray(result3.data)) return [];
    return result3.data;
  }
  async getLeaderboardAsync(id) {
    let result3;
    ...
    if (Mockup.Leaderboards.Enabled) {
      ...
      if (O10.hasOwn(result3, "data") && typeof result3.data === "object") {
  ...
  async getLeaderboardsAsync(options) {
    ...
    if (Mockup.Leaderboards.Enabled) {
      ...
      result3 = await get(`${url}?${params}`, {}, OtherHost);
      if (O10.hasOwn(result3, "data") && Array.isArray(result3.data)) {
        result3 = result3.data;
      } else {
        result3 = [];
      }
  ...
  async createLeaderboardAsync(payload) {
    ...
    if (Mockup.Leaderboards.Enabled) {
      ...
      if (O10.hasOwn(result3, "data") && V12.isObject(result3.data)) {
        result3 = result3.data;
      }
    }
    if (!O10.hasOwn(result3, "_id") || result3._id !== id) {
...
// extensions/ludex/src/plugins/leaderboards/LeaderboardPlugin.ts
var {
  Utils: { Array: A5, Valid: V13, Json: J3, Object: O11 }
} = Ludex;
var LeaderboardPlugin = class extends Ludex.Plugins.BasePlugin {
  ...
  isExistLeaderboardId(leaderboardId) {
    const { configs } = this;
    return O11.vals(configs).some((config) => config.id === leaderboardId);
  }
  getLeaderboardName(leaderboardId) {
    const { configs } = this;
    const config = A5.search(O11.vals(configs), (config2) => config2.id === leaderboardId);
  ...
  async receiveLeaderboardAsync(name2, responses) {
    ...
    const rawLeaders = O11.vals(currentLeaders);
    ...
    const keyedLeaders = O11.keyBy(sortedLeaders, "playerId");
...
init_google_analytics();
init_GameSDK2();
var { Object: O12, Valid: V14, Json: J4 } = Ludex.Utils;
...
ata"]);
    ...
    console.table(O12.clone(base));
    console.info("\u{1F4BE} Profile");
    console.table(O12.clone(profiles));
    console.info("\u{1F4BE} Custom");
    console.table(O12.clone(customData));
    console.groupEnd();
  }
  logDiff$() {
    const { After, Before } = this.stateData;
    if (!After || !Before) return;
    const diff = O12.diff(Before, After);
    if (!V14.isEmpty(diff)) {
...
var { String: S4, Valid: V15 } = Utils3;
...
// extensions/ludex/src/plugins/match/handlers/context/CreateContextHandler.ts
var { Valid: V16, Object: O14 } = Ludex.Utils;
var CreateContextHandler = class extends BaseHandler_default {
  ...
  validateError(error) {
    if (!O14.hasOwn(error, "code")) throw error;
  ...
  validateErrorMessage(error) {
    if (!O14.hasOwn(error, "message")) throw error;
...
var { String: S5, Valid: V17 } = Utils5;
...
var { Valid: V19, Object: O17 } = Utils6;
var FinishMatchHandler = class extends BaseHandler_default {
  ...
  validateMatchData(matchState) {
    ...
    const { playerId: playerId2 } = customData;
    if (!playerId2 || !O17.hasOwn(profiles, playerId2)) {
      throw new PlayerNotCurrentInMatch_default();
    }
  }
...
var { Array: A6, Object: O18 } = Utils7;
var GetOpponentChallengeContextHandler = class extends BaseHandler_default {
  ...
  async getContextPlayers(ignorePlayers) {
    try {
      ...
      if (O18.hasOwn(error, "code") && error.code === "NETWORK_FAILURE") {
...
var ResultMatchHandler = class extends BaseHandler_default {
  ...
  updateMatchGeneral(matchState, matchData) {
    const { extraData } = matchData;
    matchState.status = MatchStatus_default.FINISHED;
    matchState.customData = O21.merge(matchState.customData, extraData);
  }
  updatePlayerIds(matchState, matchData) {
    const { whitePlayerId, blackPlayerId } = matchData;
    const { customData } = matchState;
...
var { String: S6, Valid: V23 } = Utils8;
...
init_google_analytics();
init_GameSDK2();
var { Valid: V27, Object: O22 } = Ludex.Utils;
...
var GetMatchCustomDataHandler = class extends BaseHandler_default {
  ...
  updateMatchCustomData(matchState, extraData) {
    const dataMerged = O23.merge(matchState.customData, extraData);
...
var SetMatchCustomDataHandler = class extends BaseHandler_default {
  ...
  updateMatchCustomData(matchState) {
    const customDataMerged = O24.merge(matchState.customData, this.payload);
...
// extensions/ludex/src/plugins/missions/MissionsPlugin.ts
var {
  Utils: { Json: J5, Valid: V30, Object: O25 }
} = Ludex;
var MissionsPlugin = class extends Ludex.Plugins.BasePlugin {
  ...
  addMission(payload) {
    ...
    if (existingTaskIndex !== -1) {
      const newTask = O25.merge(currentTasks[existingTaskIndex], payload);
  ...
  receiveProcessLogs(missions, existingProcessLogs) {
    ...
    for (const mission of missions) {
      ...
      if (O25.hasOwn(existingProcessLogs, id)) {
  ...
  addMissionValue(payload) {
    ...
    if (!V30.isObject(playerMissionProcess)) return;
  ...
  updatePlayerMissionProcess() {
    ...
    const newPlayerData = O25.merge(currentPlayerData, playerMissionProcess);
...
var updatePlayerProfileAsync = async (payload) => {
  ...
  if (!O26.hasOwn(result3, "data")) return {};
  return result3.data || {};
};

// extensions/ludex/src/plugins/player/PlayerPlugin.ts
var {
  Utils: { Array: A7, Object: O27, Valid: V31, Function: F4 },
...
var PlayerPlugin = class extends Ludex.Plugins.BasePlugin {
  ...
  async syncProfileToServer() {
    ...
    if (!V31.isString(ASID) && "getASIDAsync" in GameSDK.player) {
  ...
  setGameData(data) {
    ...
    const newData = O27.merge(currentData, data);
  ...
  async requestConnectedPlayers() {
    ...
    const connectedPlayersKeyed = O27.keyBy(connectedPlayersUnique, "playerId");
...
var PlayerGameDataDtos = class extends BaseDtos_default {
  ...
  validateLevel(level2) {
    if (!V33.isNumber(level2) || level2 < 0) {
      this.exception$("level", "is invalid");
    }
  }
  validateCoins(coins2) {
    if (!V33.isNumber(coins2) || coins2 < 0) {
...
var ProfileAPI = class {
  ...
  async initMockAPI() {
    if (this.mockAPI) return;
    const ProfileAPIMock2 = (await Promise.resolve().then(() => (init_ProfileAPIMock(), ProfileAPIMock_exports))).
    default;
    if (typeof ProfileAPIMock2 !== "function") {
      throw new Error("Cannot load ProfileAPIMock");
    }
    this.mockAPI = new ProfileAPIMock2();
  }
  async getPlayersAsync(payload) {
    const params = S8.params(payload);
    let result3;
    ...
    if (!O28.hasOwn(result3, "data") || !Array.isArray(result3.data)) return [];
    return result3.data;
  }
};
...
var { Array: A8, Valid: V36, Object: O29, Function: F5 } = Utils11;
var ProfilePlugin = class extends Ludex.Plugins.BasePlugin {
  ...
  convertToProfiles(result3) {
    ...
    for (const data of result3) {
      if (!O29.hasOwn(data, "playerId")) continue;
      if (!V36.isString(data.playerId)) continue;
...
var {
  Utils: { Object: O30, Valid: V37, Browser: B6 }
} = Ludex;
var StoragePlugin = class extends Ludex.Plugins.BasePlugin {
  ...
  async initFromWebStorage(name2, initState10) {
    ...
    const data = await B6.getIndexedDB(`${gameName2}_S_${name2}`);
    if (!V37.isObject(data)) return;
    const keys = Object.keys(initState10);
    for (const key of keys) {
      if (!O30.hasOwn(data, key)) continue;
  ...
  setStorageData(storage, field, data) {
    let nextData;
    if (V37.isObject(data)) {
      const currentData = this.getStorageData(storage, field);
      nextData = O30.merge(currentData, data);
    } else {
      nextData = data;
    }
  ...
  async saveToWebStorage(storage) {
    const data = this.getStorage(storage);
    return B6.setIndexedDB(`${gameName2}_S_${storage}`, data);
  }
};
...
init_google_analytics();
init_GameSDK2();
var BannerInstance = class extends AdInstance_default2 {
  async loadAsync() {
    this.exception$("This method is not implemented");
  }
  async showAsync() {
...
var NormalAdInstance = class extends AdInstance3 {
  service;
  instance;
  instanceQueue = [];
  constructor(type, placementId) {
  ...
  async createInstanceByType(type) {
    try {
      ...
      if (!O31.hasOwn(error, "code")) return null;
...
var {
  ...
  Utils: { Device: D, Object: O32, Json: J6, String: S9, Valid: V38, Time: T4, Function: F6, Mark: Mark2 }
} = Ludex;
var MagicCodex = class extends codex_default {
  ...
  handleStorageCurrentRemoteConfig = () => {
    ...
    for (const key in playerRemoteConfig) {
      if (O32.hasOwn(playerRemoteConfig, key)) {
  ...
  initGoogleAnalytics() {
    const { Enabled: Enabled2, ConsoleLog } = Analytics7.GoogleAnalytics ?? {};
    if (!Enabled2) return;
  ...
  initClarityAnalytics() {
    const { Enabled: Enabled2, ConsoleLog } = Analytics7.ClarityAnalytics ?? {};
    if (!Enabled2) return;
  ...
  initFirebaseAnalytics() {
    const { Enabled: Enabled2, ConsoleLog } = Analytics7.FirebaseAnalytics ?? {};
    if (!Enabled2) return;
    if (typeof empty_script_default !== "function" || !(empty_script_default.prototype instanceof Object)) {
  ...
  initFacebookAnalytics() {
    const sdkName = GameSDK.getSDKName();
    const { Enabled: Enabled2, Prefix, ConsoleLog } = Analytics7.FacebookAnalytics ?? {};
    if (!Enabled2 || sdkName !== "FacebookInstant") return;
